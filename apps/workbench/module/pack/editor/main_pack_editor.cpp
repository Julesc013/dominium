/*
FILE: source/dominium/apps/workbench/module/pack/editor/main_pack_editor.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/pack/editor/main_pack_editor
RESPONSIBILITY: Implements `main_pack_editor`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/apps/workbench/module/world/editor/dom_world_editor_controller.h
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/world/editor/dom_world_editor_controller
RESPONSIBILITY: Defines internal contract for `dom_world_editor_controller`; shared within its subsystem; does NOT define a public API (see `include/**`).

/*
FILE: source/dominium/apps/workbench/module/world/editor/main_world_editor.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/world/editor/main_world_editor
RESPONSIBILITY: Implements `main_world_editor`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

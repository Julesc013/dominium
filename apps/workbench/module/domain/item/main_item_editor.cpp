/*
FILE: source/dominium/apps/workbench/module/domain/item/main_item_editor.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/domain/item/main_item_editor
RESPONSIBILITY: Implements `main_item_editor`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

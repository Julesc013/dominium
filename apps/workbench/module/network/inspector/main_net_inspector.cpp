/*
FILE: source/dominium/apps/workbench/module/network/inspector/main_net_inspector.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/network/inspector/main_net_inspector
RESPONSIBILITY: Implements `main_net_inspector`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: apps/workbench/module/ui/editor/ui_editor_main_win32.cpp
MODULE: Repository
...
EXTENSION POINTS: Extend via UI editor modules and schema tooling; see `docs/development/guides/ui_editor/README.md`.
*/

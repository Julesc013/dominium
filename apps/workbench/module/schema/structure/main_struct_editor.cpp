/*
FILE: source/dominium/apps/workbench/module/schema/structure/main_struct_editor.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/schema/structure/main_struct_editor
RESPONSIBILITY: Implements `main_struct_editor`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

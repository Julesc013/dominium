/*
FILE: source/dominium/apps/workbench/module/replay/viewer/dom_replay_viewer_controller.h
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / apps/workbench/module/replay/viewer/dom_replay_viewer_controller
RESPONSIBILITY: Defines internal contract for `dom_replay_viewer_controller`; shared within its subsystem; does NOT define a public API (see `include/**`).

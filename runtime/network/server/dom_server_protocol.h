/*
FILE: runtime/network/server/dom_server_protocol.h
MODULE: Dominium
...
typedef enum dom_server_event_kind {
    ...
    DOM_SERVER_EVENT_CHECKPOINT = 11,
    DOM_SERVER_EVENT_RECOVER = 12,
    DOM_SERVER_EVENT_SHARD_LIFECYCLE = 13,
    DOM_SERVER_EVENT_ROLLING_UPDATE = 14
...
typedef enum dom_server_refusal_code {
    ...
    DOM_SERVER_REFUSE_CHECKPOINT_MISSING = 801,
    DOM_SERVER_REFUSE_LOG_TAIL_MISSING = 802,
    DOM_SERVER_REFUSE_SCHEMA_INCOMPATIBLE = 803,
    DOM_SERVER_REFUSE_SHARD_STATE = 804,
    DOM_SERVER_REFUSE_CAPABILITY_GAP = 805

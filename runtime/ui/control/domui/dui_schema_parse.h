...
RESPONSIBILITY: Internal TLV contracts/schema/state parsing helpers for DUI backends (skip-unknown; bounded outputs).
ALLOWED DEPENDENCIES: `runtime/include/domino/ui/dui/**`, `include/domino/**`, `source/domino/**` (within engine), and C89/C++98 standard headers.
...
VERSIONING / ABI / DATA FORMAT NOTES: TLV is skip-unknown; see `runtime/include/domino/ui/dui/dui_schema_tlv.h`.

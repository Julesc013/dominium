...
RESPONSIBILITY: Implements the DUI Win32 native backend (common controls; message pump; contracts/schema/state driven).
ALLOWED DEPENDENCIES: `runtime/include/domino/ui/dui/**`, `include/domino/**`, `source/domino/**`, Win32 SDK headers.
...
VERSIONING / ABI / DATA FORMAT NOTES: `dui_api_v1` vtable; contracts/schema/state TLV are skip-unknown.
EXTENSION POINTS: Test/native handle extensions via query_interface.
*/
#include "domino/ui/dui/dui_api_v1.h"
#include "domui/dui_win32.h"

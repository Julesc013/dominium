...
PLATFORM_CAPABILITY_REGISTRY_REL = os.path.join("contracts", "registry", "platform_capability_registry.json")
...
_WINDOWS_NATIVE_MARKERS = {
    ...
    "launcher": ("tools/codegen/ui/launcher/native_win32_adapter.py",),
    "setup": ("tools/codegen/ui/setup/native_win32_adapter.py",),
}
_MACOS_NATIVE_MARKERS = {
    "*": ("src/platform/native_cocoa_adapter.py",),
    "client": ("src/client/ui/native_cocoa_adapter.py",),
    "launcher": ("tools/codegen/ui/launcher/native_cocoa_adapter.py",),
    "setup": ("tools/codegen/ui/setup/native_cocoa_adapter.py",),
}
_LINUX_NATIVE_MARKERS = {
    "*": ("src/platform/native_gtk_adapter.py",),
    "client": ("src/client/ui/native_gtk_adapter.py",),
    "launcher": ("tools/codegen/ui/launcher/native_gtk_adapter.py",),

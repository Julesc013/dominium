/*
FILE: source/domino/content/d_content.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / content/d_content
RESPONSIBILITY: Implements `d_content`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

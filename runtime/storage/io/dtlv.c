/*
FILE: source/domino/io/container/dtlv.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / io/container/dtlv
RESPONSIBILITY: Implements `dtlv`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).
ALLOWED DEPENDENCIES: `include/domino/**`, `source/domino/**`, and C89/C++98 standard headers as needed.
FORBIDDEN DEPENDENCIES: `include/dominium/**`, `source/dominium/**` (engine must not depend on product layer).
THREADING MODEL: No internal synchronization; callers must serialize access unless stated otherwise.
ERROR MODEL: Return codes/NULL pointers; no exceptions.
DETERMINISM: Determinism-friendly (explicit little-endian IO; deterministic directory ordering); see `docs/reference/specs/SPEC_DETERMINISM.md`.
VERSIONING / ABI / DATA FORMAT NOTES: Implements DTLV container v1 (`docs/reference/specs/SPEC_CONTAINER_TLV.md`); file-backed paths are limited by `dsys_file_seek` (long offsets).
 ...
 *
 * See docs/reference/specs/SPEC_CONTAINER_TLV.md for the authoritative format contract.
 */

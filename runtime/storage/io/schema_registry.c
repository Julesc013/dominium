/*
FILE: source/domino/io/schema_registry.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / io/schema_registry
RESPONSIBILITY: Implements `schema_registry`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: runtime/shell/command/command_registry.h
MODULE: Dominium
...
typedef enum dom_app_command_id_e {
    ...
    DOM_APP_CMD_CLIENT_CAMERA_SET_MODE,
    DOM_APP_CMD_CLIENT_CAMERA_SET_POSE,
    DOM_APP_CMD_CLIENT_BLUEPRINT_PREVIEW,
    DOM_APP_CMD_CLIENT_BLUEPRINT_PLACE,

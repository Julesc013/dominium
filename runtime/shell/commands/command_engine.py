...
from runtime.shell.diag import write_diag_snapshot_bundle
...
from runtime.shell.supervisor import (
...
from runtime.shell.ui_mode_selector import get_current_ui_mode_selection
...
REFUSAL_TO_EXIT_REGISTRY_REL = os.path.join("contracts", "registry", "refusal_to_exit_registry.json")
EXIT_INTERNAL = 60
EXIT_SUCCESS = 0
...
def _run_validate_command(repo_root: str, args: Sequence[str]) -> dict:
    from tools.validators.suite import build_validation_report, write_validation_outputs

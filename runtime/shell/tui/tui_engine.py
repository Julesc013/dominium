...
TUI_PANEL_REGISTRY_REL = os.path.join("contracts", "registry", "tui_panel_registry.json")
TUI_LAYOUT_REGISTRY_REL = os.path.join("contracts", "registry", "tui_layout_registry.json")

/*
FILE: runtime/include/domino/ui/dui/dui_api_v1.h
MODULE: DUI
...
DETERMINISM: UI must not influence authoritative simulation; events are explicit inputs; see `docs/reference/specs/SPEC_DUI.md`.
VERSIONING / ABI / DATA FORMAT NOTES: Versioned POD vtable; `DOM_ABI_HEADER`; `query_interface`.
EXTENSION POINTS: `query_interface` + capability bits; contracts/schema/state TLV is skip-unknown.
*/

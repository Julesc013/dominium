...
DETERMINISM: Determinism-supporting (schema ids and tag sets are hashed/validated); see `docs/reference/specs/SPEC_CONTAINER_TLV.md` and `docs/reference/specs/SPEC_DETERMINISM.md`.
 ...
 * - Serialization ABI rules are specified in `docs/reference/specs/SPEC_CONTAINER_TLV.md`.
 */

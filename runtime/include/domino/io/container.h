...
DETERMINISM: Determinism-friendly container framing (explicit little-endian parsing); see `docs/reference/specs/SPEC_CONTAINER_TLV.md`.
 ...
 * Notes:
 * - Field meanings and on-disk encodings are specified in `docs/reference/specs/SPEC_CONTAINER_TLV.md`.

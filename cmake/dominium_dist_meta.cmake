...
string(APPEND _rules_txt "required_pkg=dist/pkg/{winnt,win9x,win16,dos,macosx,macclassic,linux,android,ios,web}\n")
...
if(DEFINED DOM_DIST_SEED_RUNTIME AND NOT DOM_DIST_SEED_RUNTIME STREQUAL "")
    string(TOLOWER "${DOM_DIST_SEED_RUNTIME}" _seed_runtime)
    if(_seed_runtime STREQUAL "1" OR _seed_runtime STREQUAL "on" OR _seed_runtime STREQUAL "true" OR _seed_runtime STREQUAL "yes")
        string(APPEND _rules_txt "seed_runtime=1\n")
        string(APPEND _rules_txt "dir_charset_exceptions=.dsu\n")
        string(APPEND _rules_txt "seed_leaf_dirs=sys/<os>/<arch>/{.dsu,repo/{products,packs,mods},instances,artifacts,audit,exports,temp}\n")
        string(APPEND _rules_txt "seed_leaf_files=sys/<os>/<arch>/.dsu/installed_state.dsustate;sys/<os>/<arch>/dominium_install.json\n")
    endif()
endif()
string(APPEND _rules_txt "os_tokens=winnt win9x win16 dos macosx macclassic linux android ios web\n")

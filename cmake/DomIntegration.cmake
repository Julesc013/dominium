...
set(DOM_TESTX_LABEL_FAST "fast")
set(DOM_TESTX_LABEL_PORTABILITY "portability")
set(DOM_TESTX_LABEL_BUILDMETA "buildmeta")
set(DOM_TESTX_LABEL_AUDIT "audit")
set(DOM_TESTX_LABEL_SLOW "slow")
set(DOM_TESTX_LABEL_NIGHTLY "nightly")
...
function(dom_add_testx)
    ...
    set(_dom_testx_labels ${DOM_LABELS} ${DOM_TESTX_LABEL_TESTX})
    list(FIND _dom_testx_labels ${DOM_TESTX_LABEL_SMOKE} _dom_testx_smoke_idx)
    if(NOT _dom_testx_smoke_idx EQUAL -1)
        list(APPEND _dom_testx_labels ${DOM_TESTX_LABEL_FAST})
    endif()
    list(REMOVE_DUPLICATES _dom_testx_labels)
    set_tests_properties(${DOM_NAME} PROPERTIES LABELS "${_dom_testx_labels}")

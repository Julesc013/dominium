...
RESPONSIBILITY: Defines internal contract for `dg_graph`; shared within its subsystem; does NOT define a public API (see `include/**`).
...
#include "dg_graph_node.h"
#include "dg_graph_edge.h"

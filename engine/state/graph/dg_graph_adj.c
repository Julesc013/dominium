/*
FILE: source/domino/core/graph/dg_graph_adj.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/graph/dg_graph_adj
RESPONSIBILITY: Implements `dg_graph_adj`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

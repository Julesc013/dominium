/*
FILE: source/domino/core/graph/dg_graph_registry.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/graph/dg_graph_registry
RESPONSIBILITY: Defines internal contract for `dg_graph_registry`; shared within its subsystem; does NOT define a public API (see `include/**`).

/*
FILE: source/domino/world/d_worldgen.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / world/d_worldgen
RESPONSIBILITY: Implements `d_worldgen`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

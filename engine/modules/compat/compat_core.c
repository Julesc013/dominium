/*
FILE: source/domino/compat/compat_core.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / compat/compat_core
RESPONSIBILITY: Implements `compat_core`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

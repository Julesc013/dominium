/*
FILE: source/domino/content/d_content_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / content/d_content_validate
RESPONSIBILITY: Implements `d_content_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

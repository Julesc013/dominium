/*
FILE: source/domino/sim/lod/dg_representable.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/lod/dg_representable
RESPONSIBILITY: Defines internal contract for `dg_representable`; shared within its subsystem; does NOT define a public API (see `include/**`).

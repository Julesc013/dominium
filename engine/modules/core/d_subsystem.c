/*
FILE: source/domino/core/d_subsystem.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/d_subsystem
RESPONSIBILITY: Implements `d_subsystem`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

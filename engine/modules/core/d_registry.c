/*
FILE: source/domino/core/d_registry.c
MODULE: Domino
...
u32 d_registry_add(d_registry *reg, void *ptr) {
    ...
    reg->count += 1u;
    reg->next_id += 1u;
    /* TODO_FUTURE(REGISTRY-OPENADDR-001): docs/architecture/FUTURE_PROOFING.md - upgrade to open-addressing or sorted lookup if hot. */
    return entry->id;
}

/*
FILE: source/domino/caps/d_caps.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / caps/d_caps
RESPONSIBILITY: Implements `d_caps`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/net/d_net_cmd.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / net/d_net_cmd
RESPONSIBILITY: Implements `d_net_cmd`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

 ...
 *
 * See also:
 * - `docs/reference/specs/SPEC_DETERMINISM_GRADES.md` (grade definitions and enforcement rules)
 * - `docs/reference/specs/SPEC_DETERMINISM.md` (project-wide determinism constraints)
 */

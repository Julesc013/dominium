...
DETERMINISM: Determinism-critical numeric policy (fixed-point only); see `docs/reference/specs/SPEC_DETERMINISM.md` and `docs/reference/specs/SPEC_NUMERIC.md`.

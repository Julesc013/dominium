/*
FILE: include/domino/daggregate.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino API / daggregate
RESPONSIBILITY: Defines the public contract for `daggregate` (types/constants/function signatures); does NOT provide implementation.

/*
FILE: source/domino/core/dg_order_key.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/dg_order_key
RESPONSIBILITY: Implements `dg_order_key`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/core/det_invariants.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/det_invariants
RESPONSIBILITY: Defines internal contract for `det_invariants`; shared within its subsystem; does NOT define a public API (see `include/**`).
 ...
 *
 * See: docs/reference/specs/SPEC_DETERMINISM.md
 */
 ...
 * regression scans (see docs/governance/policies/DETERMINISM_REGRESSION_RULES.md).
 */

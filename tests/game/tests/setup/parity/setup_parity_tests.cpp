...
static int test_kernel_invariants_match_launcher(void) {
    ...
    if (require_markers(root_path("docs/reference/specs/setup/INVARIANTS.md"),
                        k_setup_markers,
...
static int test_capability_registry_semantics_match(void) {
    ...
    if (require_markers(root_path("docs/reference/specs/setup/SPLAT_SELECTION_RULES.md"),
                        k_setup_markers,
                        sizeof(k_setup_markers) / sizeof(k_setup_markers[0])) != 0) {
        return 1;
    }
...
static int test_job_journal_semantics_match(void) {
    ...
    if (require_markers(root_path("docs/reference/specs/setup/JOB_ENGINE.md"),
                        k_setup_markers,
                        sizeof(k_setup_markers) / sizeof(k_setup_markers[0])) != 0) {
        return 1;
    }

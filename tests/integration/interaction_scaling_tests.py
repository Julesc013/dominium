...
def main():
    parser = argparse.ArgumentParser(description="Interaction scaling guard tests.")
    ...
    for entry in fixtures:
        ...
        save2_rel = os.path.join("saves", "interaction.save")
        replay_rel = os.path.join("replays", "interaction.replay")
        save2_path = os.path.join(saves_dir, "interaction.save")
        ...
        metrics = {
            "place_events": count_token(events, "client.interaction.place"),
            "signal_events": count_token(events, "client.interaction.signal"),
            "measure_events": count_token(events, "client.interaction.measure"),
            "inspect_events": count_token(events, "client.interaction.inspect"),
            "remove_events": count_token(events, "client.interaction.remove"),

...
def main() -> int:
    parser = argparse.ArgumentParser(description="Schema round-trip tests (FAB).")
    ...
    for rel_path in FAB_SCHEMA_FILES:
        ...
        if round_obj != obj:
            violations.append("round-trip mismatch in {}".format(rel_path))
    ...
    print("Schema round-trip tests OK.")
    return 0

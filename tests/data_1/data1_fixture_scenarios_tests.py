...
def main():
    ...
    output = run_tool(repo_root, "tools/package/distribution/compat_dry_run.py",
    ...
    discover_a = run_tool(repo_root, "tools/package/distribution/pack_discover.py",
                          ["--repo-root", repo_root, "--root", full_extended, "--format", "json"])
    discover_b = run_tool(repo_root, "tools/package/distribution/pack_discover.py",
                          ["--repo-root", repo_root, "--root", full_extended, "--format", "json"])

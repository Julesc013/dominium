...
def main() -> int:
    ...
    zone_schema = read_text(os.path.join(repo_root, "contracts", "schemas", "srz.zone.schema"))
    ...
    log_schema = read_text(os.path.join(repo_root, "contracts", "schemas", "process.log.schema"))
    ...
    hash_schema = read_text(os.path.join(repo_root, "contracts", "schemas", "process.hashchain.schema"))

...
def main() -> int:
    ...
    zone_schema = read_text(os.path.join(repo_root, "contracts", "schema", "srz.zone.schema"))
    ...
    log_schema = read_text(os.path.join(repo_root, "contracts", "schema", "process.log.schema"))
    ...
    hash_schema = read_text(os.path.join(repo_root, "contracts", "schema", "process.hashchain.schema"))

...
def main():
    parser = argparse.ArgumentParser(description="Weather T4 perf/scaling tests.")
    ...
    for fixture in fixtures:
        ...
        success, output = run_cmd(
            ...
            expect_contains=["DOMINIUM_WEATHER_CORE_SAMPLE_V1"],
        )
        ok = ok and success
    ...
    if success:
        data = parse_kv(output)
        ok = ok and require(data.get("capsule_count") != "0", "collapsed window not recorded")

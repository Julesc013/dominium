...
MW_INSOLATION_PROXY_REL = os.path.join("game", "domains", "worldgen", "mw", "insolation_proxy.py")
EARTH_SURFACE_GENERATOR_REL = os.path.join("game", "domains", "worldgen", "earth", "earth_surface_generator.py")
EARTH_HYDROLOGY_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "hydrology_engine.py")
EARTH_CLIMATE_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "climate_field_engine.py")
EARTH_SEASON_PHASE_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "season_phase_engine.py")
...
EARTH_SKY_VIEW_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "sky", "sky_view_engine.py")
EARTH_HORIZON_SHADOW_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "lighting", "horizon_shadow_engine.py")
EARTH_LIGHTING_VIEW_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "lighting", "lighting_view_engine.py")

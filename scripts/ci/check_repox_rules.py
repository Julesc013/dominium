...
SEMANTIC_CONTRACT_BUNDLE_SCHEMA_REL = os.path.join("contracts", "schema", "universe", "universe_contract_bundle.schema")
SEMANTIC_CONTRACT_BUNDLE_JSON_SCHEMA_REL = os.path.join("contracts", "schema", "universe_contract_bundle.schema.json")
...
UNIVERSE_IDENTITY_SCHEMA_REL = os.path.join("contracts", "schema", "universe", "universe_identity.schema")
UNIVERSE_IDENTITY_JSON_SCHEMA_REL = os.path.join("contracts", "schema", "universe_identity.schema.json")
...
PACK_COMPAT_SCHEMA_REL = os.path.join("contracts", "schema", "package", "pack_compat_manifest.schema")
PACK_COMPAT_JSON_SCHEMA_REL = os.path.join("contracts", "schema", "pack_compat_manifest.schema.json")
...
PACK_COMPAT_REPORT_SCHEMA_REL = os.path.join("contracts", "schema", "package", "pack_compatibility_report.schema")
PACK_COMPAT_REPORT_JSON_SCHEMA_REL = os.path.join("contracts", "schema", "pack_compatibility_report.schema.json")
PACK_LOCK_SCHEMA_REL = os.path.join("contracts", "schema", "package", "pack_lock.schema")
PACK_LOCK_JSON_SCHEMA_REL = os.path.join("contracts", "schema", "pack_lock.schema.json")
PACK_VERIFICATION_PIPELINE_REL = os.path.join("packs", "compat", "pack_verification_pipeline.py")
SETUP_CLI_REL = os.path.join("tools", "package", "setup", "setup_cli.py")
LAUNCHER_CLI_REL = os.path.join("tools", "package", "launcher", "launcher_cli.py")
...
SCHEMA_MIGRATION_REGISTRY_REL = os.path.join("contracts", "schema", "SCHEMA_MIGRATION_REGISTRY.json")
...
MW_CELL_GENERATOR_REL = os.path.join("game", "domain", "worldgen", "mw", "mw_cell_generator.py")
MW_WORLDGEN_ENGINE_REL = os.path.join("game", "domain", "geology", "worldgen", "worldgen_engine.py")
MW_GALAXY_OBJECT_STUB_GENERATOR_REL = os.path.join("game", "domain", "worldgen", "galaxy", "galaxy_object_stub_generator.py")
MW_SYSTEM_QUERY_ENGINE_REL = os.path.join("game", "domain", "worldgen", "mw", "system_query_engine.py")
MW_SYSTEM_REFINER_L2_REL = os.path.join("game", "domain", "worldgen", "mw", "mw_system_refiner_l2.py")
MW_SURFACE_REFINER_L3_REL = os.path.join("game", "domain", "worldgen", "mw", "mw_surface_refiner_l3.py")
MW_INSOLATION_PROXY_REL = os.path.join("game", "domain", "worldgen", "mw", "insolation_proxy.py")
EARTH_SURFACE_GENERATOR_REL = os.path.join("game", "domain", "worldgen", "earth", "earth_surface_generator.py")
EARTH_HYDROLOGY_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "hydrology_engine.py")
EARTH_CLIMATE_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "climate_field_engine.py")
EARTH_SEASON_PHASE_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "season_phase_engine.py")
EARTH_TIDE_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "tide_field_engine.py")
EARTH_TIDE_PHASE_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "tide_phase_engine.py")
EARTH_WIND_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "wind", "wind_field_engine.py")
EARTH_MATERIAL_PROXY_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "material", "material_proxy_engine.py")
EARTH_SKY_ASTRONOMY_REL = os.path.join("game", "domain", "worldgen", "earth", "sky", "astronomy_proxy_engine.py")
EARTH_SKY_GRADIENT_REL = os.path.join("game", "domain", "worldgen", "earth", "sky", "sky_gradient_model.py")
EARTH_STARFIELD_GENERATOR_REL = os.path.join("game", "domain", "worldgen", "earth", "sky", "starfield_generator.py")
EARTH_SKY_VIEW_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "sky", "sky_view_engine.py")
EARTH_HORIZON_SHADOW_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "lighting", "horizon_shadow_engine.py")
EARTH_LIGHTING_VIEW_ENGINE_REL = os.path.join("game", "domain", "worldgen", "earth", "lighting", "lighting_view_engine.py")
MW_GALAXY_PRIORS_REGISTRY_REL = os.path.join("contracts", "registry", "galaxy_priors_registry.json")
MW_SURFACE_PRIORS_REGISTRY_REL = os.path.join("contracts", "registry", "surface_priors_registry.json")
MW_SURFACE_GENERATOR_REGISTRY_REL = os.path.join("contracts", "registry", "surface_generator_registry.json")
MW_SURFACE_GENERATOR_ROUTING_REGISTRY_REL = os.path.join("contracts", "registry", "surface_generator_routing_registry.json")
EARTH_SURFACE_PARAMS_REGISTRY_REL = os.path.join("contracts", "registry", "earth_surface_params_registry.json")
EARTH_HYDROLOGY_PARAMS_REGISTRY_REL = os.path.join("contracts", "registry", "hydrology_params_registry.json")
EARTH_CLIMATE_PARAMS_REGISTRY_REL = os.path.join("contracts", "registry", "earth_climate_params_registry.json")
EARTH_TIDE_PARAMS_REGISTRY_REL = os.path.join("contracts", "registry", "tide_params_registry.json")
EARTH_WIND_PARAMS_REGISTRY_REL = os.path.join("contracts", "registry", "wind_params_registry.json")
EARTH_WATER_VISUAL_POLICY_REGISTRY_REL = os.path.join("contracts", "registry", "water_visual_policy_registry.json")
EARTH_SKY_MODEL_REGISTRY_REL = os.path.join("contracts", "registry", "sky_model_registry.json")
EARTH_STARFIELD_POLICY_REGISTRY_REL = os.path.join("contracts", "registry", "starfield_policy_registry.json")
EARTH_MILKYWAY_BAND_POLICY_REGISTRY_REL = os.path.join("contracts", "registry", "milkyway_band_policy_registry.json")
EARTH_ILLUMINATION_MODEL_REGISTRY_REL = os.path.join("contracts", "registry", "illumination_model_registry.json")
EARTH_SHADOW_MODEL_REGISTRY_REL = os.path.join("contracts", "registry", "shadow_model_registry.json")
...
EARTH_WATER_VIEW_ENGINE_REL = os.path.join("game", "domains", "worldgen", "earth", "water", "water_view_engine.py")
...
GLOSSARY_SCHEMA_REL = os.path.join("contracts", "schema", "governance", "glossary.schema")
...
DERIVED_ARTIFACT_CONTRACT_SCHEMA_REL = os.path.join("contracts", "schema", "governance", "derived_artifact_contract.schema")
...
REMEDIATION_PLAYBOOK_SCHEMA_REL = os.path.join("contracts", "schema", "governance", "remediation_playbook.schema")

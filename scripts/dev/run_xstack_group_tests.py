...
GROUP_TESTS = {
    "testx.group.core.invariants": [
        ...
        ["tests/invariant/omega_series_tests.py", "--repo-root", ".", "--case", "plan_exists"],
        ["tests/invariant/omega_series_tests.py", "--repo-root", ".", "--case", "gates_consistent"],
        ["tests/invariant/omega_series_tests.py", "--repo-root", ".", "--case", "artifact_registry_complete"],

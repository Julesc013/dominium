...
def main(argv):
    ...
    with open(out_path, "w", encoding="utf-8", newline="\n") as out:
        ...
        out.write('                  Value="&quot;[INSTALLDIR]setup\\dominium-setup.exe&quot; --deterministic [DSU_DETERMINISTIC] plan --manifest &quot;[INSTALLDIR]setup\\manifests\\product.dsumanifest&quot; --op install --scope [DSU_SCOPE] --out &quot;[TempFolder]dominium.dsuplan&quot;" />\n')
        ...
        out.write('      <Custom Action="DSU_SetPlan" After="InstallFiles">NOT Installed</Custom>\n')

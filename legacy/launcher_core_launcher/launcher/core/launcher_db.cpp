/*
FILE: source/dominium/launcher/core/launcher_db.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / launcher/core/launcher_db
RESPONSIBILITY: Implements `launcher_db`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

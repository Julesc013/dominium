/*
FILE: source/dominium/launcher/cli/dominium_launcher_cli_main.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / launcher/cli/dominium_launcher_cli_main
RESPONSIBILITY: Implements `dominium_launcher_cli_main`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

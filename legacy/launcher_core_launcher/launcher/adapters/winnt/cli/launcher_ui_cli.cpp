/*
FILE: source/dominium/launcher/cli/launcher_ui_cli.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / launcher/cli/launcher_ui_cli
RESPONSIBILITY: Implements `launcher_ui_cli`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

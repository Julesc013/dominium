/*
FILE: source/dominium/game/rules/game_api.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/rules/game_api
RESPONSIBILITY: Implements `game_api`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/game/rules/actors.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/rules/actors
RESPONSIBILITY: Implements `actors`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

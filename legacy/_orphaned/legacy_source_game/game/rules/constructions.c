/*
FILE: source/dominium/game/rules/constructions.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/rules/constructions
RESPONSIBILITY: Implements `constructions`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/game/core/dominium_game_main.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/core/dominium_game_main
RESPONSIBILITY: Implements `dominium_game_main`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

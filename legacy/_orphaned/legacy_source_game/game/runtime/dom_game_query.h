...
enum {
    ...
    DOM_GAME_QUERY_MACRO_ECONOMY = 14u,
    DOM_GAME_QUERY_MACRO_EVENTS = 15u,
    DOM_GAME_QUERY_ATMOS_SAMPLE = 16u,
    DOM_GAME_QUERY_REENTRY_STATUS = 17u,
    DOM_GAME_QUERY_FACTIONS = 18u,
    DOM_GAME_QUERY_FACTION_SUMMARY = 19u,
    DOM_GAME_QUERY_AI_STATUS = 20u,
    DOM_GAME_QUERY_COSMO_ANCHORS = 21u,
    DOM_GAME_QUERY_MECH_PROFILES = 22u
};

/*
FILE: source/dominium/common/dmn_paths.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dmn_paths
RESPONSIBILITY: Implements `dmn_paths`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

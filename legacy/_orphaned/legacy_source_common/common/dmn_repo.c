/*
FILE: source/dominium/common/dmn_repo.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dmn_repo
RESPONSIBILITY: Implements `dmn_repo`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/common/dominium_product_info.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dominium_product_info
RESPONSIBILITY: Implements `dominium_product_info`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

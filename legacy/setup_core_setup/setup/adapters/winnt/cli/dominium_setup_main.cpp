...
static void dsk_cli_json_begin(dsk_json_writer_t *writer,
    ...
    dsk_json_string(writer, "setup-cli-1");
...
static void print_usage(void) {
    std::printf("dominium-setup manifest validate --in <file> [--json]\n");
    std::printf("dominium-setup manifest dump --in <file> --out <file> --format json [--json]\n");
    std::printf("dominium-setup request validate --in <file> [--json]\n");
    std::printf("dominium-setup request dump --in <file> --out <file> --format json [--json]\n");
    std::printf("dominium-setup audit dump --in <file> --out <file> --format json [--json]\n");
    std::printf("dominium-setup dump-audit --audit <file> --out <file> --format json [--json]\n");
    std::printf("dominium-setup state dump --in <file> --out <file> --format json [--json]\n");
    std::printf("dominium-setup explain-refusal --audit <file> [--json]\n");
    std::printf("dominium-setup doctor --state <file> [--plan <file>] [--journal <file>]\n");
    std::printf("  [--txn-journal <file>] [--audit <file>] [--json]\n");
    std::printf("dominium-setup import-legacy-state --in <file> [--out <file>] [--out-audit <file>] [--deterministic 0|1] [--json]\n");
    std::printf("dominium-setup request make --manifest <file> --op <install|upgrade|repair|uninstall|verify|status>\n");
    ...
    std::printf("dominium-setup plan --manifest <file> --request <file> --out-plan <file> [--json]\n");
    std::printf("dominium-setup resolve --manifest <file> --request <file> [--json]\n");
    std::printf("dominium-setup dump-plan --plan <file> [--json]\n");
    std::printf("dominium-setup apply --plan <file> [--out-state <file>] [--out-audit <file>] [--out-journal <file>] [--dry-run] [--json]\n");
    std::printf("dominium-setup resume --journal <file> [--out-state <file>] [--out-audit <file>] [--json]\n");
    std::printf("dominium-setup rollback --journal <file> [--out-audit <file>] [--json]\n");
    std::printf("dominium-setup status --journal <file> [--json]\n");
    std::printf("dominium-setup verify --state <file> [--format json|txt] [--json]\n");
    std::printf("dominium-setup uninstall-preview --state <file> [--components <csv>] [--format json|txt] [--json]\n");
    std::printf("dominium-setup dump-splats [--json]\n");
    std::printf("dominium-setup select-splat --manifest <file> --request <file> [--json]\n");
...
int main(int argc, char **argv) {
    ...
    if (std::strcmp(argv[1], "request") == 0) {
        ...
        if (std::strcmp(argv[2], "make") == 0) {
            ...
            opts.frontend_id = frontend_id ? frontend_id : "dominium-setup-cli";

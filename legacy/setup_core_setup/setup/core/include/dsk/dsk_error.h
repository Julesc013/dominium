...
#define DSK_SUBCODE_SPLAT_REMOVED 18u
#define DSK_SUBCODE_ALREADY_INSTALLED 19u
#define DSK_SUBCODE_NOT_INSTALLED 20u
#define DSK_SUBCODE_STATE_MISMATCH 21u
#define DSK_SUBCODE_MANIFEST_MISMATCH 22u
#define DSK_SUBCODE_DOWNGRADE_BLOCKED 23u

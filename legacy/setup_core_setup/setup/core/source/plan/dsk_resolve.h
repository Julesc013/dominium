...
enum dsk_plan_refusal_code_t {
    ...
    DSK_PLAN_REFUSAL_ALREADY_INSTALLED = 7,
    DSK_PLAN_REFUSAL_NOT_INSTALLED = 8,
    DSK_PLAN_REFUSAL_STATE_MISMATCH = 9,
    DSK_PLAN_REFUSAL_MANIFEST_MISMATCH = 10,
    DSK_PLAN_REFUSAL_DOWNGRADE_BLOCKED = 11
};

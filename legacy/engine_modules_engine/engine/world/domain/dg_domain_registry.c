/*
FILE: source/domino/world/domain/dg_domain_registry.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / world/domain/dg_domain_registry
RESPONSIBILITY: Implements `dg_domain_registry`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

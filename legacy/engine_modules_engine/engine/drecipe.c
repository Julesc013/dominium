/*
FILE: source/domino/drecipe.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / drecipe
RESPONSIBILITY: Implements `drecipe`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

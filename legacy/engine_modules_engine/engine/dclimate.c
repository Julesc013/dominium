/*
FILE: source/domino/dclimate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dclimate
RESPONSIBILITY: Implements `dclimate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/system/core/base/dom_core/dom_core_fp.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/dom_core/dom_core_fp
RESPONSIBILITY: Defines internal contract for `dom_core_fp`; shared within its subsystem; does NOT define a public API (see `include/**`).

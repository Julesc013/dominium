/*
FILE: source/domino/system/core/base/shared/process.cpp
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/shared/process
RESPONSIBILITY: Implements `process`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/system/core/base/shared/json.cpp
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/shared/json
RESPONSIBILITY: Implements `json`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/system/core/base/shared/manifest_install.cpp
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/shared/manifest_install
RESPONSIBILITY: Implements `manifest_install`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

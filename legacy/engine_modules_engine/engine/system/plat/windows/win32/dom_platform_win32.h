/*
FILE: source/domino/system/plat/windows/win32/dom_platform_win32.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/windows/win32/dom_platform_win32
RESPONSIBILITY: Defines internal contract for `dom_platform_win32`; shared within its subsystem; does NOT define a public API (see `include/**`).

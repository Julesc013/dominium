/*
FILE: source/domino/system/plat/wayland/wayland_sys.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/wayland/wayland_sys
RESPONSIBILITY: Implements `wayland_sys`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

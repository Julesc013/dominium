/*
FILE: source/domino/system/plat/cpm86/cpm86_sys.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/cpm86/cpm86_sys
RESPONSIBILITY: Implements `cpm86_sys`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

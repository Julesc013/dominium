/*
FILE: source/domino/system/plat/null/sys_null.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/null/sys_null
RESPONSIBILITY: Implements `sys_null`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

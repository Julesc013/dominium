/*
FILE: source/domino/system/plat/cocoa/cocoa_sys.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/cocoa/cocoa_sys
RESPONSIBILITY: Implements `cocoa_sys`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

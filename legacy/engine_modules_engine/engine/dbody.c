/*
FILE: source/domino/dbody.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dbody
RESPONSIBILITY: Implements `dbody`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/dspace_graph.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dspace_graph
RESPONSIBILITY: Implements `dspace_graph`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/dhydro.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dhydro
RESPONSIBILITY: Implements `dhydro`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

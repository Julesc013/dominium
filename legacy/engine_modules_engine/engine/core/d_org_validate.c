/*
FILE: source/domino/core/d_org_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/d_org_validate
RESPONSIBILITY: Implements `d_org_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/dtransport.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dtransport
RESPONSIBILITY: Implements `dtransport`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

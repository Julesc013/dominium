/*
FILE: source/domino/trans/compile/dg_trans_frame.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/compile/dg_trans_frame
RESPONSIBILITY: Defines internal contract for `dg_trans_frame`; shared within its subsystem; does NOT define a public API (see `include/**`).

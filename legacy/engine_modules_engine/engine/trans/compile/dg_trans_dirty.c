/*
FILE: source/domino/trans/compile/dg_trans_dirty.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/compile/dg_trans_dirty
RESPONSIBILITY: Implements `dg_trans_dirty`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

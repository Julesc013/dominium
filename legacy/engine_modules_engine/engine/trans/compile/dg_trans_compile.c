/*
FILE: source/domino/trans/compile/dg_trans_compile.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/compile/dg_trans_compile
RESPONSIBILITY: Implements `dg_trans_compile`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/trans/model/dg_trans_attachment.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/model/dg_trans_attachment
RESPONSIBILITY: Implements `dg_trans_attachment`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

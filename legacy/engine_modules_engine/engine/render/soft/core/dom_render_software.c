/*
FILE: source/domino/render/soft/core/dom_render_software.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/soft/core/dom_render_software
RESPONSIBILITY: Implements `dom_render_software`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

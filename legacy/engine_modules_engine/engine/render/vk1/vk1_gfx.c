/*
FILE: source/domino/render/vk1/vk1_gfx.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/vk1/vk1_gfx
RESPONSIBILITY: Implements `vk1_gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

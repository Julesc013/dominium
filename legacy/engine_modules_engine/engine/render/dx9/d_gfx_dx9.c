/*
FILE: source/domino/render/dx9/d_gfx_dx9.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/dx9/d_gfx_dx9
RESPONSIBILITY: Implements `d_gfx_dx9`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

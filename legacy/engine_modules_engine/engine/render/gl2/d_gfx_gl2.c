/*
FILE: source/domino/render/gl2/d_gfx_gl2.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/gl2/d_gfx_gl2
RESPONSIBILITY: Implements `d_gfx_gl2`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

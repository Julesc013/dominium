/*
FILE: source/domino/sim/bus/dg_field.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/bus/dg_field
RESPONSIBILITY: Implements `dg_field`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

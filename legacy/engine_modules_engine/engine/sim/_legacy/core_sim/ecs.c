/*
FILE: source/domino/sim/_legacy/core_sim/ecs.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/_legacy/core_sim/ecs
RESPONSIBILITY: Implements `ecs`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/agent/act/dg_intent_dispatch.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / agent/act/dg_intent_dispatch
RESPONSIBILITY: Defines internal contract for `dg_intent_dispatch`; shared within its subsystem; does NOT define a public API (see `include/**`).

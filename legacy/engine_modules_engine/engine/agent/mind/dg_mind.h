/*
FILE: source/domino/agent/mind/dg_mind.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / agent/mind/dg_mind
RESPONSIBILITY: Defines internal contract for `dg_mind`; shared within its subsystem; does NOT define a public API (see `include/**`).

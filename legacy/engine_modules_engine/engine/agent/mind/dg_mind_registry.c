/*
FILE: source/domino/agent/mind/dg_mind_registry.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / agent/mind/dg_mind_registry
RESPONSIBILITY: Implements `dg_mind_registry`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

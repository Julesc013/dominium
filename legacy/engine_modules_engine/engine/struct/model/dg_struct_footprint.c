/*
FILE: source/domino/struct/model/dg_struct_footprint.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/model/dg_struct_footprint
RESPONSIBILITY: Implements `dg_struct_footprint`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/struct/compile/dg_struct_dirty.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/compile/dg_struct_dirty
RESPONSIBILITY: Implements `dg_struct_dirty`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

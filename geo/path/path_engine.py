...
from geo.frame.domain_adapters import field_sampling_cell_key
from geo.index.geo_index_engine import _coerce_cell_key, _semantic_cell_key, geo_cell_key_from_position, geo_refine_cell_key
...
from geo.metric.metric_engine import geo_distance
from geo.metric.neighborhood_engine import geo_neighbors
from geo.path.shard_route_planner import build_shard_route_plan
...
def _field_cost_modifier(
    *,
    ...
    def _field_value(field_id: str, cell_key: Mapping[str, object]) -> int:
        ...
        try:
            from fields.field_engine import field_get_value
        except Exception:
            return 0

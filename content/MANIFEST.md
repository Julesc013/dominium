...
| `profiles/` | not moved | left_for_review | Contains `content/profiles/bundles/bundle.mvp_default.json`, which embeds profile bundle identity and path metadata. | Profile IDs, profile bundle ID, hashes, and rel-path metadata unchanged. |

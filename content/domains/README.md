...
`content/domains/` is the target source root for authored domain datasets, source data, fixtures intended as product/content inputs, and non-code domain material.

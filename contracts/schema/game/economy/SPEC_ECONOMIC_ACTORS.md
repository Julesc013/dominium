...
- Settlements: `schema/domain/civilization/SPEC_SETTLEMENTS.md`


- Institutions: `schema/domain/civilization/SPEC_INSTITUTIONS.md`


- Organizations: `schema/domain/civilization/SPEC_ORGANIZATIONS.md`

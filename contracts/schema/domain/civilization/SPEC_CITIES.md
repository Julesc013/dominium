...
`schema/domain/civilization/README.md` and `schema/economy/README.md`. Retained for reference
...
## Integration points
- Buildings/machines: `schema/domain/civilization/SPEC_BUILDINGS_MACHINES.md`
- Production chains: `schema/domain/civilization/SPEC_PRODUCTION_CHAINS.md`
- Logistics flows: `schema/domain/civilization/SPEC_LOGISTICS_FLOWS.md`
- Population cohorts: `schema/domain/civilization/SPEC_POPULATION_COHORTS.md`

...
Compatibility: Must inherit `docs/reference/specs/reality/SPEC_DOMINIUM_UNIVERSAL_REALITY_FRAMEWORK.md` v1.0.0 and conform to `schema/reality/domain_contract.schema.json`.
Stability: template
Future Series: Λ, Σ, Φ

...
- `python tools/xstack/controlx/controlx.py sanitize --prompt-file <path>`
- `python tools/xstack/controlx/controlx.py run --prompt-file <path> --repo-root .`
- `python tools/xstack/controlx/controlx.py run-queue --queue-file <path> --repo-root .`

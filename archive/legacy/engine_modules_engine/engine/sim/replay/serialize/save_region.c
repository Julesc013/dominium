/*
FILE: source/domino/sim/replay/serialize/save_region.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/replay/serialize/save_region
RESPONSIBILITY: Implements `save_region`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

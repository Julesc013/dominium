/*
FILE: source/domino/sim/replay/serialize/save_tlv.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/replay/serialize/save_tlv
RESPONSIBILITY: Implements `save_tlv`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

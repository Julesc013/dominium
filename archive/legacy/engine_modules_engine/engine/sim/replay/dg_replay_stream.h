/*
FILE: source/domino/sim/replay/dg_replay_stream.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/replay/dg_replay_stream
RESPONSIBILITY: Defines internal contract for `dg_replay_stream`; shared within its subsystem; does NOT define a public API (see `include/**`).

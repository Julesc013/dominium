/*
FILE: source/domino/sim/hash/dg_hash.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/hash/dg_hash
RESPONSIBILITY: Implements `dg_hash`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/struct/compile/dg_struct_occupancy.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/compile/dg_struct_occupancy
RESPONSIBILITY: Implements `dg_struct_occupancy`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

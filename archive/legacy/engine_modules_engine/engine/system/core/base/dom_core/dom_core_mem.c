/*
FILE: source/domino/system/core/base/dom_core/dom_core_mem.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/dom_core/dom_core_mem
RESPONSIBILITY: Implements `dom_core_mem`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

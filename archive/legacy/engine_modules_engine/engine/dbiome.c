/*
FILE: source/domino/dbiome.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dbiome
RESPONSIBILITY: Implements `dbiome`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

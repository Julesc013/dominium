/*
FILE: source/domino/render/gl2/gl2_gfx.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/gl2/gl2_gfx
RESPONSIBILITY: Implements `gl2_gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

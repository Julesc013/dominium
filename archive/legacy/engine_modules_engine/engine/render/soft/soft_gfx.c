/*
FILE: source/domino/render/soft/soft_gfx.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/soft/soft_gfx
RESPONSIBILITY: Implements `soft_gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/decor/compile/dg_decor_tiles.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / decor/compile/dg_decor_tiles
RESPONSIBILITY: Implements `dg_decor_tiles`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

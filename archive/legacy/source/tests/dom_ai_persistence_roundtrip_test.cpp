/*
FILE: source/tests/dom_ai_persistence_roundtrip_test.cpp
MODULE: Repository Tests
PURPOSE: Ensure faction and AI scheduler state survives save/load.
*/
#include <cassert>
#include <cstdio>
#include <cstring>
...
static bool setup_ai_baseline(TestRuntime &tr) {
...
int main(void) {
    const char *path = "tmp_ai_save.dmsg";
    TestRuntime a;
    TestRuntime b;
    u64 hash_a = 0ull;
    u64 hash_b = 0ull;
    ...
    teardown_runtime(a);
    std::remove(path);
    std::printf("dom_ai_persistence_roundtrip_test: OK\n");
    return 0;
}

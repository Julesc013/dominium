/*
FILE: source/dominium/setup/adapters/steam/dominium_setup_adapter_steam.c
MODULE: Dominium Setup
PURPOSE: Steam lifecycle adapter entrypoint (Plan S-6).
*/

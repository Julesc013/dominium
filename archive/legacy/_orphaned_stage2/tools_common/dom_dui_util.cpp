/*
FILE: source/dominium/tools/common/dom_dui_util.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / tools/common/dom_dui_util
RESPONSIBILITY: Implements `dom_dui_util`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/launcher/launcher_ui.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / launcher/launcher_ui
RESPONSIBILITY: Implements `launcher_ui`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

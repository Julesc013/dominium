/*
FILE: source/dominium/game/rule/client/input/dom_input_mapping.c
MODULE: Dominium
...
#include "dom_keys.h"
#include "dominium/dom_plat.h" /* for platform-independent keycodes */

/* Minimal platform input frame stub until dom_plat wiring is complete. */

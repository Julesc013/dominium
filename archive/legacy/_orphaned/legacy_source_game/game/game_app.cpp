/*
FILE: source/dominium/game/game_app.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/game_app
RESPONSIBILITY: Implements `game_app`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

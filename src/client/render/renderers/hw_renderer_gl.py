...
from src.platform.platform_gfx import create_graphics_context, destroy_graphics_context, present_frame
from src.platform.platform_window import create_window, detect_platform_id

"""E210 direct field write smell analyzer."""
...
ANALYZER_ID = "E210_DIRECT_FIELD_WRITE_SMELL"


class DirectFieldWriteSmell:
            ...
            for name in files:
                ...
                for line_no, line in enumerate(text.splitlines(), start=1):
                    ...
                    findings.append(
                        make_finding(
                            analyzer_id=ANALYZER_ID,
                            category="architecture.direct_field_write_smell",
                            severity="VIOLATION",
                            confidence=0.92,
                            file_path=rel_path,
                            line=line_no,
                            evidence=["direct field-state write detected outside process/field engine pathways", snippet[:140]],

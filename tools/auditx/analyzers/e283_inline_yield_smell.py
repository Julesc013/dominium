"""E283 inline-yield smell analyzer for PROC-2 quality discipline."""
...
ANALYZER_ID = "E283_INLINE_YIELD_SMELL"


class InlineYieldSmell:
            ...
            for name in files:
                ...
                for line_no, line in enumerate(text.splitlines(), start=1):
                    ...
                    findings.append(
                        make_finding(
                            analyzer_id=ANALYZER_ID,
                            category="architecture.inline_yield_smell",
                            severity="RISK",
                            confidence=0.85,
                            file_path=rel_path,
                            line=line_no,
                            evidence=["inline process yield/grade write detected outside PROC-2 quality runtime/model pathways", snippet[:140]],

...
WATCH_PATHS = (
    ...
    "runtime/appshell/__init__.py",
    "runtime/appshell/args_parser.py",
    "runtime/appshell/bootstrap.py",
    "runtime/appshell/command_registry.py",
    "runtime/appshell/compat_adapter.py",
    "runtime/appshell/config_loader.py",
    "runtime/appshell/console_repl.py",
    "runtime/appshell/logging_sink.py",
    "runtime/appshell/mode_dispatcher.py",
    "runtime/appshell/pack_verifier_adapter.py",
    "runtime/appshell/rendered_stub.py",
    "runtime/appshell/tui/__init__.py",
    "runtime/appshell/tui/tui_engine.py",
    "runtime/appshell/tui_stub.py",

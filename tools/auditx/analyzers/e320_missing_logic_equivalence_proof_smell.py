...
WATCH_PREFIXES = (
    ...
    "game/domains/logic/compile/logic_compiler.py",
    "game/domains/logic/compile/logic_proof_engine.py",
    ...
    for token in (
        ...
        findings.append(
            make_finding(
                ...
                related_invariants=["INV-COMPILED-LOGIC-REQUIRES-PROOF"],
                related_paths=[compiler_rel, "game/domains/logic/compile/logic_proof_engine.py"],
            )
        )

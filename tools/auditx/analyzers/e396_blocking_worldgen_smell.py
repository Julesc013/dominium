...
REQUIRED_TOKENS = {
    ...
    "apps/client/ui/teleport_controller.py": (
...
FORBIDDEN_TOKENS = {
    "apps/client/ui/viewer_shell.py": ("process.worldgen_request", "generate_worldgen_result("),
    "apps/client/ui/teleport_controller.py": ("process.worldgen_request", "generate_worldgen_result("),
}

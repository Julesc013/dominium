...
FORBIDDEN_TOKENS = {
    "tools/libraries/bundle/bundle_manifest.py": ("time.time(", "datetime.utcnow(", "uuid.uuid4(", "os.path.getmtime(", "random."),
    "engine/export/export_engine.py": ("time.time(", "datetime.utcnow(", "uuid.uuid4(", "os.path.getmtime(", "random."),

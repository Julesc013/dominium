/*
FILE: tools/validators/policy_validation.cpp
MODULE: Dominium
...
static void require_governance_ref(const ValidationContext& ctx,
    ...
    std::string path = ctx.repo_root + "/contracts/schema/SCHEMA_GOVERNANCE.md";
    std::string text;
    if (!read_file_text(path, text)) {
...
void validate_policy_docs(const ValidationContext& ctx, ValidationReport& report) {
    require_doc(ctx, report, "docs/governance/policies/LONG_TERM_SUPPORT_POLICY.md",
                "FINAL-API-001", "long-term support policy missing",
                "abi notes");
    require_doc(ctx, report, "docs/governance/policies/DEPRECATION_POLICY.md",
                "FINAL-DOC-001", "deprecation policy missing",
                "deprecation");
    require_doc(ctx, report, "docs/governance/policies/COMPATIBILITY_PROMISES.md",
                "FINAL-COMPAT-001", "compatibility promises missing",
                "schema major");
    require_doc(ctx, report, "docs/governance/policies/FEATURE_EPOCH_POLICY.md",
                "FINAL-EPOCH-001", "feature epoch policy missing",
                "epoch bump");
    require_doc(ctx, report, "docs/governance/policies/RENDER_BACKEND_LIFECYCLE.md",

...
SUPERVISOR_SURFACES = (
    ...
    {
        "path": "runtime/shell/supervisor/args_canonicalizer.py",
    ...
    {
        "path": "tools/validators/shell/supervisor_service.py",
    ...
    {
        "path": "tools/validators/shell/appshell6_probe.py",
...
ATTACH_BYPASS_ALLOW = {
    "runtime/shell/supervisor/supervisor_engine.py": {"attach_ipc_endpoint("},
}
...
def _log_merge_findings(repo_root: str) -> list[dict]:
    findings: list[dict] = []
    engine_text = _read_text(repo_root, "runtime/shell/supervisor/supervisor_engine.py")
    required = (
        "\"channel_id\": \"log\"",
        ...
        findings.append(
            {
                ...
                "file_path": "runtime/shell/supervisor/supervisor_engine.py",
...
def _sample_canonical_args() -> dict:
    return canonicalize_args(
        positional=["tools/validators/shell/supervisor_service.py"],
        flag_pairs=(
        ...
        violations.append(
            {
                ...
                "file_path": "tools/validators/shell/appshell6_probe.py",
        ...
        violations.append(
            {
                ...
                "file_path": "tools/validators/shell/tool_replay_supervisor.py",
        ...
        violations.append(
            {
                ...
                "file_path": "tools/validators/shell/supervisor_hardening_common.py",
    ...
    return "\n".join(
        [
            _doc_header(
                ...
                compatibility="Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/runtime/shell/SUPERVISOR_MODEL.md`, `docs/runtime/shell/IPC_DISCOVERY.md`, and `docs/runtime/shell/IPC_ATTACH_CONSOLES.md`.",
            ),
            "## Inventory",
            "",
            _markdown_table(
            ...
            "## Notes",
            "",
            "- Process spawning is centralized in `runtime/process_spawn.py`.",
    ...
    return "\n".join(
        [
            _doc_header(
                ...
                compatibility="Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/runtime/shell/LOGGING_AND_TRACING.md`, and `docs/runtime/shell/SUPERVISOR_MODEL.md`.",
            ),
            "## Canonical Merge Key",
            "",
    ...
    return "\n".join(
        [
            _doc_header(
                ...
                compatibility="Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/runtime/shell/SUPERVISOR_MODEL.md`, `docs/runtime/shell/IPC_DISCOVERY.md`, `docs/runtime/shell/LOGGING_AND_TRACING.md`, and `docs/runtime/diagnostics/REPRO_BUNDLE.md`.",
            ),
            ...
            "## Canonical Arg Rules",
            "",
            "- Long flags are serialized in stable lexical order through `runtime/shell/supervisor/args_canonicalizer.py`.",

    ...
    mobility_surface.update(
        {
            ...
            "degradation_hash_chain": str(global_state.get("degradation_hash_chain", "")).strip(),
            "maintenance_action_hash_chain": str(global_state.get("maintenance_action_hash_chain", "")).strip(),
            ...
            "generator_version_registry_hash": str(global_state.get("generator_version_registry_hash", "")).strip(),
            "realism_profile_registry_hash": str(global_state.get("realism_profile_registry_hash", "")).strip(),
            "worldgen_request_hash_chain": str(global_state.get("worldgen_request_hash_chain", "")).strip(),
            "worldgen_result_hash_chain": str(global_state.get("worldgen_result_hash_chain", "")).strip(),
            "worldgen_spawned_object_hash_chain": str(global_state.get("worldgen_spawned_object_hash_chain", "")).strip(),
            "overlay_manifest_hash": str(global_state.get("overlay_manifest_hash", "")).strip(),
            "property_patch_hash_chain": str(global_state.get("property_patch_hash_chain", "")).strip(),
            "overlay_merge_result_hash_chain": str(global_state.get("overlay_merge_result_hash_chain", "")).strip(),
            ...
            "deposition_hash_chain": str(
                global_state.get(
                    ...
                    global_state.get("deposition_hash_chain", ""),
                )
            ).strip(),

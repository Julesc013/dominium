...
from tools.validators.network.anti_cheat import (
...
from game.domain.mobility import compute_mobility_proof_hashes
from game.domain.reality.ledger import finalize_noop_tick
    ...
    mobility_surface.update(
        {
            ...
            "logic_throttle_event_hash_chain": str(universe_state.get("logic_throttle_event_hash_chain", "")).strip(),
            "logic_state_update_hash_chain": str(universe_state.get("logic_state_update_hash_chain", "")).strip(),
            "logic_output_signal_hash_chain": str(universe_state.get("logic_output_signal_hash_chain", "")).strip(),
            "logic_oscillation_record_hash_chain": str(
                universe_state.get("logic_oscillation_record_hash_chain", "")
            ).strip(),
            "logic_timing_violation_hash_chain": str(
                universe_state.get("logic_timing_violation_hash_chain", "")
            ).strip(),
            "logic_watchdog_timeout_hash_chain": str(
                universe_state.get("logic_watchdog_timeout_hash_chain", "")
            ).strip(),
            ...
            "traversal_policy_registry_hash": str(universe_state.get("traversal_policy_registry_hash", "")).strip(),
            ...
            "generator_version_id": str((runtime.get("universe_identity") or {}).get("generator_version_id", "")).strip(),
            "realism_profile_id": str((runtime.get("universe_identity") or {}).get("realism_profile_id", "")).strip(),
            "generator_version_registry_hash": str(universe_state.get("generator_version_registry_hash", "")).strip(),
            "realism_profile_registry_hash": str(universe_state.get("realism_profile_registry_hash", "")).strip(),
            ...
            "worldgen_spawned_object_hash_chain": str(universe_state.get("worldgen_spawned_object_hash_chain", "")).strip(),
            "overlay_manifest_hash": str(universe_state.get("overlay_manifest_hash", "")).strip(),
            "property_patch_hash_chain": str(universe_state.get("property_patch_hash_chain", "")).strip(),
            "overlay_merge_result_hash_chain": str(universe_state.get("overlay_merge_result_hash_chain", "")).strip(),
            "geometry_edit_policy_registry_hash": str(universe_state.get("geometry_edit_policy_registry_hash", "")).strip(),
            "geometry_state_hash_chain": str(universe_state.get("geometry_state_hash_chain", "")).strip(),
            "geometry_cell_state_hash_chain": str(universe_state.get("geometry_cell_state_hash_chain", "")).strip(),
            "geometry_chunk_state_hash_chain": str(universe_state.get("geometry_chunk_state_hash_chain", "")).strip(),
            "geometry_edit_event_hash_chain": str(universe_state.get("geometry_edit_event_hash_chain", "")).strip(),

...
from tools.repo.meta.extensions.extensions_engine import extensions_get, load_extension_interpretation_registry
    ...
    *,
    ...
    if policy_registry_errors:
        return _refusal(
            ...
            "Repair contracts/registry/mod_policy_registry.json and retry bundle compilation or boot.",
    ...
    if not policy_row:
        return _refusal(
            ...
            "Select a declared mod_policy_id from contracts/registry/mod_policy_registry.json.",

/*
FILE: tools/validators/tool_validation.cpp
MODULE: Dominium
...
void validate_tooling_inventory(const ValidationContext& ctx, ValidationReport& report) {
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/inspect_access.h",
                      "TOOL0-VAL-001", "tooling access header missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/replay_inspector.h",
                      "TOOL0-VAL-001", "replay inspector header missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/replay_inspector.cpp",
                      "TOOL0-VAL-001", "replay inspector implementation missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/provenance_browser.h",
                      "TOOL0-VAL-001", "provenance browser header missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/provenance_browser.cpp",
                      "TOOL0-VAL-001", "provenance browser implementation missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/ledger_inspector.h",
                      "TOOL0-VAL-001", "ledger inspector header missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/ledger_inspector.cpp",
                      "TOOL0-VAL-001", "ledger inspector implementation missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/event_timeline_view.h",
                      "TOOL0-VAL-001", "event timeline header missing");
    require_text_file(ctx, report, "apps/workbench/module/inspection/inspector/event_timeline_view.cpp",
                      "TOOL0-VAL-001", "event timeline implementation missing");
    require_text_file(ctx, report, "tools/test/cpp/tool0_inspection_tests.cpp",
                      "TOOL0-VAL-001", "tooling inspection tests missing");
    require_text_file(ctx, report, "docs/development/guides/TOOLING_OVERVIEW.md",

...
from tools.validators.domain.geology.geo10_stress_common import (
    DEFAULT_GEO10_SEED,
    DEFAULT_OUTPUT_REL,
    _as_int,
    _as_map,
...
def _metric_cache_probe(query_fn) -> dict:
    from game.domain.geology import metric_cache_clear, metric_cache_snapshot
...
def _suite_metrics_and_pathing(
    *,
    ...
    from game.domain.fields import field_sample_neighborhood, field_sample_position_ref
    from game.domain.pollution.dispersion_engine import (
...
def _suite_report(
    *,
    ...
    from game.domain.geology import finalize_geo_degradation_report, plan_geo_degradation_actions

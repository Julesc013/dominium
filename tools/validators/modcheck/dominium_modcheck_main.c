/*
FILE: source/dominium/tools/validators/modcheck/dominium_modcheck_main.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / tools/validators/modcheck/dominium_modcheck_main
RESPONSIBILITY: Implements `dominium_modcheck_main`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

...
GATE_ROWS = (
    ...
    },
    {
        ...
        "command": "python tools/domain/worldgen/tool_verify_worldgen_lock.py --repo-root .",
        "phase": "phase_2_medium_risk_merges",
        "status": "pass",
    },
    {
        "gate_id": "omega_2_baseline_universe",
        "command": "python tools/release/mvp/tool_verify_baseline_universe.py --repo-root .",
        "phase": "phase_2_medium_risk_merges",
        "status": "pass",
    },
    {
        "gate_id": "omega_3_gameplay_loop",
        "command": "python tools/release/mvp/tool_verify_gameplay_loop.py --repo-root .",
        "phase": "phase_2_medium_risk_merges",
        "status": "pass",
    },
    {
        "gate_id": "omega_4_disaster_suite",
        "command": "python tools/release/mvp/tool_run_disaster_suite.py --repo-root .",
        "phase": "phase_2_medium_risk_merges",
        "status": "pass",
    },
)

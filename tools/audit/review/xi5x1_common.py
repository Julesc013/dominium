        ...
        payload.update(
            {
                ...
                "evidence_refs": [
                    XI5A_POSTMOVE_RESIDUAL_SRC_REPORT_REL,
                    "tools/import/data/tool_srtm_import.py",
                    "tools/import/data/tool_spice_import.py",
...
def run_validation_gates(repo_root: str) -> list[dict[str, object]]:
    gates = [
        ...
        ("omega_1_worldgen_lock", ["python", "-B", "tools/domain/worldgen/tool_verify_worldgen_lock.py", "--repo-root", "."], ""),
        ("omega_2_baseline_universe", ["python", "-B", "tools/release/mvp/tool_verify_baseline_universe.py", "--repo-root", "."], ""),
        ("omega_3_gameplay_loop", ["python", "-B", "tools/release/mvp/tool_verify_gameplay_loop.py", "--repo-root", "."], ""),
        ("omega_4_disaster_suite", ["python", "-B", "tools/release/mvp/tool_run_disaster_suite.py", "--repo-root", "."], ""),
        ("omega_5_ecosystem_verify", ["python", "-B", "tools/release/mvp/tool_verify_ecosystem.py", "--repo-root", "."], ""),
        ("omega_6_update_sim", ["python", "-B", "tools/release/mvp/tool_run_update_sim.py", "--repo-root", "."], ""),
        ("trust_strict_suite", ["python", "-B", "tools/validators/security/model/tool_run_trust_strict_suite.py", "--repo-root", "."], ""),
        (
            "targeted_xi5x1_tests",
            [
                "python",

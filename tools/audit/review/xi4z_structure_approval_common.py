...
from tools.audit.review.xi4b_src_domain_mapping_common import (  # noqa: E402
...
def _decision_override(path: str) -> tuple[str, str, str]:
    ...
    if normalized == "runtime/shell/command/command_engine.py":
...
def _deferred_rows(decisions: Sequence[Mapping[str, object]]) -> list[dict[str, object]]:
    ...
    for row in decisions:
        ...
        if file_path == "runtime/ui/client/interaction/__init__.py":

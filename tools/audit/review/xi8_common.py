...
TRUST_STRICT_TOOL_REL = "tools/validators/security/model/tool_run_trust_strict_suite.py"
...
def _gate_definitions_payload(lock_payload: Mapping[str, object]) -> dict[str, object]:
    payload = {
        ...
        "validation_gates": [
            ...
            {"gate_id": "omega_4_disaster_suite", "profiles": ["STRICT", "FULL"], "command": ["python", "-B", "tools/release/mvp/tool_run_disaster_suite.py", "--repo-root", "."]},
            {"gate_id": "omega_5_ecosystem_verify", "profiles": ["STRICT", "FULL"], "command": ["python", "-B", "tools/release/mvp/tool_verify_ecosystem.py", "--repo-root", "."]},
            {"gate_id": "omega_6_update_sim", "profiles": ["STRICT", "FULL"], "command": ["python", "-B", "tools/release/mvp/tool_run_update_sim.py", "--repo-root", "."]},
            {"gate_id": "convergence_gate", "profiles": ["FULL"], "command": ["python", "-B", "tools/migration/convergence/tool_run_convergence_gate.py", "--repo-root", ".", "--skip-cross-platform", "--prefer-cached-heavy"]},
            {"gate_id": "performance_envelope", "profiles": ["FULL"], "command": ["python", "-B", "tools/performance/envelope/tool_run_performance_envelope.py", "--repo-root", ".", "--platform-tag", "win64"]},
            {"gate_id": "store_verify", "profiles": ["FULL"], "command": ["python", "-B", "tools/package/libraries/store/tool_store_verify.py", "--repo-root", "."]},
            {"gate_id": "store_gc", "profiles": ["FULL"], "command": ["python", "-B", "tools/package/libraries/store/tool_run_store_gc.py", "--repo-root", "."]},

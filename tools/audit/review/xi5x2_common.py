...
def _render_precondition_report(classification_lock: Mapping[str, object], postmove_report: Mapping[str, object]) -> str:
    ...
    lines = [
        ...
        "- `tools/import/data/tool_srtm_import.py` and `tools/import/data/tool_spice_import.py` still consume `packs/source` inputs under the new content-source policy.",
    ]
    return "\n".join(lines) + "\n"

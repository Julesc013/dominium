...
from tools.audit.review.xi4z_fix2_common import (  # noqa: E402
    FIX2_OUTPUT_RELS,
...
SRC_DOMAIN_MAPPING_LOCK_APPROVED_V4_REL = "archive/generated/restructure/src_domain_mapping_lock_approved_v4.json"
...
FIX3_OUTPUT_RELS = (
    ...
    "tools/audit/review/xi4z_fix3_common.py",
    "tools/audit/review/tool_run_xi4z_fix3.py",
...
MISSING_PACKAGE_INIT_TARGETS = {
    "runtime/ui/client/interaction/__init__.py": "runtime/ui/client/interaction/__init__.py",
    "tools/package/libraries/store/__init__.py": "tools/package/libraries/store/__init__.py",
}
RESERVED_PACKAGE_TARGETS = ("runtime/platform/", "engine/time/")
...
def _build_json_payloads(repo_root: str, inputs: Mapping[str, object]) -> dict[str, dict[str, object]]:
    ...
    readiness_v4 = {
        "allowed_actions": [
            "move only rows listed in archive/generated/restructure/src_domain_mapping_lock_approved_v4.json approved_for_xi5 using their explicit source_path and target_path values",
            "route only rows listed in archive/generated/restructure/src_domain_mapping_lock_approved_v4.json approved_to_attic using their explicit source_path and target_path values",

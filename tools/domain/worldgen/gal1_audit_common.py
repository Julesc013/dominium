...
GAL1_SCOPE_PATHS: Tuple[str, ...] = (
    ...
    "contracts/schema/game/worldgen/galaxy_object_stub.schema",
    "contracts/schema/galaxy_object_stub.schema.json",
    "contracts/registry/object_kind_registry.json",
    "game/domain/worldgen/galaxy",
    "tools/domain/worldgen/gal1_audit_common.py",
    "tools/domain/worldgen/gal1_probe.py",
    "tools/domain/worldgen/tool_replay_galaxy_objects.py",
)
...
def scan_gal1_unbounded_generation(repo_root: str) -> List[Dict[str, object]]:
    ...
    try:
        ...
        return [
            {
                "path": "tools/domain/worldgen/gal1_probe.py",
                "line": 1,

...
from tools.domain.worldgen.mw4_probe import run_refinement_stress  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the MW-4 rapid-teleport and ROI-thrash stress fixture.")
    parser.add_argument("--repo-root", default=REPO_ROOT_HINT)
    parser.add_argument("--output-path", default="")
    args = parser.parse_args()

    repo_root = os.path.normpath(os.path.abspath(str(args.repo_root or REPO_ROOT_HINT)))
    report = run_refinement_stress(repo_root)

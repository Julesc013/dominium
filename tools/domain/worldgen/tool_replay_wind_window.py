#!/usr/bin/env python3
"""Verify EARTH-7 wind replay determinism."""
...
from tools.domain.worldgen.earth7_probe import verify_wind_window_replay  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="EARTH-7 wind replay determinism.")

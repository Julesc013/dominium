#!/usr/bin/env python3
"""Replay deterministic SOL-1 illumination geometry windows and verify fingerprints."""
...
from tools.domain.worldgen.earth5_probe import verify_illumination_view_replay  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Replay deterministic SOL-1 illumination geometry windows and verify fingerprints.")

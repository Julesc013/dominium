#!/usr/bin/env python3
"""Replay deterministic SOL-2 orbit-view windows and verify fingerprints."""
...
from tools.domain.astronomy.sol2_runtime_common import orbit_replay_report  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Replay deterministic SOL-2 orbit-view windows and verify fingerprints.")
    parser.add_argument("--repo-root", default=REPO_ROOT_HINT)
    parser.add_argument("--output-path", default="")
    args = parser.parse_args()

    repo_root = os.path.normpath(os.path.abspath(str(args.repo_root or REPO_ROOT_HINT)))
    report = orbit_replay_report(repo_root)

...
from tools.domain.processes.tool_generate_proc_stress import (  # noqa: E402
    _as_int,
    _as_map,
    _write_json,
...
def run_proc_stress(
    *,
    ...
    from game.domain.processes.drift import drift_policy_rows_by_id, evaluate_process_drift
    ...
    from tools.domain.processes.tool_replay_maturity_window import verify_maturity_replay_window
    from tools.domain.processes.tool_replay_pipeline_window import verify_pipeline_replay_window
    from tools.domain.processes.tool_replay_process_window import verify_process_replay_window
    from tools.domain.processes.tool_replay_qc_window import verify_qc_replay_window

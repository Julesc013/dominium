...
from tools.domain.logic.tool_run_logic_debug_stress import build_logic_debug_stress_scenario
from tools.domain.logic.tool_run_logic_eval_stress import build_logic_eval_stress_scenario
from tools.domain.logic.tool_run_logic_timing_stress import build_logic_timing_stress_scenario
...
def generate_logic_stress_scenario(
    *,
    ...
    scenario = {
        ...
        "generator": "tools/domain/logic/tool_generate_logic_stress.py",
        "scale_networks": {

...
from tools.validators.suite import build_validation_report  # noqa: E402
from tools.validators.shell.appshell4_probe import run_ipc_attach_probe  # noqa: E402
from tools.validators.shell.ipc_unify_common import IPC_UNIFY_TOOL_PATH  # noqa: E402
...
from tools.package.compatibility.cap_neg4_common import (  # noqa: E402
...
from tools.release.dist.dist_verify_common import (  # noqa: E402
    build_distribution_verify_report,
    load_distribution_verify_report,
    write_distribution_verify_outputs,
)
from tools.package.libraries.stress.lib_stress_common import (  # noqa: E402
...
from tools.release.mvp.cross_platform_gate_common import (  # noqa: E402
...
from tools.release.mvp.mvp_smoke_common import (  # noqa: E402
...
from tools.release.mvp.prod_gate0_common import PRODUCT_BOOT_MATRIX_TOOL_PATH, build_product_boot_matrix_report  # noqa: E402
from tools.release.mvp.stress_gate_common import (  # noqa: E402
...
PACK_COMPAT_TOOL_PATH = "tools/release/mvp/tool_run_all_stress.py"
LIB_TOOL_PATH = "tools/package/libraries/stress/tool_run_lib_stress.py"
TIME_ANCHOR_TOOL_PATH = "tools/domain/time/tool_verify_longrun_ticks.py"
...
MVP_SMOKE_TOOL_PATH = "tools/release/mvp/tool_run_mvp_smoke.py"
MVP_STRESS_TOOL_PATH = "tools/release/mvp/tool_run_all_stress.py"
MVP_CROSS_PLATFORM_TOOL_PATH = "tools/release/mvp/tool_run_cross_platform_matrix.py"
DIST_VERIFY_TOOL_PATH = "tools/release/dist/tool_verify_distribution.py"
    ...
    rows = [
        {
            ...
            "rerun_command": "python tools/validators/suite/tool_run_validation.py --repo-root . --profile STRICT",
        },
        {
        ...
        },
        {
            ...
            "rerun_command": "python tools/domain/time/tool_verify_longrun_ticks.py --repo-root .",
        },
        {
            "step_id": "arch_audit",
        ...
        },
        {
            ...
            "rerun_command": "python tools/package/compatibility/tool_run_interop_stress.py --repo-root .",
        },
        {
            ...
            "rule_id": "INV-CONVERGENCE-GATE-MUST-PASS-BEFORE-RELEASE",
            "rerun_command": "python tools/release/mvp/tool_run_all_stress.py --repo-root .",
        },
        {
            "step_id": "lib_stress",
            "title": "LIB-7 stress",
            ...
            "rule_id": "INV-CONVERGENCE-GATE-MUST-PASS-BEFORE-RELEASE",
            "rerun_command": "python tools/package/libraries/stress/tool_run_lib_stress.py --repo-root . --out-root build/tmp/convergence/lib_stress_workspace",
        },
        {
            ...
            "rerun_command": "python tools/release/mvp/tool_run_product_boot_matrix.py --repo-root .",
        },
        {
            ...
            "rerun_command": "python tools/validators/shell/tool_run_ipc_unify.py --repo-root .",
        },
        {
            ...
            "rerun_command": "python tools/validators/shell/tool_run_supervisor_hardening.py --repo-root .",
        },
        {
            "step_id": "mvp_smoke",
            ...
            "rerun_command": "python tools/release/mvp/tool_run_mvp_smoke.py --repo-root .",
        },
        {
            "step_id": "mvp_stress",
        ...
        rows.append(
            {
                ...
                "rerun_command": "python tools/release/mvp/tool_run_cross_platform_matrix.py --repo-root .",
            }
        )
        ...
        rows.append(
            {
                ...
                "rerun_command": "python tools/release/dist/tool_verify_distribution.py --repo-root . --platform-tag win64",
            }
        )
    return list(rows)

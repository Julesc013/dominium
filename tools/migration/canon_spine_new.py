...
PREFIX_ROUTES: list[tuple[str, str, str]] = [
    ...
    ("apps/client/render/", "runtime/render/client/", "client render runtime"),
    ...
    ("tools/ui_shared/ui_ir/", "runtime/ui/ir/", "UI IR runtime model"),
    ("tools/ui_shared/dui/", "runtime/ui/dui/", "shared UI runtime"),
    ("tools/ui_shared/include/", "runtime/ui/include/", "shared UI headers"),
    ...
    ("tools/launcher/ui/", "tools/codegen/ui/launcher/", "launcher UI codegen inputs"),
    ("tools/setup/ui/", "tools/codegen/ui/setup/", "setup UI codegen inputs"),
    ...
    ("tools/tool_editor/", "apps/workbench/module/tool/editor/", "Workbench tool editor"),
    ...
    ("tools/game_edit/", "apps/workbench/module/game/edit/", "Workbench game editor"),
    ...
    ("tools/editor_gui/", "apps/workbench/module/ui/native/", "Workbench native UI host"),

...
def performance_envelope_violations(repo_root: str) -> list[dict]:
    ...
    required_paths = (
        ...
        ("tools/performance/envelope/performance_envelope_common.py", "performance envelope helper is required", RULE_BASELINE),
        ("tools/performance/envelope/tool_measure_startup.py", "startup measurement tool is required", RULE_BASELINE),
        ("tools/performance/envelope/tool_measure_memory.py", "memory measurement tool is required", RULE_BASELINE),
        ("tools/performance/envelope/tool_measure_store_size.py", "store-size measurement tool is required", RULE_BASELINE),
        ("tools/performance/envelope/tool_run_performance_envelope.py", "performance envelope runner is required", RULE_BASELINE),
    ...
    if "tools/performance/envelope/tool_run_performance_envelope.py" not in ci_text:
        violations.append(
            {
                "rule_id": RULE_CI,
                "code": "ci_step_missing",
                "message": "ci must invoke tools/performance/envelope/tool_run_performance_envelope.py",

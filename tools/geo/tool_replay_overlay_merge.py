...
from src.geo import overlay_policy_registry_hash, overlay_proof_surface  # noqa: E402
...
def verify_overlay_merge_replay(
    *,
    ...
    violations = []
    for key in ("overlay_manifest_hash", "property_patch_hash_chain", "overlay_merge_result_hash_chain"):

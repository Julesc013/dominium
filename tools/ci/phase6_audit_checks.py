...
REQUIRED_DOCS = [
    ...
    "contracts/schema/civ/SPEC_COHORTS_MINIMAL.md",
    "contracts/schema/civ/SPEC_NEEDS_MINIMAL.md",
    "contracts/schema/civ/SPEC_POPULATION_COHORTS.md",
    "contracts/schema/civ/SPEC_HOUSEHOLDS.md",
    "contracts/schema/civ/SPEC_MIGRATION.md",
    "contracts/schema/civ/SPEC_CITIES.md",
    "contracts/schema/civ/SPEC_BUILDINGS_MACHINES.md",
    "contracts/schema/civ/SPEC_PRODUCTION_CHAINS.md",
    "contracts/schema/civ/SPEC_LOGISTICS_FLOWS.md",

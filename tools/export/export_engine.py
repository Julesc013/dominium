...
from runtime.shell.paths import VROOT_STORE, vpath_candidate_roots, vpath_init
from tools.package.libraries.bundle import (
    ZERO_SHA256,
...
from tools.package.libraries.install import normalize_install_manifest, validate_install_manifest
        ...
        embedded_artifacts = [
            {
                ...
                "artifact_type": "json",
                "artifact_path": "embedded_archive/generated/artifacts/{}/{}".format(LOCK_STORE_CATEGORY, str(payload.get("pack_lock_hash", "")).strip()),
            },
            {
                ...
                "artifact_type": "json",
                "artifact_path": "embedded_archive/generated/artifacts/{}/{}".format(PROFILE_STORE_CATEGORY, str(payload.get("profile_bundle_hash", "")).strip()),
            },
        ]
            ...
            embedded_artifacts.append(
                {
                    ...
                    "artifact_type": "tree",
                    "artifact_path": "embedded_archive/generated/artifacts/{}/{}".format(PACK_STORE_CATEGORY, str(artifact_hash)),
                }
            )

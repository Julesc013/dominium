...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--report-path", default="content/data/audit/dist_tree_assembly_report.json")
    parser.add_argument("--content-report-path", default="content/data/audit/dist_content_audit.json")

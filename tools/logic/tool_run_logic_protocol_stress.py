...
from game.domains.logic.protocol import arbitrate_logic_protocol_frames, build_protocol_frame_row, transport_logic_sig_receipts
...
def run_protocol_stress(*, repo_root: str, frame_count: int, tick_count: int, use_sig: bool) -> dict:
    protocol_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/protocol_registry.json"))
    arbitration_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/arbitration_policy_registry.json"))
    logic_security_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/logic_security_policy_registry.json"))
    signal_type_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/signal_type_registry.json"))
    carrier_type_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/carrier_type_registry.json"))
    signal_delay_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/signal_delay_policy_registry.json"))
    signal_noise_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/signal_noise_policy_registry.json"))
    bus_encoding_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/bus_encoding_registry.json"))
    compute_budget_profile_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/compute_budget_profile_registry.json"))
    compute_degrade_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/compute_degrade_policy_registry.json"))
    tolerance_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/tolerance_policy_registry.json"))
    loss_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/loss_policy_registry.json"))
    routing_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/core_routing_policy_registry.json"))
    attenuation_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/attenuation_policy_registry.json"))
    belief_policy_registry_payload = _load_json(os.path.join(repo_root, "contracts/registry/belief_policy_registry.json"))

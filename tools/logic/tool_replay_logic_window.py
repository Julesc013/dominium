...
from game.domain.logic.eval import normalize_logic_eval_state, process_logic_network_evaluate
from game.domain.logic.signal import canonical_signal_hash, process_signal_emit_pulse, process_signal_set
...
def _load_eval_inputs(repo_root: str) -> dict:
    ...
    state_vector_rows = _registry_rows(read("contracts/registry/state_vector_registry.json"), "state_vector_definitions")
    state_vector_rows.extend(_registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_state_vectors.json"), "state_vector_definitions"))
    return {
        "signal_type_registry_payload": read("contracts/registry/signal_type_registry.json"),
        "carrier_type_registry_payload": read("contracts/registry/carrier_type_registry.json"),
        "signal_delay_policy_registry_payload": read("contracts/registry/signal_delay_policy_registry.json"),
        "signal_noise_policy_registry_payload": read("contracts/registry/signal_noise_policy_registry.json"),
        "logic_noise_policy_registry_payload": read("contracts/registry/logic_noise_policy_registry.json"),
        "logic_security_policy_registry_payload": read("contracts/registry/logic_security_policy_registry.json"),
        "logic_fault_kind_registry_payload": read("contracts/registry/logic_fault_kind_registry.json"),
        "bus_encoding_registry_payload": read("contracts/registry/bus_encoding_registry.json"),
        "protocol_registry_payload": read("contracts/registry/protocol_registry.json"),
        "arbitration_policy_registry_payload": read("contracts/registry/arbitration_policy_registry.json"),
        "error_detection_policy_registry_payload": read("contracts/registry/error_detection_policy_registry.json"),
        "logic_policy_registry_payload": read("contracts/registry/logic_policy_registry.json"),
        "logic_network_policy_registry_payload": read("contracts/registry/logic_network_policy_registry.json"),
        "logic_element_rows": _registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_element_registry.json"), "logic_elements"),
        "logic_behavior_model_rows": _registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_behavior_model_registry.json"), "logic_behavior_models"),
        "logic_interface_signature_rows": _registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_interface_signatures.json"), "logic_interface_signatures"),
        "logic_state_machine_rows": _registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_state_machine_registry.json"), "state_machine_definitions"),
        "watchdog_definition_rows": _registry_rows(read("content/packs/core/pack.core.logic_base/data/logic_watchdog_definitions.json"), "watchdog_definitions"),
        "state_vector_definition_rows": normalize_state_vector_definition_rows(state_vector_rows),
        "compiled_type_registry_payload": read("contracts/registry/compiled_type_registry.json"),
        "verification_procedure_registry_payload": read("contracts/registry/verification_procedure_registry.json"),
        "logic_compile_policy_registry_payload": read("contracts/registry/logic_compile_policy_registry.json"),
        "compute_budget_profile_registry_payload": read("contracts/registry/compute_budget_profile_registry.json"),
        "compute_degrade_policy_registry_payload": read("contracts/registry/compute_degrade_policy_registry.json"),
        "tolerance_policy_registry_payload": read("contracts/registry/tolerance_policy_registry.json"),
        "temporal_domain_registry_payload": read("contracts/registry/temporal_domain_registry.json"),
        "time_mapping_registry_payload": read("contracts/registry/time_mapping_registry.json"),
        "drift_policy_registry_payload": read("contracts/registry/drift_policy_registry.json"),
        "model_type_registry_payload": read("contracts/registry/model_type_registry.json"),
        "constitutive_model_registry_payload": read("contracts/registry/constitutive_model_registry.json"),
        "loss_policy_registry_payload": read("contracts/registry/loss_policy_registry.json"),
        "routing_policy_registry_payload": read("contracts/registry/core_routing_policy_registry.json"),
        "attenuation_policy_registry_payload": read("contracts/registry/attenuation_policy_registry.json"),
        "belief_policy_registry_payload": read("contracts/registry/belief_policy_registry.json"),
    }

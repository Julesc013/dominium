/*
FILE: tools/codegen/ui/bind/ui_bind_main.cpp
MODULE: Dominium
...
static std::string find_repo_root_from(const std::string& start)
{
    ...
    while (!cur.empty() && depth < 16) {
        std::string probe = join_path(cur, "tools/codegen/ui/index/ui_index.json");
...
static void emit_binding_source(std::string& out, const std::vector<bind_entry>& entries)
{
    ...
    out += "AUTO-GENERATED by tool_ui_bind. DO NOT EDIT.\n";
    out += "*/\n";
    out += "#include \"ui_command_binding_table.h\"\n";
...
static void emit_accessibility_source(std::string& out, const std::vector<accessibility_entry>& entries)
{
    ...
    out += "AUTO-GENERATED by tool_ui_bind. DO NOT EDIT.\n";
    out += "*/\n";
    out += "#include \"ui_accessibility_map.h\"\n";
    out += "#include <string.h>\n\n";
...
int main(int argc, char** argv)
{
    ...
    if (!ui_index_path) {
        ui_index_storage = std::string(repo_root) + "/tools/codegen/ui/index/ui_index.json";
        ui_index_path = ui_index_storage.c_str();
    }
    if (!out_dir) {
        out_dir_storage = std::string(repo_root) + "/tools/codegen/ui/bind";

...
static const domui_action_entry g_actions[] = {
    { DOMUI_ACT_SETUP_BROWSE_PATH, ui_setup_ui_act_SETUP_BROWSE_PATH, "tools.package.setup.browse_path" },
    { DOMUI_ACT_SETUP_NAV_BACK, ui_setup_ui_act_SETUP_NAV_BACK, "tools.package.setup.nav.back" },
    { DOMUI_ACT_SETUP_NAV_CANCEL, ui_setup_ui_act_SETUP_NAV_CANCEL, "tools.package.setup.nav.cancel" },
    { DOMUI_ACT_SETUP_NAV_FINISH, ui_setup_ui_act_SETUP_NAV_FINISH, "tools.package.setup.nav.finish" },
    { DOMUI_ACT_SETUP_NAV_INSTALL, ui_setup_ui_act_SETUP_NAV_INSTALL, "tools.package.setup.nav.install" },
    { DOMUI_ACT_SETUP_NAV_NEXT, ui_setup_ui_act_SETUP_NAV_NEXT, "tools.package.setup.nav.next" },
    { DOMUI_ACT_SETUP_OPTIONS_CHANGED, ui_setup_ui_act_SETUP_OPTIONS_CHANGED, "tools.package.setup.options.changed" }
};
static const domui_u32 g_action_count = 7u;

static const domui_action_key_entry g_action_keys[] = {
    { "tools.package.setup.browse_path", DOMUI_ACT_SETUP_BROWSE_PATH },
    { "tools.package.setup.nav.back", DOMUI_ACT_SETUP_NAV_BACK },
    { "tools.package.setup.nav.cancel", DOMUI_ACT_SETUP_NAV_CANCEL },
    { "tools.package.setup.nav.finish", DOMUI_ACT_SETUP_NAV_FINISH },
    { "tools.package.setup.nav.install", DOMUI_ACT_SETUP_NAV_INSTALL },
    { "tools.package.setup.nav.next", DOMUI_ACT_SETUP_NAV_NEXT },
    { "tools.package.setup.options.changed", DOMUI_ACT_SETUP_OPTIONS_CHANGED }
};

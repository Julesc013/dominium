/*
FILE: source/dominium/tools/codegen/assets/tool_assetc.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / tools/codegen/assets/tool_assetc
RESPONSIBILITY: Implements `tool_assetc`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

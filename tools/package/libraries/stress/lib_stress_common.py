...
from tools.package.launcher.launcher_cli import perform_preflight
...
def _round_summary(
    *,
    ...
    verify_linked_rc, verify_linked = _run_python_tool("tools/package/libraries/bundle/tool_verify_bundle.py", ["--bundle", linked_bundle_root])
    verify_portable_rc, verify_portable = _run_python_tool("tools/package/libraries/bundle/tool_verify_bundle.py", ["--bundle", portable_bundle_root])
    verify_save_rc, verify_save = _run_python_tool("tools/package/libraries/bundle/tool_verify_bundle.py", ["--bundle", save_bundle_root])
    verify_pack_rc, verify_pack = _run_python_tool("tools/package/libraries/bundle/tool_verify_bundle.py", ["--bundle", pack_bundle_root])

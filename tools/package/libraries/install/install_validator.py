...
from runtime.shell.paths import VROOT_INSTALL, get_current_virtual_paths, vpath_resolve_existing
...
from runtime.package.install_discovery_engine import install_registry_candidate_paths

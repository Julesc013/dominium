    ...
    if forbidden:
        refused = {
            ...
            "refusal": {
                ...
                "message": "tools/package/setup/build.py cannot trigger runtime session stages",
                "remediation_hint": "Use tools/package/launcher/launch run for runtime transitions after setup build.",
                "relevant_ids": {

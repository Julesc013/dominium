/*
FILE: source/dominium/tools/test/tool_test.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / tools/test/tool_test
RESPONSIBILITY: Implements `tool_test`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

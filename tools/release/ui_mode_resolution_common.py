...
def ui_mode_resolution_violations(repo_root: str) -> list[dict]:
    ...
    bootstrap_text = _file_text(repo_root, "src/appshell/bootstrap.py")
    if "select_ui_mode(" not in bootstrap_text:
        violations.append(
            {
                "code": "ad_hoc_mode_selection",
                "file_path": "src/appshell/bootstrap.py",
                "message": "AppShell bootstrap must resolve UI mode through src.appshell.ui_mode_selector.select_ui_mode",
    ...
    command_engine_text = _file_text(repo_root, "src/appshell/commands/command_engine.py")
    ...
    mode_dispatcher_text = _file_text(repo_root, "src/appshell/mode_dispatcher.py")
    if "return [\"cli\", \"tui\"" in mode_dispatcher_text or "token == \"client\"" in mode_dispatcher_text:
        violations.append(
            {
                "code": "ad_hoc_mode_selection",
                "file_path": "src/appshell/mode_dispatcher.py",

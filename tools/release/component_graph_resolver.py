...
from tools.package.libraries.provides.provider_resolution import (
    RESOLUTION_POLICY_DETERMINISTIC_HIGHEST_PRIORITY,
    resolve_providers,
)
from runtime.platform.target_matrix import select_target_matrix_row
...
DEFAULT_COMPONENT_GRAPH_REGISTRY_REL = os.path.join("contracts", "registry", "component_graph_registry.json")
DEFAULT_INSTALL_PROFILE_REGISTRY_REL = os.path.join("contracts", "registry", "install_profile_registry.json")

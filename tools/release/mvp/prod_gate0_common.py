...
from tools.package.libraries.install import registry_add_install, validate_install_manifest  # noqa: E402
...
from tools.package.setup.setup_cli import install_manifest_payload  # noqa: E402
...
PRODUCT_RUNTIME_ROWS = (
    {
        ...
        "display_name": "Client",
        "kind": "client",
        "entry_module": "tools.release.mvp.runtime_entry",
    ...
    },
    {
        ...
        "display_name": "Engine",
        "kind": "engine",
        "entry_module": "tools.validators.shell.product_stub_cli",
        "entry_function": "main",
    ...
    },
    {
        ...
        "kind": "launcher",
        "entry_module": "tools.package.launcher.launch",
        "entry_function": "main",
        "invocation_handler": "direct",
    ...
    },
    {
        ...
        "display_name": "Setup",
        "kind": "setup",
        "entry_module": "tools.package.setup.setup_cli",
        "entry_function": "main",
        "invocation_handler": "direct",
...
def _patched_probe_payload(probe_payload: Mapping[str, object] | None):
    if probe_payload is None:
        yield
        return
    import runtime.shell.ui_mode_selector as ui_mode_selector
    ...
    import runtime.platform.platform_probe as platform_probe
...
def render_product_boot_matrix_doc(report: Mapping[str, object]) -> str:
    ...
    lines.extend(
        (
            ...
            "## Notes",
            "",
            "- Product mode selection must route through `runtime/shell/ui_mode_selector.py` with platform capabilities sourced from `runtime/platform/platform_probe.py`.",

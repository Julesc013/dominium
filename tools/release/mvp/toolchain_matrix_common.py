...
from tools.release.mvp.baseline_universe_common import (  # noqa: E402
    load_baseline_universe_snapshot,
    verify_baseline_universe,
)
from tools.release.mvp.gameplay_loop_common import load_gameplay_snapshot  # noqa: E402
from tools.domain.worldgen.worldgen_lock_common import (  # noqa: E402
...
def _source_snapshot_hash(repo_root: str) -> str:
    snapshot_paths = [
        "tools/release/mvp/toolchain_matrix_common.py",
        "tools/release/mvp/tool_run_toolchain_matrix.py",
        "tools/release/mvp/tool_compare_toolchain_runs.py",
...
def _pack_verify_step(repo_root: str, *, required: bool) -> tuple[dict, dict]:
    ...
    errors = []
    try:
        from tools.release.mvp.mvp_smoke_common import build_curated_pack_runtime
...
def render_toolchain_matrix_retro_audit(repo_root: str) -> str:
    ...
    lines = [
        ...
        "",
        "- `CONVERGENCE-GATE`: `tools/migration/convergence/convergence_gate_common.py`",
        "- `WORLDGEN-LOCK verify`: `tools/domain/worldgen/worldgen_lock_common.py`",
        "- `BASELINE-UNIVERSE verify`: `tools/release/mvp/baseline_universe_common.py`",
        "- `GAMEPLAY verify`: `tools/release/mvp/gameplay_loop_common.py`",
        "- `DISASTER suite`: `tools/release/mvp/disaster_suite_common.py`",

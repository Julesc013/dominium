...
SCHEMA_REL = os.path.join("contracts", "schemas", "release", "install_profile.schema")
COMPILED_SCHEMA_REL = os.path.join("contracts", "schemas", "install_profile.schema.json")

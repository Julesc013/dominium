#!/usr/bin/env python3
"""CLI: deterministic minimal boot/shutdown for SessionSpec artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Boot SessionSpec in deterministic headless bootstrap mode.")

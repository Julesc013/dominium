...
def overlay_manifest(*, include_mods: bool = True, reverse_mod_order: bool = False):
...
def overlay_fixture_merge_result(
    *,
    ...
    overlay_cache_clear()
    manifest = overlay_manifest(include_mods=include_mods, reverse_mod_order=reverse_mod_order)
...
def seed_overlay_state(*, include_mods: bool = True):
    ...
    manifest = overlay_manifest(include_mods=include_mods)
...
def merge_state_overlay(*, state, include_mods: bool = True):
    overlay_cache_clear()

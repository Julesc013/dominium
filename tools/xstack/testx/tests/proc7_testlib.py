...
def base_state(
    ...
    *,
    ...
    from game.domain.processes.research import build_experiment_definition_row
...
def seed_candidate_for_promotion(
    *,
    ...
    from game.domain.processes.research import build_candidate_process_definition_row

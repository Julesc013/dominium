...
def binding_row(*, network_id: str, graph_id: str, policy_id: str = "logic.policy.default", extensions: dict | None = None) -> dict:
    from game.domain.logic.network import build_logic_network_binding_row
...
def node_row(
    *,
    ...
    from game.domain.logic.network import build_logic_node_payload_row
...
def edge_row(
    *,
    ...
    from game.domain.logic.network import build_logic_edge_payload_row
...
def validate(repo_root: str, *, binding: dict, graph: dict) -> dict:
    from game.domain.logic.network import validate_logic_network

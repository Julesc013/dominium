...
def orbit_phase_report(repo_root: str) -> dict:
    ...
    from tools.domain.worldgen.earth2_probe import orbit_phase_report as _report
...
def climate_year_delta_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth2_probe import climate_year_delta_report as _report
...
def polar_daylight_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth2_probe import polar_daylight_report as _report
...
def bucket_update_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth2_probe import verify_climate_window_replay as _report
...
def earth_climate_hash(repo_root: str) -> str:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth2_probe import run_climate_tick_fixture

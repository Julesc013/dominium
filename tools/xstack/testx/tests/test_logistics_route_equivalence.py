...
def _create_manifest_route(*, graph: dict, rule: dict, inventory_index: dict):
    from game.domain.logistics.logistics_engine import create_manifest_and_commitment
...
def run(repo_root: str):
    ...
    from tools.validators.core.graph.routing_engine import route_query_edges
    from game.domain.logistics.logistics_engine import _core_graph_payload, _core_routing_policy, build_inventory_index

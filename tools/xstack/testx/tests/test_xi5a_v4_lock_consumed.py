...
def test_xi5a_v4_lock_consumed(repo_root: str) -> None:
    ...
    assert execution_log.get("approved_lock_path") == "archive/generated/restructure/src_domain_mapping_lock_approved_v4.json"
    assert execution_log.get("readiness_contract_path") == "contracts/restructure/xi5_readiness_contract_v4.json"

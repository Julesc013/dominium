...
def test_xi4z_v3_lock_schema_valid(repo_root: str) -> None:
    ...
    assert readiness_payload.get("approved_lock_path") == "archive/generated/restructure/src_domain_mapping_lock_approved_v3.json"
    assert readiness_payload.get("readiness_contract_path") == "contracts/restructure/xi5_readiness_contract_v3.json"

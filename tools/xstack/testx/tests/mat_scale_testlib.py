...
def base_scenario(
    *,
    ...
    from game.domain.materials.performance.mat_scale_engine import default_factory_planet_scenario
...
def run_report(
    *,
    ...
    from game.domain.materials.performance.mat_scale_engine import run_stress_simulation

...
def run_legacy_validator(repo_root: str, *, strict: bool = False) -> dict:
    ensure_repo_root(repo_root)
    from tools.validators.compatibility.shims import run_legacy_validate_all
...
def warning_payload() -> dict:
    from tools.validators.compatibility.shims.common import build_deprecation_warning

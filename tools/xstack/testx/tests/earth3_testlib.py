...
def lunar_phase_report(repo_root: str) -> dict:
    ...
    from tools.domain.worldgen.earth3_probe import lunar_phase_report as _report
...
def tide_day_delta_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth3_probe import tide_day_delta_report as _report
...
def inland_damping_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth3_probe import inland_damping_report as _report
...
def bucket_update_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth3_probe import verify_tide_window_replay as _report
...
def earth_tide_hash(repo_root: str) -> str:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth3_probe import run_tide_tick_fixture

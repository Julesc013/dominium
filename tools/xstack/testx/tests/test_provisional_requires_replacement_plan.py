"""FAST test: provisional META-STABILITY-0 entries declare a replacement plan."""
...
def run(repo_root: str):
    ...
    if provisional_count <= 0:
        return {"status": "fail", "message": "expected at least one provisional entry in META-STABILITY-0 scope"}

...
def run_proc5_capsule_case(
    *,
    ...
    from game.domains.processes.capsules import execute_process_capsule, generate_process_capsule
    from game.domains.processes.maturity import build_process_maturity_record_row, build_process_metrics_state_row

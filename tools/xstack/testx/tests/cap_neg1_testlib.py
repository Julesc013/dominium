...
def product_bin_map(repo_root: str) -> dict[str, str]:
    ...
    from tools.validators.compatibility.descriptor import product_capability_default_rows_by_id
    from tools.validators.compatibility.capability_negotiation import load_product_registry

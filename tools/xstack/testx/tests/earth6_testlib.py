...
def ground_contact_report(repo_root: str) -> dict:
    ...
    from tools.domain.embodiment.earth6_probe import ground_contact_report as _report
...
def slope_modifier_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.embodiment.earth6_probe import slope_modifier_report as _report
...
def geometry_edit_height_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.embodiment.earth6_probe import geometry_edit_height_report as _report
...
def verify_collision_window_replay_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.embodiment.earth6_probe import verify_collision_window_replay as _report
...
def earth_collision_hash(repo_root: str) -> str:
    _ensure_repo_root(repo_root)
    from tools.domain.embodiment.earth6_probe import collision_hash as _hash

...
def generate_hydrology_window_fixture(repo_root: str) -> dict:
    ...
    from tools.domain.worldgen.earth1_probe import generate_hydrology_window_fixture
...
def verify_hydrology_window_replay_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth1_probe import verify_hydrology_window_replay
...
def verify_window_monotonicity_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth1_probe import verify_window_monotonicity
...
def verify_river_threshold_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth1_probe import verify_river_threshold_fixture
...
def verify_local_edit_hydrology_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth1_probe import verify_local_edit_hydrology_update
...
def earth_hydrology_hash(repo_root: str) -> str:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth1_probe import earth_hydrology_hash as _hash_rows
    from tools.domain.worldgen.earth1_probe import sample_earth_hydrology

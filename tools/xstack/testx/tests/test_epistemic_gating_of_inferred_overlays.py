...
def _candidate_row(repo_root: str):
    ...
    from game.domain.infrastructure.formalization import build_inference_candidate
...
def _snapshot(
    *,
    ...
    from game.domain.inspection.inspection_engine import build_inspection_snapshot_artifact

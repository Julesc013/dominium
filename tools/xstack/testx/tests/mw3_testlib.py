...
def build_surface_request_from_fixture(fixture: dict, *, request_id: str, reason: str = "query") -> dict:
    from game.domains.geology import build_worldgen_request
...
def build_surface_fixture(repo_root: str, *, current_tick: int = FIXTURE_CURRENT_TICK, require_atmosphere: bool = True) -> dict:
    ...
    from game.domains.geology import generate_worldgen_result
    from game.domains.worldgen.mw import build_planet_surface_cell_key
...
def surface_result_hash(result: dict) -> str:
    ...
    from game.domains.worldgen.mw import surface_tile_artifact_hash_chain

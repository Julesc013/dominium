...
def sun_direction_report(repo_root: str) -> dict:
    ...
    from tools.domain.worldgen.earth4_probe import sun_direction_report as _report
...
def sky_gradient_transition_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth4_probe import sky_gradient_transition_report as _report
...
def starfield_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth4_probe import starfield_report as _report
...
def replay_report(repo_root: str) -> dict:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth4_probe import verify_sky_view_replay as _report
...
def earth_sky_hash(repo_root: str) -> str:
    _ensure_repo_root(repo_root)
    from tools.domain.worldgen.earth4_probe import sky_hash as _report

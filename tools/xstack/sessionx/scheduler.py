...
PROCESS_PRIORITY = {
    ...
    "process.control_ir.autopilot_stub": 25,
    "process.control_ir.ai_controller_stub": 25,
...
PROCESS_ENTITY_SCOPE = {
    ...
    "process.control_ir.autopilot_stub": "controller.ir.autopilot",
    "process.control_ir.ai_controller_stub": "controller.ir.ai",
...
PROCESS_FIELD_SCOPE = {
    ...
    "process.control_ir.autopilot_stub": "control.ir.autopilot",
    "process.control_ir.ai_controller_stub": "control.ir.ai",

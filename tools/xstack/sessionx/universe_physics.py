...
_NULL_DIMENSIONS = [
    ...
    {
        "dimension_id": "dim.specific_energy",
        "base_exponents": {"L": 2, "T": -2},
        "description": "Specific energy dimension.",
        "version_introduced": "1.0.0",
        "deprecated": False,
        "extensions": {},
    },
...
_NULL_UNITS = [
    ...
    {
        "unit_id": "unit.kg_per_m3",
        "dimension_id": "dim.density",
        "scale_factor_to_canonical": 16777216,
        "display_symbol": "kg/m^3",
        "description": "Canonical kilograms-per-cubic-meter unit.",
        "version_introduced": "1.0.0",
        "deprecated": False,
        "extensions": {},
    },
    {
        "unit_id": "unit.J_per_kg",
        "dimension_id": "dim.specific_energy",
        "scale_factor_to_canonical": 16777216,
        "display_symbol": "J/kg",
        "description": "Canonical joules-per-kilogram unit.",
        "version_introduced": "1.0.0",
        "deprecated": False,
        "extensions": {},
    },
...
_NULL_CONSERVATION_CONTRACT_SET = {
    ...
    "quantities": [
        ...
        },
        {
            ...
            "notes": "Tracked-only material mass channel in null profile.",
        },
        {
            "quantity_id": "quantity.charge_total",
            "mode": "ignore",
...
_NULL_REGISTRY_LIST_KEYS = {
    ...
    "element_registry": "elements",
    "compound_registry": "compounds",
    "mixture_registry": "mixtures",
    "material_class_registry": "materials",
    "quality_distribution_registry": "quality_distribution_models",
    "part_class_registry": "part_classes",
    "connection_type_registry": "connection_types",
    "blueprint_registry": "blueprints",
    "interior_volume_type_registry": "volume_types",
    "portal_type_registry": "portal_types",
    "compartment_flow_policy_registry": "policies",
    "portal_flow_template_registry": "templates",
    "logistics_routing_rule_registry": "routing_rules",
    "logistics_graph_registry": "graphs",
    "provenance_event_type_registry": "event_types",
    "construction_policy_registry": "policies",
    ...
    "spec_type_registry": "spec_types",
    "tolerance_policy_registry": "tolerance_policies",
    "compliance_check_registry": "compliance_checks",
    "interaction_action_registry": "actions",
    "surface_type_registry": "surface_types",
    "port_type_registry": "port_types",
    "tool_tag_registry": "tool_tags",
    "tool_type_registry": "tool_types",
    "tool_effect_model_registry": "effect_models",
    "surface_visibility_policy_registry": "policies",
    "port_visibility_policy_registry": "policies",
    "machine_type_registry": "machine_types",
    "machine_operation_registry": "operations",
    "task_type_registry": "task_types",
    "progress_model_registry": "progress_models",
...
def normalize_physics_profile_id(profile_id: str) -> str:
    ...
    if token.startswith("physics.") and token.count(".") == 1:
        prefix, suffix = token.split(".", 1)
        if "_" in suffix:
            head, tail = suffix.split("_", 1)
            token = "{}.{}.{}".format(prefix, head, tail)

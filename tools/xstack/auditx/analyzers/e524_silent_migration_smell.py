...
from tools.package.compatibility.migration_lifecycle_common import RULE_READ_ONLY, RULE_SILENT, migration_lifecycle_violations
    ...
    for row in migration_lifecycle_violations(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                severity="BLOCKER",
                confidence=0.99,
                file_path=rel_path or "tools/validators/compatibility/migration_lifecycle.py",
                evidence=[

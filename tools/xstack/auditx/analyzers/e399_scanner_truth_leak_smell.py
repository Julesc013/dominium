...
REQUIRED_TOKENS = {
    "game/domain/embodiment/tools/scanner_tool.py": (
        '"source_kind": "derived.scan_result"',
        "inspection_snapshot",
        "field_values",
        "property_origin_result",
    ),
    "runtime/ui/client/inspect_panels.py": (
...
FORBIDDEN_TOKENS = {
    "game/domain/embodiment/tools/scanner_tool.py": ("truth_model", "universe_state", "process_runtime"),
}

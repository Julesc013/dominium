...
WATCH_PATHS = (
    ...
    "runtime/shell/__init__.py",
    "runtime/shell/args_parser.py",
    "runtime/shell/bootstrap.py",
    "runtime/shell/command_registry.py",
    "runtime/shell/compat_adapter.py",
    "runtime/shell/config_loader.py",
    "runtime/shell/console_repl.py",
    "runtime/shell/logging_sink.py",
    "runtime/shell/mode_dispatcher.py",
    "runtime/shell/pack_verifier_adapter.py",
    "runtime/shell/rendered_stub.py",
    "runtime/shell/tui/__init__.py",
    "runtime/shell/tui/tui_engine.py",
    "runtime/shell/tui_stub.py",
...
def run(graph, repo_root, changed_files=None):
    ...
    doctrine_text = _read_text(repo_root, "docs/runtime/shell/APPSHELL_CONSTITUTION.md")
    if "must not depend on repo or XStack at runtime" not in doctrine_text:
        findings.append(
            make_finding(
                ...
                severity="RISK",
                confidence=0.95,
                file_path="docs/runtime/shell/APPSHELL_CONSTITUTION.md",
                line=1,

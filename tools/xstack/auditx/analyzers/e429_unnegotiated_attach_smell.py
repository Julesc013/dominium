...
from tools.validators.shell.ipc_unify_common import ipc_unify_violations
    ...
    for row in ipc_unify_violations(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                related_paths=[
                    rel_path or "archive/generated/audit/ipc_unify_report.json",
                    "tools/validators/shell/tool_run_ipc_unify.py",
                    "runtime/shell/ipc/ipc_transport.py",

...
FORBIDDEN_TOKENS = {
    "runtime/shell/supervisor/supervisor_engine.py": ("random.", "uuid.uuid4(", "secrets.", "os.urandom("),
    "tools/validators/shell/supervisor_service.py": ("random.", "uuid.uuid4(", "secrets.", "os.urandom("),
}

...
WATCH_PREFIXES = (
    ...
    "game/domain/materials/commitments/commitment_engine.py",
...
def run(graph, repo_root, changed_files=None):
    ...
    domain_expectations = {
        "game/domain/inspection/inspection_engine.py": ("build_fidelity_request(", "arbitrate_fidelity_requests(", "fidelity_allocation"),
        "game/domain/materials/materialization/materialization_engine.py": ("build_fidelity_request(", "arbitrate_fidelity_requests(", "fidelity_allocation"),
        "game/domain/materials/commitments/commitment_engine.py": ("build_fidelity_request(", "arbitrate_fidelity_requests(", "fidelity_allocation"),

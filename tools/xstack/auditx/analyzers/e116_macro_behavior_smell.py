...
WATCH_PREFIXES = (
    ...
    "game/domain/materials/construction/construction_engine.py",
    ...
    for token in required_runtime_tokens:
        ...
        findings.append(
            make_finding(
                ...
                recommended_action="REWRITE",
                related_invariants=["INV-NO-MACRO-BEHAVIOR-WITHOUT-IR"],
                related_paths=[runtime_rel, "tools/repo/governance/ir/control_ir_programs.py"],
            )
        )

    construction_rel = "game/domain/materials/construction/construction_engine.py"

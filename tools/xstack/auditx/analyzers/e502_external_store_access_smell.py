    ...
    for row in clean_room_violations(repo_root, platform_tag="win64"):
        ...
        findings.append(
            make_finding(
                ...
                severity="RISK",
                confidence=0.98,
                file_path=rel_path or "archive/generated/audit/clean_room_win64.json",
                evidence=[
                    code,
                ...
                related_paths=[rel_path or "archive/generated/audit/clean_room_win64.json", "tools/release/dist/clean_room_common.py"],
            )
        )
    return findings

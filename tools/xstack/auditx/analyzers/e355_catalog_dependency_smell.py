...
WATCH_PREFIXES = ("game/domain/worldgen/mw/", "game/domain/geology/worldgen/", "tools/validators/domain/geology/", "tools/xstack/sessionx/")
SCAN_ROOTS = ("game/domain/worldgen/mw", "game/domain/geology/worldgen", "tools/geo", "tools/xstack/sessionx")
SCAN_EXTS = (".py",)
CATALOG_TOKENS = (
        ...
        for line_no, line in enumerate(text.splitlines(), start=1):
            ...
            findings.append(
                make_finding(
                    ...
                    related_paths=[rel_path, "game/domain/worldgen/mw/mw_cell_generator.py", "contracts/registry/galaxy_priors_registry.json"],
                )
            )
            break
    return findings

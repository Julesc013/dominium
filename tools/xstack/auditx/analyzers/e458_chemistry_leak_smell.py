"""E458 chemistry leak smell analyzer for the EARTH-10 proxy layer."""
...
from tools.domain.worldgen.earth10_audit_common import EARTH10_SCOPE_PATHS, scan_earth10_chemistry_leaks


ANALYZER_ID = "E458_CHEMISTRY_LEAK_SMELL"
WATCH_PREFIXES = tuple(EARTH10_SCOPE_PATHS)
RULE_IDS = ("INV-NO-CHEMISTRY-IN-EARTH10",)
    ...
    for row in scan_earth10_chemistry_leaks(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                category="earth.material_proxy.chemistry_leak_smell",
                severity="VIOLATION",
                confidence=0.98,
                file_path=rel_path,

...
def run(graph, repo_root, changed_files=None):
    ...
    required_tokens = {
        "tools/validators/core/flow/flow_engine.py": ("flow_transfer(", "quantity_id"),
        "game/domain/logistics/logistics_engine.py": ("tick_flow_channels(", "_best_route(", "flow_channel_id"),

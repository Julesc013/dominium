...
WATCH_PREFIXES = (
    "tools/xstack/auditx/analyzers/e317_commit_phase_bypass_smell.py",
...
_NON_COMMIT_PATHS = (
    ...
    "game/domain/logic/eval/compute_engine.py",
...
def run(graph, repo_root, changed_files=None):
    ...
    commit_rel = "game/domain/logic/eval/commit_engine.py"

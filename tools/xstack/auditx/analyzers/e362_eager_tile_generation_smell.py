...
WATCH_PREFIXES = ("game/domain/worldgen/mw/", "game/domain/geology/worldgen/", "tools/xstack/sessionx/", "docs/domains/worldgen/")
SURFACE_REFINER_REL = "game/domain/worldgen/mw/mw_surface_refiner_l3.py"
INSOLATION_PROXY_REL = "game/domain/worldgen/mw/insolation_proxy.py"
WORLDGEN_ENGINE_REL = "game/domain/geology/worldgen/worldgen_engine.py"
DOC_REL = "docs/domains/worldgen/PLANET_SURFACE_MACRO_MODEL.md"

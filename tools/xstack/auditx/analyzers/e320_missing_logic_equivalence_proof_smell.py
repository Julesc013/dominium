...
def run(graph, repo_root, changed_files=None):
    ...
    compiler_rel = "game/domain/logic/compile/logic_compiler.py"
    ...
    for token in (
        ...
        findings.append(
            make_finding(
                ...
                related_invariants=["INV-COMPILED-LOGIC-REQUIRES-PROOF"],
                related_paths=[compiler_rel, "game/domain/logic/compile/logic_proof_engine.py"],
            )
        )

    proof_rel = "game/domain/logic/compile/logic_proof_engine.py"

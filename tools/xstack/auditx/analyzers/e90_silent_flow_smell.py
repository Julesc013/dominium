...
WATCH_PREFIXES = ("src/core/flow/", "game/domain/logistics/", "tools/xstack/sessionx/")

FLOW_ENGINE_PATH = "tools/validators/core/flow/flow_engine.py"
LOGISTICS_ENGINE_PATH = "game/domain/logistics/logistics_engine.py"

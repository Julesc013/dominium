...
WATCH_PREFIXES = ("game/domain/signals/", "tools/xstack/sessionx/")
...
def run(graph, repo_root, changed_files=None):
    ...
    allow_files = {
        ...
        "tools/xstack/auditx/analyzers/e174_direct_schedule_mutation_smell.py",
    }
    scan_roots = (
                ...
                for line_no, line in enumerate(text.splitlines(), start=1):
                    ...
                    findings.append(
                        make_finding(
                            ...
                            related_paths=[rel_path, "game/domain/signals/institutions/dispatch_engine.py"],
                        )
                    )
                    break
    return sorted(

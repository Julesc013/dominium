...
FORBIDDEN_TOKENS = {
    "runtime/shell/supervisor/supervisor_engine.py": ("time.sleep(", "time.time(", "datetime.utcnow(", "perf_counter(", "sleep("),
    "tools/validators/shell/appshell6_probe.py": ("time.sleep(", "time.time(", "datetime.utcnow(", "perf_counter(", "sleep("),
}

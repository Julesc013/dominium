...
COMMITMENT_ENGINE_PATH = "game/domain/materials/commitments/commitment_engine.py"
PROCESS_RUNTIME_PATH = "tools/xstack/sessionx/process_runtime.py"
INSPECTION_OVERLAY_PATH = "runtime/ui/client/interaction/inspection_overlays.py"

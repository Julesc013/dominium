...
WATCH_PREFIXES = ("game/domain/signals/",)
...
def run(graph, repo_root, changed_files=None):
    ...
    bulletin_rel = "game/domain/signals/institutions/bulletin_engine.py"
    dispatch_rel = "game/domain/signals/institutions/dispatch_engine.py"
    standards_rel = "game/domain/signals/institutions/standards_engine.py"
    ...
    allow_files = {
        ...
        dispatch_rel,
        standards_rel,
        "tools/xstack/auditx/analyzers/e175_institutional_bypass_smell.py",
    }

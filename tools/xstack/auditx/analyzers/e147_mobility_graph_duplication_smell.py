...
def run(graph, repo_root, changed_files=None):
    ...
    allowed_files = {
        "tools/validators/core/graph/network_graph_engine.py",
        "tools/validators/core/graph/routing_engine.py",
        "game/domain/mobility/network/mobility_network_engine.py",
                ...
                for line_no, line in enumerate(text.splitlines(), start=1):
                    ...
                    findings.append(
                        make_finding(
                            ...
                            related_paths=[rel_path, "tools/validators/core/graph/network_graph_engine.py"],
                        )
                    )
                    break
    return sorted(

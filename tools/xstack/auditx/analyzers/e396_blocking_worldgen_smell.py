...
REQUIRED_TOKENS = {
    ...
    "runtime/ui/client/teleport_controller.py": (
...
FORBIDDEN_TOKENS = {
    "runtime/ui/client/viewer_shell.py": ("process.worldgen_request", "generate_worldgen_result("),
    "runtime/ui/client/teleport_controller.py": ("process.worldgen_request", "generate_worldgen_result("),
}

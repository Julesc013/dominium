...
from tools.repo.governance.governance_model_common import RULE_PROFILE, governance_model_violations
    ...
    for row in governance_model_violations(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                severity="RISK",
                confidence=0.99,
                file_path=rel_path or "contracts/governance/governance_profile.json",
                evidence=[
                ...
                related_paths=[
                    rel_path or "contracts/governance/governance_profile.json",

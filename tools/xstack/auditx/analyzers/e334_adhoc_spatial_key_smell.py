...
WATCH_PREFIXES = ("src/net/srz/", "game/domain/systems/roi/", "game/domain/worldgen/", "tools/validators/domain/geology/")
_PATTERNS = (
    re.compile(r'["\']cell\.[^"\']*\{'),
    re.compile(r'["\']atlas\.[^"\']*\{'),
...
_ALLOWLIST = {
    ...
    "game/domain/geology/index/geo_index_engine.py",
}
        ...
        for line_no, line in enumerate(text.splitlines(), start=1):
            ...
            findings.append(
                make_finding(
                    ...
                    related_paths=[rel_path, "game/domain/geology/index/geo_index_engine.py"],
                )
            )
            break
    return findings

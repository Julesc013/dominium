...
def run(graph, repo_root, changed_files=None):
    ...
    allow_files = {
        "game/domain/signals/addressing/address_engine.py",
        "game/domain/signals/transport/transport_engine.py",
        "tools/xstack/auditx/analyzers/e169_broadcast_bypass_smell.py",
    }
            ...
            for line_no, line in enumerate(text.splitlines(), start=1):
                ...
                findings.append(
                    make_finding(
                        ...
                        related_paths=[rel_path, "game/domain/signals/addressing/address_engine.py"],
                    )
                )
                break
    return sorted(

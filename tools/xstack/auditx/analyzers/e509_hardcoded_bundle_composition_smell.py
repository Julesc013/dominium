    ...
    for row in component_graph_violations(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                severity="RISK",
                confidence=0.99,
                file_path=rel_path or "contracts/registry/component_graph_registry.json",
                evidence=[
                ...
                related_paths=[rel_path or "contracts/registry/component_graph_registry.json", "tools/release/component_graph_common.py"],
            )
        )
    return findings

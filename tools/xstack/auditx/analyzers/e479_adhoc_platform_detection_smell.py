...
ALLOWED_PATHS = {
    "runtime/platform/platform_probe.py",
                ...
                for token in TOKENS:
                    ...
                    findings.append(
                        make_finding(
                            ...
                            evidence=[
                                "token={}".format(token),
                                "platform detection heuristics must be centralized in runtime/platform/platform_probe.py",
                            ],
                            suggested_classification="TODO-BLOCKED",
                            recommended_action="ROUTE_THROUGH_PLATFORM_PROBE",
                            related_invariants=["INV-UI-MODE-SELECTION-USES-PROBE"],
                            related_paths=[rel_path, "runtime/platform/platform_probe.py"],
                        )
                    )
    return findings

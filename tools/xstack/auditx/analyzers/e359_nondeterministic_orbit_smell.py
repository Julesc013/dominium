...
SYSTEM_REFINER_REL = "game/domain/worldgen/mw/mw_system_refiner_l2.py"
REQUIRED_TOKENS = (
    ...
    if missing:
        findings.append(
            make_finding(
                ...
                related_invariants=["INV-NO-RANDOM-RETRY-LOOPS-IN-WORLDGEN"],
                related_paths=[SYSTEM_REFINER_REL, "docs/domains/worldgen/STAR_SYSTEM_ORBITAL_PRIORS.md"],
            )
        )

...
WATCH_PREFIXES = (
    "tools/xstack/auditx/analyzers/e310_direct_signal_mutation_smell.py",
...
_ALLOWED_PATHS = {
    "game/domain/logic/signal/signal_store.py",
    "tools/xstack/sessionx/process_runtime.py",
}
                ...
                for pattern in _DIRECT_MUTATION_PATTERNS:
                    ...
                    findings.append(
                        make_finding(
                            ...
                            related_paths=[rel_path, "game/domain/logic/signal/signal_store.py", "tools/xstack/sessionx/process_runtime.py"],
                        )
                    )
                    break

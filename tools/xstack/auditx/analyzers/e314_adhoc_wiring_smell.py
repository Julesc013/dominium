...
WATCH_PREFIXES = (
    "tools/xstack/auditx/analyzers/e314_adhoc_wiring_smell.py",
            ...
            for name in sorted(files):
                ...
                findings.append(
                    make_finding(
                        ...
                        related_paths=[rel_path, "game/domain/logic/network/logic_network_engine.py"],
                    )
                )

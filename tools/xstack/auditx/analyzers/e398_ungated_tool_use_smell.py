...
REQUIRED_TOKENS = {
    "game/domain/embodiment/tools/terrain_edit_tool.py": ('evaluate_tool_access(tool_id="tool.terrain_edit"',),
    "game/domain/embodiment/tools/scanner_tool.py": ('evaluate_tool_access(', '"tool.scanner_basic"'),
    ...
    "game/domain/embodiment/tools/teleport_tool.py": ('evaluate_tool_access(tool_id="tool.teleport"',),

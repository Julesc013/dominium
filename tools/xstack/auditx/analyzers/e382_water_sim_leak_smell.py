...
WATER_PROBE_REL = "tools/domain/worldgen/earth8_probe.py"
WATER_REPLAY_REL = "tools/domain/worldgen/tool_replay_water_view.py"
WATER_DOC_REL = "docs/domains/worldgen/EARTH_WATER_VISUAL_MODEL.md"

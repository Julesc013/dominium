...
def run(graph, repo_root, changed_files=None):
    ...
    replay_rel = "tools/domain/systems/tool_replay_tier_transitions.py"
    ...
    allowed_files = {
        runtime_rel,
        "game/domain/systems/system_collapse_engine.py",
        "game/domain/systems/system_expand_engine.py",

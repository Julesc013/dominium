    ...
    try:
        ...
        return [
            make_finding(
                ...
                severity="RISK",
                confidence=0.96,
                file_path="tools/migration/convergence/convergence_gate_common.py",
                line=1,
                ...
                related_paths=["tools/migration/convergence/convergence_gate_common.py"],
            )
        ]
    findings = []
    for row in convergence_gate_violations(repo_root):
        ...
        findings.append(
            make_finding(
                ...
                related_paths=[rel_path or "archive/generated/audit/convergence_final.json", "tools/migration/convergence/tool_run_convergence_gate.py"],
            )
        )
    return findings

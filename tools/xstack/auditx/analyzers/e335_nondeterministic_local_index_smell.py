...
WATCH_PREFIXES = ("game/domain/geology/index/", "game/domain/worldgen/", "tools/validators/domain/geology/")
        ...
        for line_no, line in enumerate(text.splitlines(), start=1):
            ...
            findings.append(
                make_finding(
                    ...
                    related_paths=[rel_path, "game/domain/geology/index/object_id_engine.py"],
                )
            )
            break
    return findings

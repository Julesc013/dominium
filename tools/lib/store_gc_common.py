...
from tools.libraries.bundle.bundle_manifest import build_bundle_manifest, write_json as write_bundle_json
from tools.libraries.install.install_validator import (
...
def build_store_gc_report(repo_root: str) -> dict:
        ...
        violations.append(
            {
                ...
                "file_path": "engine/store/gc_engine.py",
            }
        )
    ...
    gc_engine_text = _read_text(root, "engine/store/gc_engine.py")
...
def store_gc_violations(repo_root: str) -> list[dict]:
    ...
    required_paths = (
        ...
        ("contracts/schemas/lib/gc_policy.schema", "gc_policy schema is required", RULE_POLICY),
        ("contracts/schemas/lib/gc_report.schema", "gc_report schema is required", RULE_POLICY),
        ("contracts/schemas/gc_policy.schema.json", "compiled gc_policy schema is required", RULE_POLICY),
        ("contracts/schemas/gc_report.schema.json", "compiled gc_report schema is required", RULE_POLICY),
        ...
        ("engine/store/gc_engine.py", "gc engine is required", RULE_GRAPH),

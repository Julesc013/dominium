...
from tools.repo.dev.impact_graph import (  # noqa: E402
...
def _scenario_script(target: str) -> str:
    mapping = {
        "galaxy": "tools/repo/dev/scenarios/script.galaxy.json",
        "sol": "tools/repo/dev/scenarios/script.sol.json",
        "earth": "tools/repo/dev/scenarios/script.earth.json",
    }

...
SCRIPT_AREA_SPECS = (
    {"area_id": "geo", "root_relpath": "tools/validators/domain/geology", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "worldgen", "root_relpath": "tools/domain/worldgen", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "earth", "root_relpath": "tools/domain/worldgen/earth_stress", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "earth", "root_relpath": "tools/domain/worldgen", "include_pattern": r"^tool_(replay_(climate|hydrology|illumination|material|sky|tide|water|wind)|verify_earth_surface).+\.py$"},
    {"area_id": "sol", "root_relpath": "tools/domain/astronomy", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "gal", "root_relpath": "tools/domain/worldgen", "include_pattern": r"^tool_replay_galaxy_(objects|proxies)\.py$"},
    {"area_id": "logic", "root_relpath": "tools/domain/logic", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "sys", "root_relpath": "tools/domain/systems", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "proc", "root_relpath": "tools/domain/processes", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "lib", "root_relpath": "tools/package/libraries", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "compat", "root_relpath": "tools/package/compatibility", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "diag", "root_relpath": "tools/diagnostics", "include_pattern": r"^tool_.*\.py$"},
    {"area_id": "server", "root_relpath": "tools/test/server", "include_pattern": r"^tool_.*\.py$"},
)

EXPLICIT_SCRIPT_ROWS = (
    {
        "area_id": "pack",
        "tool_relpath": "tools/package/pack/capability_inspect.py",
        "command_slug": "capability-inspect",
        "description": "Inspect declared pack capabilities, overlaps, and dependency closure.",
    },
    {
        "area_id": "pack",
        "tool_relpath": "tools/package/pack/pack_validate.py",
        "command_slug": "validate-manifest",
        "description": "Run the legacy pack manifest validator through the stable umbrella.",
    },
    {
        "area_id": "pack",
        "tool_relpath": "tools/package/pack/migrate_capability_gating.py",
...
def _render_tool_surface_map(report: Mapping[str, object]) -> str:
    lines = [
        ...
        "# Tool Surface Map",
        "",
        "Source: `archive/generated/audit/repo_inventory.json` + `tools/repo/tool_surface_adapter.py`",
        "",

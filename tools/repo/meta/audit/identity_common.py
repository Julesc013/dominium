...
def identity_violations(repo_root: str, *, strict_missing: bool = False) -> list[dict]:
    ...
    required_files = (
        ...
        (os.path.join("contracts", "schemas", "meta", "universal_identity_block.schema"), "universal identity schema is required", RULE_CANONICAL),
        (os.path.join("contracts", "schemas", "universal_identity_block.schema.json"), "compiled universal identity schema is required", RULE_CANONICAL),
        ...
        (os.path.join("tools", "repo", "meta", "audit", "identity_common.py"), "identity helper is required", RULE_CANONICAL),
        (os.path.join("tools", "repo", "meta", "audit", "tool_print_identity.py"), "identity print tool is required", RULE_WARN),
        (os.path.join("tools", "repo", "meta", "audit", "tool_diff_identity.py"), "identity diff tool is required", RULE_WARN),

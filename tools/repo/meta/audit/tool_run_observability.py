#!/usr/bin/env python3
"""Generate deterministic OBSERVABILITY-0 baseline artifacts."""
...
from tools.repo.meta.audit.observability_common import write_observability_outputs  # noqa: E402
from tools.xstack.compatx.canonical_json import canonical_json_text  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Write OBSERVABILITY-0 baseline artifacts.")
    parser.add_argument("--repo-root", default=".")
    args = parser.parse_args()
    payload = write_observability_outputs(os.path.abspath(str(args.repo_root or ".")))

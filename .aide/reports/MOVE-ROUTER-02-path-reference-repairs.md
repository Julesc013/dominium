...
- `apps/client/shell/client_shell.c`
- `apps/launcher/cli/launcher_cli_main.c`
- `apps/server/app/main_server.c`
- `apps/server/server_boot.py`
- `apps/setup/cli/setup_cli_main.c`
- `content/MANIFEST.md`
- `content/bundles/README.md`
- `content/data/agents/agent_context.json`
- `content/data/agents/task_intent_map.json`
- `content/data/analysis/duplicate_cluster_rankings.json`
- `content/data/analysis/implementation_scores.json`
...
- `content/data/perf/perf_report_win64.json`
- `content/data/release/dist_final_expected_artifacts.json`
- `content/data/repo/repo_authoritative_boundary_model_and_preferred_target.json`
- `content/data/repo/repo_coupling_drift_and_relayout_risk_analysis.json`
- `content/data/repo/repo_non_negotiables_and_current_reality.json`
- `content/data/repo/repo_phased_migration_shims_validation_and_rollback.json`
- `content/data/repo/repo_target_topology_options_and_comparison.json`
- `content/data/repo/repo_topology_paths_and_ownership_reality_map.json`
- `content/data/xstack/checkpoint_c_xstack_aide_closure.json`
- `content/data/xstack/gate_definitions.json`
- `content/data/xstack/next_execution_order_post_xstack_aide.json`
- `content/data/xstack/xstack_inventory_and_classification.json`
- `content/data/xstack/xstack_scope_freeze.json`
- `content/data/xstack/xstack_to_aide_extraction_map.json`
...
- `contracts/schemas/deprecation_entry.schema.json`
- `contracts/schemas/domain_registry.schema.json`
- `contracts/schemas/law/SPEC_LAW_TARGETS.md`
- `contracts/schemas/reality/capability_surface.schema.json`
- `contracts/schemas/reality/domain_contract.schema.json`

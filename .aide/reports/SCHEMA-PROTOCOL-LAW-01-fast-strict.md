...
- started: `2026-05-20T18:06:36Z`
- completed: `2026-05-20T18:12:07Z`
- elapsed seconds: `331.344`
...
| `t1.aide_doctor` | `T1` | `true` | `pass` | `11.531` |
| `t1.aide_validate` | `T1` | `true` | `pass` | `11.344` |
| `t1.aide_test` | `T1` | `true` | `pass` | `14.859` |
| `t1.aide_selftest` | `T1` | `true` | `pass` | `14.594` |
| `t1.aide_tools_validate` | `T1` | `true` | `pass` | `2.141` |
| `t1.aide_roots_validate` | `T1` | `true` | `pass` | `2.078` |
| `t1.aide_repo_validate` | `T1` | `true` | `pass` | `2.078` |
| `t1.repo_layout_strict` | `T1` | `true` | `pass` | `4.5` |
| `t1.root_allowlist_strict` | `T1` | `true` | `pass` | `4.359` |
...
| `t1.include_sanity` | `T1` | `true` | `pass` | `1.843` |
| `t1.build_target_boundaries` | `T1` | `true` | `pass` | `4.407` |
| `t1.ui_shell_purity` | `T1` | `true` | `pass` | `0.14` |
| `t1.abi_boundaries` | `T1` | `true` | `pass` | `0.297` |
| `t1.language_baseline` | `T1` | `true` | `pass` | `5.141` |
| `t1.cpp17_forbidden_library_use` | `T1` | `true` | `pass` | `4.219` |
| `t1.repox_strict` | `T1` | `true` | `pass` | `119.984` |
| `t2.cmake_configure_verify` | `T2` | `true` | `pass` | `30.0` |
| `t2.cmake_build_all_build` | `T2` | `true` | `pass` | `45.266` |

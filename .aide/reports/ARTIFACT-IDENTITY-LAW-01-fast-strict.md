...
- started: `2026-05-20T17:31:11Z`
- completed: `2026-05-20T17:36:32Z`
- elapsed seconds: `321.578`
...
| `t1.aide_validate` | `T1` | `true` | `pass` | `10.031` |
| `t1.aide_test` | `T1` | `true` | `pass` | `13.969` |
| `t1.aide_selftest` | `T1` | `true` | `pass` | `14.266` |
| `t1.aide_tools_validate` | `T1` | `true` | `pass` | `1.906` |
| `t1.aide_roots_validate` | `T1` | `true` | `pass` | `1.922` |
| `t1.aide_repo_validate` | `T1` | `true` | `pass` | `1.875` |
| `t1.repo_layout_strict` | `T1` | `true` | `pass` | `4.484` |
| `t1.root_allowlist_strict` | `T1` | `true` | `pass` | `4.36` |
| `t1.distribution_layout_strict` | `T1` | `true` | `pass` | `0.187` |
| `t1.component_matrices_strict` | `T1` | `true` | `pass` | `0.188` |
| `t1.no_src_source_dirs` | `T1` | `true` | `pass` | `0.218` |
...
| `t1.include_sanity` | `T1` | `true` | `pass` | `1.718` |
...
| `t1.cpp17_forbidden_library_use` | `T1` | `true` | `pass` | `4.0` |
| `t1.repox_strict` | `T1` | `true` | `pass` | `112.016` |
| `t2.cmake_configure_verify` | `T2` | `true` | `pass` | `28.593` |
| `t2.cmake_build_all_build` | `T2` | `true` | `pass` | `45.969` |
| `t2.ctest_smoke` | `T2` | `true` | `pass` | `54.078` |

...
- started: `2026-05-22T03:15:52Z`
- completed: `2026-05-22T03:21:06Z`
- elapsed seconds: `314.266`
...
| `t0.changed_toml_parse` | `T0` | `true` | `pass` | `0.625` |
| `t0.forbidden_active_roots` | `T0` | `true` | `pass` | `0.125` |
| `t1.aide_doctor` | `T1` | `true` | `pass` | `10.078` |
| `t1.aide_validate` | `T1` | `true` | `pass` | `11.157` |
| `t1.aide_test` | `T1` | `true` | `pass` | `13.937` |
| `t1.aide_selftest` | `T1` | `true` | `pass` | `13.781` |
| `t1.aide_tools_validate` | `T1` | `true` | `pass` | `1.829` |
| `t1.aide_roots_validate` | `T1` | `true` | `pass` | `1.813` |
| `t1.aide_repo_validate` | `T1` | `true` | `pass` | `1.797` |
| `t1.repo_layout_strict` | `T1` | `true` | `pass` | `5.031` |
...
| `t1.include_sanity` | `T1` | `true` | `pass` | `1.859` |
| `t1.build_target_boundaries` | `T1` | `true` | `pass` | `4.203` |
...
| `t1.repox_strict` | `T1` | `true` | `pass` | `110.859` |
| `t2.cmake_configure_verify` | `T2` | `true` | `pass` | `29.5` |
| `t2.cmake_build_all_build` | `T2` | `true` | `pass` | `42.11` |

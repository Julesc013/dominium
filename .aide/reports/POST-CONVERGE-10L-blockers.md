...
- `INV-IDENTITY-FINGERPRINT` remains stale.
- `INV-REPOX-RULESET-MISSING` remains for two rule ids.
- Five warnings remain: one stale AuditX output warning and four glossary-term warnings in audit evidence.

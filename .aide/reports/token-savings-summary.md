...
- `.aide/context/latest-context-packet.md`: 1865 chars / 467 approx tokens / within_budget
- `.aide/context/latest-review-packet.md`: 5307 chars / 1327 approx tokens / within_budget
- `.aide/verification/latest-verification-report.md`: 5078 chars / 1270 approx tokens / within_budget

## Named Baselines

- `root_history_baseline`: 440459 chars / 110115 approx tokens
- `review_baseline`: 27104 chars / 6776 approx tokens
...
- `.aide/context/latest-review-packet.md` vs `review_baseline`: 80.4% estimated reduction (1327 vs 6776 approx tokens)
...
- `.aide/context/latest-review-packet.md` (review_packet): 1327 approx tokens
- `.aide/verification/latest-verification-report.md` (verification_report): 1270 approx tokens
...
- `.aide/evals/runs/latest-golden-tasks.json` (eval_report): 827 approx tokens

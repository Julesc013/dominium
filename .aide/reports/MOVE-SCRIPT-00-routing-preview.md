...
| `data/agents/agent_context.json` | `content/data/agents/agent_context.json` | `content_identity` | `low` |
| `data/agents/task_intent_map.json` | `content/data/agents/task_intent_map.json` | `content_identity` | `low` |
...
| `data/architecture/architecture_graph.json` | `content/data/architecture/architecture_graph.json` | `content_identity` | `low` |
| `data/architecture/architecture_graph.v1.json` | `content/data/architecture/architecture_graph.v1.json` | `content_identity` | `low` |
| `data/architecture/module_boundary_rules.v1.json` | `content/data/architecture/module_boundary_rules.v1.json` | `content_identity` | `low` |
| `data/architecture/module_dependency_graph.json` | `content/data/architecture/module_dependency_graph.json` | `content_identity` | `low` |

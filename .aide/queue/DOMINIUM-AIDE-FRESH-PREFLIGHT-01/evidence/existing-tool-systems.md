...
- AuditX: `tools/auditx/**`, `tools/xstack/auditx/**`, `docs/audit/auditx/**`, `data/registries/auditx_groups.json`.
...
- Compat/Control/Governance families: `tools/compatx/**`, `tools/controlx/**`, `tools/governance/**`, `validation/validation_engine.py`, `control/**`, `governance/**`.

## Capability Families

- validate: `validation/validation_engine.py`, `tools/ci/validate_all.py`, `tools/ci/validate_*.py`, `tools/domain/tool_domain_validate.py`, `tools/core/tool_graph_validate.py`, `tools/compatx/core/semantic_contract_validator.py`, CMake `verify_fast`.
...
- audit: `tools/auditx/auditx.py`, `tools/auditx/analyzers/**`, `docs/audit/**`.
...
- release: `repo/release_policy.toml`, `docs/release/**`, `tools/distribution/**`, release/update/security roots.
- package: CMake `dist_*` and `pkg_verify_all` targets, `tools/distribution/**`.
- migration: `tools/compat/**`, `tools/compatx/**`, `contracts/install/**`, `contracts/release/**`.

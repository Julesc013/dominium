...
| audit | `tools/auditx/**`, `tools/xstack/auditx/**`, `docs/audit/**`, AIDE audit outputs | Found; report-only | `dominium.auditx.scan`, `dominium.docs.sanity` |
...
| docs | `docs/**`, `tools/auditx/README.md`, generated docs-consistency outputs | Found; doctrine-adjacent | `dominium.docs.sanity` |

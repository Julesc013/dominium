...
| `dominium.auditx.scan` | `tools/auditx/auditx.py`, `tools/xstack/auditx/check.py` | `tools run dominium.auditx.scan --dry-run` | Input: scoped audit group. Output: audit findings under `.aide/tools/`. | Keep generated findings as evidence only. | Doctrine/release-adjacent. |

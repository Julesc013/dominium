...
- Use `docs/archive/audit/REPO_TREE_INDEX.md` and `docs/archive/audit/ENTRYPOINT_MAP.md` for the current convergence-era structural baseline.
...
- Governance execution: `docs/development/xstack/XSTACK.md`
- Survival baseline: `docs/archive/SURVIVAL_SLICE.md`
- Canon glossary: `docs/reference/GLOSSARY.md`

...
## Invariants
- Governance is law layered on institutions, not a mode.
- Authority is capability-based and law-gated.
- Legitimacy bounds enforcement capacity.
...
## Dependencies
- Authority and law: `docs/architecture/AUTHORITY_MODEL.md`
- Domain jurisdictions: `docs/architecture/DOMAIN_JURISDICTIONS_AND_LAW.md`
...
- Governance effects can bypass law gates.
- Legitimacy is optional or cosmetic.

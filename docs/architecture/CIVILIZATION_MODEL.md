...
- Life and population: `docs/architecture/LIFE_AND_POPULATION.md`


- Reality layer: `docs/architecture/REALITY_LAYER.md`


- Economy and logistics: `docs/architecture/ECONOMY_AND_LOGISTICS.md`


- Governance: `docs/architecture/GOVERNANCE_AND_INSTITUTIONS.md`


- Collapse and decay: `docs/architecture/COLLAPSE_AND_DECAY.md`

...
| INV-INSTALL-NO-ABSOLUTE-PATH-DEPENDENCY | Install identity and validation must not depend on absolute host paths. | docs/architecture/INSTALL_MODEL.md | tools/libraries/install/install_validator.py |

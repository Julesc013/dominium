...
- Date: 2026-03-11
  ...
  Migration: legacy reverse-DNS pack ids remain loadable; normalize provider declarations and instance/lock resolution records through `tools/libraries/provides/provider_resolution.py`
...
- Date: 2026-03-11
  ...
  Migration: existing payload schemas remain loadable; LIB-4 export/store flows canonicalize the artifact envelope or sidecar through `tools/libraries/artifact/artifact_validator.py`
...
- Date: 2026-03-11
  ...
  Migration: normalize legacy save manifests through `tools/libraries/save/save_validator.py`; legacy adapter field `contract_bundle_hash` remains available for compatibility
...
- Date: 2026-03-11
  ...
  Migration: normalize legacy instance manifests through `tools/libraries/instance/instance_validator.py`; legacy adapter fields remain available for existing launcher/setup flows

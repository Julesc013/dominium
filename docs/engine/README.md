...
architecture rules live in `docs/architecture/INVARIANTS.md`,
`docs/architecture/TERMINOLOGY.md`, `docs/architecture/NON_GOALS.md`,
`docs/architecture/COMPATIBILITY_PHILOSOPHY.md`, and
`docs/architecture/MENTAL_MODEL.md`. If there is any conflict, those documents
are authoritative.

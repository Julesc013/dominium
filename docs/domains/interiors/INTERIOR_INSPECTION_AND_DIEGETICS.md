...
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/domains/interiors/INTERIOR_VOLUME_MODEL.md`, `docs/domains/interiors/COMPARTMENT_FLOWS.md`, and `docs/domains/materials/INSPECTION_SYSTEM.md`.

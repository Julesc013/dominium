...
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/domains/interiors/INTERIOR_VOLUME_MODEL.md`, and `docs/architecture/FLOWSYSTEM_STANDARD.md`.

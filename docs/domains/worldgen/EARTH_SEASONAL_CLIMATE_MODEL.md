...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/domains/worldgen/EARTH_PROCEDURAL_CONSTITUTION.md`, `docs/domains/worldgen/PLANET_SURFACE_MACRO_MODEL.md`, and EARTH-2 runtime/proof tooling.

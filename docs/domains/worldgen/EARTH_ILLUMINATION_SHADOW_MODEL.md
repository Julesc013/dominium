...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/domains/worldgen/EARTH_SKY_STARFIELD_MODEL.md`, and EARTH-5 runtime/proof tooling.

...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/reference/contracts/SEMANTIC_CONTRACT_MODEL.md`, and GEO-9 overlay merge.

...
This theme gathers 691 source block(s) from 167 source file(s). It is advisory conversation evidence unless the current repo independently supports the same claim.

## What The Sources Suggest

The documentation and archive material form a memory system whose value is provenance, contradiction surfacing, and future promotion planning.
...
This theme gathers 432 source block(s) from 149 source file(s). It is advisory conversation evidence unless the current repo independently supports the same claim.

## What The Sources Suggest

Settled-looking decisions cluster around authority, determinism, refusal, product boundaries, and documentation discipline, but archive support is still advisory unless current docs also support it.
...
- decision: The hard user-stated decisions are DECISION-01 through DECISION-05. The strongest design commitments are DECISION-08, DECISION-10, DECISION-13, DECISION-15, DECISION-16, and DECISION-17. See the registers file for exact statuses and labels.
...
- decision: Read file 01 first if you want to understand what happened. Read file 04 if you need tasks and decisions. Read file 05 if merging into a master Project Spec Book. Read file 07 before treating external support claims as implementation truth.

## Representative Source Block References

- PVCB-00082: `docs/archive/conversations/advanced_simulation_infrastructure/dominium_advanced_simulation_infrastructure_architecture__05_reader_brief.md`
...
- PVCB-00083: `docs/archive/conversations/architecture_ui_providers/dominium_architecture_ui_providers_robot_os_strategy__09_in_chat_reader.md`
...
- PVCB-00084: `docs/archive/conversations/Build_and_Future_Proofing/Dominium_Build_and_Future_Proofing_Architecture__01_human_readable_report.md`
- PVCB-00473: `docs/archive/conversations/Build_and_Future_Proofing/Dominium_Build_and_Future_Proofing_Architecture__01_human_readable_report.md`

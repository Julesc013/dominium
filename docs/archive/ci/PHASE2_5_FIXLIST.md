...
1) Align dependency/ownership headers with Phase-1 law across Phase 2–5 specs.
   ...
   - Targets include: `docs/specs/SPEC_EFFECT_FIELDS.md`, `docs/specs/SPEC_SENSORS.md`, `docs/specs/SPEC_COMMUNICATION.md`,


     `docs/specs/SPEC_COMMAND_MODEL.md`, `docs/specs/SPEC_DOCTRINE_AUTONOMY.md`, `docs/specs/SPEC_FIDELITY_PROJECTION.md`,


     `docs/specs/SPEC_PROVENANCE.md`, `docs/specs/SPEC_EVENT_DRIVEN_STEPPING.md`, `docs/specs/SPEC_FIDELITY_DEGRADATION.md`,


     `docs/specs/SPEC_TIME_CORE.md`, `docs/specs/SPEC_TIME_FRAMES.md`, `docs/specs/SPEC_TIME_STANDARDS.md`,


     `docs/specs/SPEC_CALENDARS.md`, `docs/specs/SPEC_SCHEDULING.md`, `docs/specs/SPEC_TIME_KNOWLEDGE.md`,


     `docs/specs/SPEC_UI_CAPABILITIES.md`, `docs/specs/SPEC_UI_WIDGETS.md`, `docs/specs/SPEC_UI_PROJECTIONS.md`,


     `docs/specs/SPEC_MARKETS.md`, `docs/specs/SPEC_MONEY_STANDARDS.md`, `docs/specs/SPEC_PROPERTY_RIGHTS.md`,


     `docs/specs/SPEC_FACTIONS.md`, `docs/specs/SPEC_KNOWLEDGE_VIS_COMMS.md`.
...
2) Resolve legacy spec conflicts.
   ...
   - Deprecate or reconcile `docs/specs/SPEC_KNOWLEDGE.md` with `docs/specs/SPEC_INFORMATION_MODEL.md` and
...
4) Add explicit fixed-point/rational constraints where “scalar” or “physical computation” appears.
   ...
   - `docs/specs/SPEC_TIME_WARP.md` (sim_rate), `docs/specs/SPEC_SCHEDULING.md` (astronomical recurrence),


     `docs/specs/SPEC_EFFECT_FIELDS.md` (evaluation math).
...
5) Require `next_due_tick` exposure for all macro subsystems in Phase 2–5.
   ...
   - Belief decay (`docs/specs/SPEC_INFORMATION_MODEL.md`), doctrine review (`docs/specs/SPEC_DOCTRINE_AUTONOMY.md`),


     market clearing (`docs/specs/SPEC_MARKETS.md`), faction scheduling (`docs/specs/SPEC_FACTIONS.md`), comm delivery


     (`docs/specs/SPEC_COMMUNICATION.md`), sensor cadence (`docs/specs/SPEC_SENSORS.md`).
...
6) Clarify UI/camera interest rules.
   ...
   - In `docs/specs/SPEC_INTEREST_SETS.md`, ensure UI/camera focus cannot directly activate micro simulation
...
10) Clarify “real continuous time” wording in `docs/specs/SPEC_TIME_CORE.md` to explicitly mean fixed-point ACT.


11) Clarify that market quotes are InfoRecords and must pass epistemic gating in `docs/specs/SPEC_MARKETS.md`.


12) Clarify that WSS LOD policy is game-owned; engine provides only deterministic helpers in


    `docs/specs/SPEC_WORLD_SOURCE_STACK.md` (partially addressed).

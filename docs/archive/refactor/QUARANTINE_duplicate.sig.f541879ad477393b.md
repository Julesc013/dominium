...
- `tools/validators/domain/geology/geology_cli.cpp`

## Scorecard

- `tools/climate/climate_cli.cpp` disposition=`canonical` rank=`1` total_score=`54.21` risk=`HIGH`
- `tools/validators/domain/geology/geology_cli.cpp` disposition=`quarantine` rank=`2` total_score=`51.95` risk=`HIGH`

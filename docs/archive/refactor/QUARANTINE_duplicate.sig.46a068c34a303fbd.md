...
- Risk Level: `HIGH`
- Canonical Candidate: `runtime/network/d_net_schema.h`
...
- `runtime/network/d_net_schema.h`

## Scorecard

- `runtime/network/d_net_schema.h` disposition=`canonical` rank=`1` total_score=`69.23` risk=`HIGH`
- `runtime/network/d_net_schema.c` disposition=`quarantine` rank=`2` total_score=`63.61` risk=`HIGH`

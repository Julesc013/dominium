...
# Quarantine Packet `duplicate.sig.ec1e946596f4bf09`

- Symbol: `dom_time_act_to_bst`
- Cluster Kind: `exact`
...
- `engine/kernel/dom_time_frames.c`

## Scorecard

- `engine/include/domino/core/dom_time_frames.h` disposition=`canonical` rank=`1` total_score=`58.05` risk=`HIGH`
- `engine/kernel/dom_time_frames.c` disposition=`quarantine` rank=`2` total_score=`57.15` risk=`HIGH`

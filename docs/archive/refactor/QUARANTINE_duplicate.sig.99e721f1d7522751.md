...
- Risk Level: `HIGH`
- Canonical Candidate: `game/domain/simulation/pkt/registry/dg_type_registry.c`
- Quarantine Reasons: `planned_quarantine`
- Planned Action Kinds: `quarantine`

## Competing Files

- `game/domain/simulation/pkt/registry/dg_type_registry.c`
- `game/domain/simulation/pkt/registry/dg_type_registry.h`

## Scorecard

- `game/domain/simulation/pkt/registry/dg_type_registry.c` disposition=`canonical` rank=`1` total_score=`88.69` risk=`HIGH`
- `game/domain/simulation/pkt/registry/dg_type_registry.h` disposition=`quarantine` rank=`2` total_score=`87.8` risk=`HIGH`

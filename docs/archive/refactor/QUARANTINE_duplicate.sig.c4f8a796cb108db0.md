...
- Docs: `docs/SCHEMA_EVOLUTION.md, docs/runtime/shell/CLI_REFERENCE.md, docs/runtime/shell/IPC_ATTACH_CONSOLES.md, docs/runtime/shell/TUI_FRAMEWORK.md, docs/architecture/APP_CANON0.md, docs/architecture/APP_CANON1.md, docs/architecture/BEHAVIORAL_COMPONENTS_STANDARD.md, docs/architecture/CANON_INDEX.md`

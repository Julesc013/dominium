...
# Quarantine Packet `duplicate.cluster.e8925ee259b7adc2`

- Symbol: `_entry_fingerprint`
- Cluster Kind: `near`
- Cluster Resolution: `quarantine`
- Risk Level: `HIGH`
- Canonical Candidate: `tools/xstack/compatx/core/semantic_contract_validator.py`
...
- `tools/xstack/compatx/core/semantic_contract_validator.py` disposition=`canonical` rank=`1` total_score=`84.05` risk=`HIGH`

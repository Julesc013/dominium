...
- Build Targets: `none`
- Docs: `docs/runtime/shell/CLI_REFERENCE.md, docs/runtime/shell/TOOL_REFERENCE.md, docs/architecture/EXPLORATION_SCALING_PROOF.md, docs/architecture/SLICE_0_CONTRACT.md, docs/architecture/WORLDDEFINITION.md, docs/architecture/WORLDDEFINITION_CONTRACT.md, docs/architecture/camera_and_navigation.md, docs/audit/EMBODIMENT_BASELINE_REPORT.md`

...
# Quarantine Packet `duplicate.cluster.893c13a7938c4ef4`
...
- `src/tools/package/libraries/provides/__init__.py` disposition=`canonical` rank=`1` total_score=`64.17` risk=`HIGH`
- `src/tools/package/libraries/provides/provider_resolution.py` disposition=`quarantine` rank=`2` total_score=`54.72` risk=`HIGH`

...
- `tools/validators/domain/geology/geo10_stress_common.py` disposition=`canonical` rank=`1` total_score=`63.87` risk=`HIGH`
- `tools/validators/domain/geology/geo10_stress_runtime.py` disposition=`quarantine` rank=`2` total_score=`59.54` risk=`HIGH`

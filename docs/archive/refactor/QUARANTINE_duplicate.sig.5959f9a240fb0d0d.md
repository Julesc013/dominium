...
# Quarantine Packet `duplicate.sig.5959f9a240fb0d0d`

- Symbol: `dom_time_event_id_next`
- Cluster Kind: `exact`
...
- `engine/kernel/dom_time_events.c` disposition=`quarantine` rank=`2` total_score=`82.5` risk=`HIGH`

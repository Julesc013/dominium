...
- Risk Level: `HIGH`
- Canonical Candidate: `tools/xstack/compatx/compatx.py`
...
- `tools/xstack/compatx/compatx.py` disposition=`canonical` rank=`1` total_score=`68.93` risk=`HIGH`
- `tools/xstack/securex/securex.py` disposition=`quarantine` rank=`2` total_score=`66.55` risk=`HIGH`

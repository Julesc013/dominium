...
- Build Targets: `none`
- Docs: `docs/runtime/shell/CLI_REFERENCE.md, docs/archive/architecture/INVARIANTS.md, docs/archive/architecture/TERMINOLOGY.md, docs/audit/APPSHELL_IPC_BASELINE.md, docs/audit/CHEM1_RETRO_AUDIT.md, docs/audit/CHEM4_RETRO_AUDIT.md, docs/audit/COMBUSTION_BASELINE.md, docs/audit/COMPUTE_BUDGET_BASELINE.md`

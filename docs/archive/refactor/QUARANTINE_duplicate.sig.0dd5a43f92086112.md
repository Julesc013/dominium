...
- Build Targets: `none`
- Docs: `docs/ARCHITECTURE.md, docs/runtime/shell/CLI_REFERENCE.md, docs/runtime/shell/TOOL_REFERENCE.md, docs/architecture/CANON_INDEX.md, docs/architecture/INSTALL_MODEL.md, docs/architecture/INSTANCE_MODEL.md, docs/architecture/REPORT_GAME_ARCH_DECISIONS.md, docs/architecture/SAVE_MODEL.md`

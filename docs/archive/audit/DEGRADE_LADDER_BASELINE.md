...
Superseded By: none
Version: 1.0.0
Compatibility: Derived from `docs/compatibility/DEGRADE_LADDERS.md`, `data/registries/degrade_ladder_registry.json`, `data/registries/capability_fallback_registry.json`, `src/compat/capability_negotiation.py`, and `src/compat/negotiation/degrade_enforcer.py`.

...
| tool_ui_bind | `archive/generated/dist/sys/winnt/x64/bin/tools/tool_ui_bind.exe` | Tool (CLI) | `domino_ui_ir.lib`, `appcore.lib` | Win32 CRT + standard Windows SDK link set |
| tool_ui_validate | `archive/generated/dist/sys/winnt/x64/bin/tools/tool_ui_validate.exe` | Tool (CLI) | `domino_ui_ir.lib`, `domino_core` link chain | Win32 CRT + standard Windows SDK link set |
...
- Executables:
  ...
  - `archive/generated/dist/sys/winnt/x64/bin/tools/tool_ui_bind.exe`
  - `archive/generated/dist/sys/winnt/x64/bin/tools/tool_ui_validate.exe`

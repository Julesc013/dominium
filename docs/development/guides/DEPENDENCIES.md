...
- Language/determinism constraints: `docs/reference/specs/SPEC_LANGUAGE_BASELINES.md`,
...
Public header boundaries and ABI rules are defined in `docs/reference/specs/CONTRACTS.md`.
...
- Authoritative code must not use wall-clock time, non-deterministic RNG, or
  ...
  platform APIs. See `docs/reference/specs/SPEC_DETERMINISM.md`.

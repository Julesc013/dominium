...
- `docs/reference/specs/DATA_FORMATS.md`: legacy `universe_seed`/universe metadata fields. Owner: docs/spec alignment (P2).
...
- `docs/reference/specs/SPEC_GAME_CLI.md`: dev override permits absolute paths. Owner: CLI contract alignment (P2/P7).
...
- `docs/reference/specs/SPEC_DOMINO_SIM.md`: documents `dt_s`/`sim_time_s` in sim state. Owner: spec alignment (P2).
- `docs/REPORT_GAME_ARCH_DECISIONS.md`: notes `dt_s = 1/ups` in core. Owner: spec alignment (P2).
- `docs/reference/specs/SPEC_NUMERIC.md`: defines `g_domino_dt_s` and default 30 Hz. Owner: spec alignment (P2).
- `docs/reference/specs/SPEC_DOMINIUM_RULES.md`: references `dt_s` values in runtime APIs. Owner: spec alignment (P2).
...
- `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`: documents `timestamp_wall_us`. Owner: docs/spec alignment (P2).

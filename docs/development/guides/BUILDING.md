...
- Baseline and modern presets are documented in `docs/testing/ci/BUILD_MATRIX.md`.
...
- Dist layout outputs are opt-in via `dist_set_role`; see
  `docs/development/guides/BUILD_DIST.md` and `docs/development/guides/build_output.md`.

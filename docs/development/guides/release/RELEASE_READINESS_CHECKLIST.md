...
- [x] Setup docs complete + consistent (arch, schema, txn/journal, installed state, audit log, CLI, adapters, packaging, recovery, security, reproducible builds)
  Code: docs/apps/setup/SETUP_CORE_ARCHITECTURE.md, docs/apps/setup/MANIFEST_SCHEMA.md, docs/apps/setup/TRANSACTION_ENGINE.md,
        docs/apps/setup/JOURNAL_FORMAT.md, docs/apps/setup/INSTALLED_STATE_SCHEMA.md, docs/apps/setup/AUDIT_LOG_FORMAT.md,
        docs/apps/setup/CLI_REFERENCE.md, docs/apps/setup/PLATFORM_ADAPTERS.md, docs/apps/setup/PACKAGING_PIPELINES.md,
        docs/apps/setup/TROUBLESHOOTING.md, docs/apps/setup/SECURITY_MODEL.md, docs/apps/setup/REPRODUCIBLE_BUILDS.md
...
- [x] Launcher docs complete + consistent (installed-state contract, error handling, smoke tests, recovery workflow)
  Code: docs/reference/specs/launcher/ARCHITECTURE.md, docs/reference/specs/launcher/RECOVERY_AND_SAFE_MODE.md, docs/reference/specs/launcher/TESTING.md
  Tests: docs validation pass (manual review)
  Commits: b89f63a
  Verify: docs/apps/launcher/CLI.md, docs/release/RECOVERY_PLAYBOOK.md (launcher section)

...
- `data/xstack/**`
- explicit XStack governance/task docs under `docs/game/agents/` and `docs/governance/`
...
| `tools/xstack/ci/`, `archive/generated/xstack/gate_definitions.json`, `docs/development/xstack/CI_GUARDRAILS.md`, and `docs/development/xstack/ARCH_DRIFT_POLICY.md` | These surfaces define and drive CI/guardrail policy rather than gameplay or product runtime. |
...
| `docs/development/xstack/XSTACK.md` | Useful reference, but still describes an older gate-centric model and does not cleanly reflect current live coupling. |
...
| `docs/development/xstack/` and `data/xstack/` | Useful support surfaces for later extracted policy/catalog packaging, but docs/data do not justify a standalone platform by themselves. |
...
- support policy/catalog surfaces under `docs/development/xstack/` and `data/xstack/`

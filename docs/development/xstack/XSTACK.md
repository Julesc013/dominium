...
- Use `docs/archive/audit/VALIDATION_STACK_MAP.md` for the current validation surface inventory.
- Use `docs/archive/audit/ENTRYPOINT_MAP.md` and `docs/archive/audit/REPO_REVIEW_2_FINAL.md` for convergence-era product and tooling ownership.
...
Artifacts are emitted under `docs/archive/audit/auditx/`.
...
- artifacts: `docs/archive/audit/performance/`
...
- artifacts: `docs/archive/audit/compat/`
...
- artifacts: `docs/archive/audit/security/`
...
- Architecture summary: `docs/architecture/ROOT_ARCHITECTURE.md`
- Survival baseline: `docs/archive/SURVIVAL_SLICE.md`

...
- Repo Paths: `docs/development/xstack/AIDE_PORTABLE_TASK_CONTRACT.md`, `contracts/xstack/aide_portable_task_contract.json`, `docs/development/xstack/AIDE_EVIDENCE_AND_REVIEW_CONTRACT.md`, `contracts/xstack/aide_evidence_and_review_contract.json`, `docs/development/xstack/AIDE_POLICY_AND_PERMISSION_SHAPE.md`, `contracts/xstack/aide_policy_and_permission_shape.json`, `docs/development/xstack/AIDE_CAPABILITY_PROFILE_SHAPE.md`, `contracts/xstack/aide_capability_profile_shape.json`, `docs/development/xstack/AIDE_ADAPTER_CONTRACT.md`, `contracts/xstack/aide_adapter_contract.json`
...
- Rationale: these are wrapper CLIs over repo-specific audit and review scans; `auditx/check.py` explicitly calls itself a wrapper and reads `docs/archive/audit/auditx/FINDINGS.json`, while `repox/check.py` hardcodes repo scan roots and review helpers
...
- Repo Paths: `tools/xstack/ci/`, `docs/development/xstack/CI_GUARDRAILS.md`, `docs/development/xstack/ARCH_DRIFT_POLICY.md`, `archive/generated/xstack/gate_definitions.json`
- Current role / maturity summary: `ops_concern / implemented_and_used / wired_to_entrypoints`
- Extraction decision: `mixed_needs_later_review`
...
- Repo Paths: `docs/development/xstack/XSTACK.md`, `docs/governance/XSTACK_PORTABILITY.md`, `docs/governance/XSTACK_INCREMENTAL_MODEL.md`, `docs/governance/XSTACK_EXTENSION_MODEL.md`, `docs/development/xstack/CODEX_REPO_OPERATING_CONTRACT.md`, `contracts/xstack/codex_repo_operating_contract.json`
...
- `docs/development/xstack/CODEX_REPO_OPERATING_CONTRACT.md` and `contracts/xstack/codex_repo_operating_contract.json`
...
- the frozen portable contract artifacts under `docs/development/xstack/AIDE_*.md` and `data/xstack/aide_*.json`
...
- report sink/path adapters so extracted cores do not write directly into `docs/archive/audit/**` and `data/audit/**`

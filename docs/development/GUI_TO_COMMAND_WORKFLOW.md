...
- Ensure widget names follow `docs/development/UI_NAMING_CONVENTIONS.md`.
...
```sh
tool_ui_doc_annotate --repo-root . --ui-index tools/codegen/ui/index/ui_index.json --write
```
...
```sh
tool_ui_bind --repo-root . --ui-index tools/codegen/ui/index/ui_index.json --out-dir libs/appcore/ui_bind --write
```

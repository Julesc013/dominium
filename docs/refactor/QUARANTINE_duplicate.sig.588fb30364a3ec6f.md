...
# Quarantine Packet `duplicate.sig.588fb30364a3ec6f`
...
- `game/include/dominium/execution/system_iface.h`
...
- `game/include/dominium/rules/governance/governance_system.h` disposition=`canonical` rank=`1` total_score=`85.18` risk=`HIGH`
- `game/include/dominium/rules/war/war_system.h` disposition=`quarantine` rank=`2` total_score=`77.83` risk=`HIGH`
- `game/include/dominium/rules/economy/economy_system.h` disposition=`drop` rank=`3` total_score=`77.07` risk=`HIGH`
- `game/include/dominium/execution/system_iface.h` disposition=`drop` rank=`4` total_score=`72.14` risk=`HIGH`
- `game/include/dominium/rules/agents/agent_system.h` disposition=`drop` rank=`5` total_score=`72.08` risk=`HIGH`
...
- Build Targets: `none`
- Docs: `docs/ARCHITECTURE.md, docs/GLOSSARY.md, docs/architecture/ADOPTION_PROTOCOL.md, docs/architecture/ARCH0_CONSTITUTION.md, docs/architecture/ARCH_BUILD_ENFORCEMENT.md, docs/architecture/CANON_INDEX.md, docs/architecture/CONTRACTS_INDEX.md, docs/architecture/EXTENSION_MAP.md`

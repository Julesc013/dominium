...
- `src/tools/governance/view/view_engine.py` disposition=`quarantine` rank=`12` total_score=`53.87` risk=`HIGH`
...
- `src/tools/validators/safety/safety_engine.py` disposition=`drop` rank=`17` total_score=`52.73` risk=`HIGH`
...
- `src/tools/governance/effects/effect_engine.py` disposition=`drop` rank=`22` total_score=`50.98` risk=`HIGH`
...
- `src/tools/governance/planning/plan_engine.py` disposition=`drop` rank=`33` total_score=`46.81` risk=`HIGH`

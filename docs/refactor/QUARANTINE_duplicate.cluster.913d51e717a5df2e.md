...
# Quarantine Packet `duplicate.cluster.913d51e717a5df2e`
...
- `src/worldgen/earth/water/water_view_engine.py` disposition=`canonical` rank=`1` total_score=`51.68` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.869d9b3336072b15`
...
- `src/system/certification/system_cert_engine.py` disposition=`quarantine` rank=`3` total_score=`51.68` risk=`HIGH`

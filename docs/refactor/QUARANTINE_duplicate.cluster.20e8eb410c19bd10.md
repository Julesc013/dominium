...
# Quarantine Packet `duplicate.cluster.20e8eb410c19bd10`
...
- Quarantine Reasons: `builtin_or_entrypoint_collision, cross_domain_helper_collision, cross_product_surface, file_scope_ambiguity, near_duplicate_requires_review, secondary_file_active_in_default_build`

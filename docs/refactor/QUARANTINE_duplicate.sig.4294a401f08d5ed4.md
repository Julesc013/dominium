...
# Quarantine Packet `duplicate.sig.4294a401f08d5ed4`
...
- `tests/bugreport/bugreport_ingest_tests.py`
...
- `tests/bugreport/bugreport_ingest_tests.py` disposition=`merge` rank=`49` total_score=`59.29` risk=`HIGH`
- `tests/integration/mining_field_tests.py` disposition=`merge` rank=`50` total_score=`59.29` risk=`HIGH`
- `tests/integration/server_discovery_tests.py` disposition=`drop` rank=`51` total_score=`59.06` risk=`HIGH`
- `tests/perf/institution_perf_tests.py` disposition=`merge` rank=`52` total_score=`59.06` risk=`HIGH`
- `tests/perf/weather_perf_tests.py` disposition=`merge` rank=`53` total_score=`59.06` risk=`HIGH`
- `tests/integration/autonomy_field_tests.py` disposition=`merge` rank=`54` total_score=`58.09` risk=`HIGH`
- `tests/integration/economy_field_tests.py` disposition=`merge` rank=`55` total_score=`58.09` risk=`HIGH`
- `tests/integration/exploration_scaling_tests.py` disposition=`merge` rank=`56` total_score=`58.09` risk=`HIGH`
- `tests/integration/geology_field_tests.py` disposition=`merge` rank=`57` total_score=`58.09` risk=`HIGH`
- `tests/integration/world_manager_tests.py` disposition=`drop` rank=`58` total_score=`58.09` risk=`HIGH`
- `tests/perf/autonomy_perf_tests.py` disposition=`merge` rank=`59` total_score=`58.09` risk=`HIGH`
- `tests/perf/geology_perf_tests.py` disposition=`merge` rank=`60` total_score=`58.09` risk=`HIGH`
- `tests/perf/mining_perf_tests.py` disposition=`merge` rank=`61` total_score=`58.09` risk=`HIGH`
- `tests/integration/animal_agent_tests.py` disposition=`merge` rank=`62` total_score=`56.9` risk=`HIGH`
- `tests/integration/crafting_field_tests.py` disposition=`merge` rank=`63` total_score=`56.9` risk=`HIGH`
- `tests/integration/freecam_epistemics_tests.py` disposition=`merge` rank=`64` total_score=`56.9` risk=`HIGH`
- `tests/integration/vegetation_field_tests.py` disposition=`merge` rank=`65` total_score=`56.9` risk=`HIGH`
- `tests/perf/animal_perf_tests.py` disposition=`merge` rank=`66` total_score=`56.9` risk=`HIGH`
- `tests/perf/exploration_fixture_contracts.py` disposition=`merge` rank=`67` total_score=`56.9` risk=`HIGH`
- `tests/perf/vegetation_perf_tests.py` disposition=`merge` rank=`68` total_score=`56.9` risk=`HIGH`
- `tests/perf/crafting_perf_tests.py` disposition=`merge` rank=`69` total_score=`55.12` risk=`HIGH`
- `tests/integration/server_tools_operational_tests.py` disposition=`merge` rank=`70` total_score=`54.3` risk=`HIGH`
- `tests/integration/exploration_scale_guard_tests.py` disposition=`merge` rank=`71` total_score=`53.93` risk=`HIGH`

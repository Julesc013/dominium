...
- `engine/modules/ai/d_agent.h` disposition=`canonical` rank=`1` total_score=`81.96` risk=`HIGH`
- `engine/modules/ai/d_agent.c` disposition=`quarantine` rank=`2` total_score=`81.43` risk=`HIGH`

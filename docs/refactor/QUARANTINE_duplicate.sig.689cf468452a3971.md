...
- Risk Level: `HIGH`
- Canonical Candidate: `src/tools/validators/compatibility/negotiation/degrade_enforcer.py`
...
- `src/tools/validators/compatibility/negotiation/degrade_enforcer.py` disposition=`canonical` rank=`1` total_score=`62.5` risk=`HIGH`
- `src/tools/validators/compatibility/negotiation/__init__.py` disposition=`quarantine` rank=`2` total_score=`60.95` risk=`HIGH`

...
# Quarantine Packet `duplicate.cluster.a5e8b1d0e29b2634`
...
- `src/worldgen/earth/material/material_proxy_engine.py` disposition=`quarantine` rank=`2` total_score=`54.57` risk=`HIGH`

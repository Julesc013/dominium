...
# Quarantine Packet `duplicate.sig.80a46c267b593019`

- Symbol: `REFUSAL_SYSTEM_MACRO_MODEL_SET_INVALID`
- Cluster Kind: `exact`
...
- `src/system/macro/__init__.py` disposition=`canonical` rank=`1` total_score=`61.55` risk=`HIGH`

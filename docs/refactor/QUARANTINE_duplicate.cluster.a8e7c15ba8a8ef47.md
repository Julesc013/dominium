...
# Quarantine Packet `duplicate.cluster.a8e7c15ba8a8ef47`
...
- `tools/xstack/testx/tests/test_ranked_profile_forbids_free_view.py` disposition=`merge` rank=`3` total_score=`62.03` risk=`HIGH`

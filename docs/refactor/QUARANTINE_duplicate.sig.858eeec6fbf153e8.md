...
- Risk Level: `HIGH`
- Canonical Candidate: `game/domain/job/d_job_validate.c`
...
- `game/domain/job/d_job_validate.c`

## Scorecard

- `game/domain/job/d_job_validate.c` disposition=`canonical` rank=`1` total_score=`81.55` risk=`HIGH`
- `game/domain/job/d_job.h` disposition=`quarantine` rank=`2` total_score=`76.43` risk=`HIGH`

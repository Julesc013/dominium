...
# Quarantine Packet `duplicate.cluster.50b28aa7aa0b96db`
...
- Quarantine Reasons: `builtin_or_entrypoint_collision, cross_domain_helper_collision, cross_product_surface, entrypoint_surface, file_scope_ambiguity, near_duplicate_requires_review, phase_boundary_deferred, requires_medium_risk_batch_gate`

...
# Quarantine Packet `duplicate.cluster.b8d950dc2f1cbfa9`
...
- `src/astro/ephemeris/kepler_proxy_engine.py` disposition=`drop` rank=`17` total_score=`49.04` risk=`HIGH`
- `src/worldgen/earth/sky/astronomy_proxy_engine.py` disposition=`drop` rank=`18` total_score=`48.36` risk=`HIGH`
- `src/worldgen/earth/sky/starfield_generator.py` disposition=`drop` rank=`19` total_score=`48.36` risk=`HIGH`
- `src/worldgen/galaxy/galaxy_proxy_field_engine.py` disposition=`merge` rank=`20` total_score=`48.25` risk=`HIGH`
- `src/worldgen/mw/mw_surface_refiner_l3.py` disposition=`merge` rank=`21` total_score=`47.84` risk=`HIGH`
- `src/embodiment/collision/macro_heightfield_provider.py` disposition=`merge` rank=`22` total_score=`47.82` risk=`HIGH`

...
- `src/tools/governance/negotiation/__init__.py` disposition=`canonical` rank=`1` total_score=`72.68` risk=`HIGH`
- `src/control/__init__.py` disposition=`quarantine` rank=`2` total_score=`67.02` risk=`HIGH`
- `src/tools/governance/negotiation/negotiation_kernel.py` disposition=`merge` rank=`3` total_score=`54.02` risk=`HIGH`

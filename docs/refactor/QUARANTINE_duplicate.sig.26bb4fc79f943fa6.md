...
- `runtime/network/d_net_transport.c` disposition=`canonical` rank=`1` total_score=`88.1` risk=`HIGH`
- `runtime/network/d_net_transport.h` disposition=`quarantine` rank=`2` total_score=`86.07` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.f6cc7c4edbebc0d8`

- Symbol: `dtlv_le_write_u64`
- Cluster Kind: `exact`
...
- `runtime/storage/io/dtlv.c`

## Scorecard

- `engine/include/domino/io/container.h` disposition=`canonical` rank=`1` total_score=`76.64` risk=`HIGH`
- `runtime/storage/io/dtlv.c` disposition=`quarantine` rank=`2` total_score=`67.44` risk=`HIGH`

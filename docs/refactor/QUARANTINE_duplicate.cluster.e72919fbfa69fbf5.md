...
# Quarantine Packet `duplicate.cluster.e72919fbfa69fbf5`
...
- `tools/validators/domain/geology/tool_replay_geo_window.py` disposition=`canonical` rank=`1` total_score=`65.1` risk=`HIGH`
- `tools/validators/domain/geology/tool_verify_overlay_identity.py` disposition=`quarantine` rank=`2` total_score=`62.94` risk=`HIGH`

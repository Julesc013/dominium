...
| `duplicate.cluster.07c7e7b9365cb9dc` | `quarantine` | `src/tools/libraries/provides/__init__.py` | `src/tools/libraries/provides/provider_resolution.py` | `HIGH` |
...
| `duplicate.cluster.0b7c5e4a1d1e1287` | `quarantine` | `src/tools/libraries/bundle/__init__.py` | `src/tools/libraries/bundle/bundle_manifest.py` | `HIGH` |

...
| --- | --- | --- | --- | --- |
| `duplicate.cluster.0075f9b78b2784df` | `quarantine` | `src/meta_extensions_engine.py` | `src/tools/repo/meta/extensions/extensions_engine.py` | `HIGH` |
...
| `duplicate.cluster.03ab149d795288bb` | `quarantine` | `tools/package/distribution/profile_inspect.py` | `tools/package/distribution/compat_dry_run.py` | `HIGH` |
...
| `duplicate.cluster.0631a59ef2fe2be3` | `quarantine` | `src/tools/repo/meta/extensions/__init__.py` | `src/meta_extensions_engine.py` | `HIGH` |
...
| `duplicate.cluster.07c7e7b9365cb9dc` | `quarantine` | `src/tools/package/libraries/provides/__init__.py` | `src/tools/package/libraries/provides/provider_resolution.py` | `HIGH` |
...
| `duplicate.cluster.0b7c5e4a1d1e1287` | `quarantine` | `src/tools/package/libraries/bundle/__init__.py` | `src/tools/package/libraries/bundle/bundle_manifest.py` | `HIGH` |
| `duplicate.cluster.0bb6cc4d90e796fb` | `quarantine` | `tests/ops/ops_manifest_tests.py` | `tests/ops/compatibility_tests.py` | `HIGH` |
| `duplicate.cluster.0bbdf1ddf2183c6a` | `quarantine` | `setup/packages/scripts/gen_launcher_ui_schema_v1.py` | `tests/tests/game/vectors/gen_tlv_vectors.py` | `HIGH` |

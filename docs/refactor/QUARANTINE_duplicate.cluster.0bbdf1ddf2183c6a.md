...
# Quarantine Packet `duplicate.cluster.0bbdf1ddf2183c6a`

- Symbol: `tlv_u32`
- Cluster Kind: `near`
- Cluster Resolution: `quarantine`
- Risk Level: `HIGH`
- Canonical Candidate: `setup/packages/scripts/gen_launcher_ui_schema_v1.py`
...
- Build Targets: `none`
- Docs: `docs/specs/core/TLV_SCHEMA_GOVERNANCE.md`

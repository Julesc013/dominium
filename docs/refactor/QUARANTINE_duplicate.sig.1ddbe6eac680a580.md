...
# Quarantine Packet `duplicate.sig.1ddbe6eac680a580`

- Symbol: `_geo_sort_tuple`
- Cluster Kind: `exact`
...
- `src/worldgen/earth/tide_field_engine.py` disposition=`quarantine` rank=`4` total_score=`54.55` risk=`HIGH`

## Usage Sites

- Build Targets: `none`
- Docs: `docs/runtime/shell/CLI_REFERENCE.md, docs/architecture/CANON_INDEX.md, docs/audit/CANON_MAP.md, docs/audit/COMPAT_SEM2_RETRO_AUDIT.md, docs/audit/DOC_INDEX.md, docs/audit/EARTH10_RETRO_AUDIT.md, docs/audit/EARTH2_RETRO_AUDIT.md, docs/audit/EARTH3_RETRO_AUDIT.md`

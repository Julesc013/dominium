...
# Quarantine Packet `duplicate.sig.5d1d7b9792e8dd80`
...
- `tools/xstack/testx/tests/test_control_save_compat_replay.py` disposition=`quarantine` rank=`3` total_score=`59.55` risk=`HIGH`

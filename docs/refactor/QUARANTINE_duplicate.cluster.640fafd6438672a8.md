...
- `src/tools/governance/fidelity/fidelity_engine.py` disposition=`canonical` rank=`1` total_score=`58.11` risk=`HIGH`
- `src/tools/governance/negotiation/negotiation_kernel.py` disposition=`quarantine` rank=`2` total_score=`49.49` risk=`HIGH`

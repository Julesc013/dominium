...
- Risk Level: `HIGH`
- Canonical Candidate: `src/tools/libraries/store/__init__.py`
...
- `src/tools/libraries/store/__init__.py` disposition=`canonical` rank=`1` total_score=`59.13` risk=`HIGH`
- `src/engine/store/gc_engine.py` disposition=`quarantine` rank=`2` total_score=`51.18` risk=`HIGH`

...
# Quarantine Packet `duplicate.cluster.ea7102a8ffc867fd`

- Symbol: `REFUSAL_SYSTEM_CERT_UNKNOWN_PROFILE`
- Cluster Kind: `near`
...
- `src/system/certification/system_cert_engine.py` disposition=`quarantine` rank=`2` total_score=`51.68` risk=`HIGH`

...
- Risk Level: `HIGH`
- Canonical Candidate: `engine/kernel/d_tlv_schema.c`
...
- `engine/kernel/d_tlv_schema.c` disposition=`canonical` rank=`1` total_score=`81.55` risk=`HIGH`
- `engine/kernel/d_tlv_schema.h` disposition=`quarantine` rank=`2` total_score=`79.7` risk=`HIGH`

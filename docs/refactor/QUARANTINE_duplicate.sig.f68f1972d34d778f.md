...
- Risk Level: `HIGH`
- Canonical Candidate: `engine/kernel/d_container_state.c`
- Quarantine Reasons: `planned_quarantine`
- Planned Action Kinds: `quarantine`

## Competing Files

- `engine/kernel/d_container_state.c`
- `engine/kernel/d_container_state.h`

## Scorecard

- `engine/kernel/d_container_state.c` disposition=`canonical` rank=`1` total_score=`83.93` risk=`HIGH`
- `engine/kernel/d_container_state.h` disposition=`quarantine` rank=`2` total_score=`80.06` risk=`HIGH`

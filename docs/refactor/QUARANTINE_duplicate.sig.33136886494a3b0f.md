...
# Quarantine Packet `duplicate.sig.33136886494a3b0f`
...
- `tools/validators/domain/geology/geo10_stress_common.py` disposition=`canonical` rank=`1` total_score=`69.23` risk=`HIGH`

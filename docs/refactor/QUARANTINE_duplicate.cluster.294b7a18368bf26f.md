...
# Quarantine Packet `duplicate.cluster.294b7a18368bf26f`
...
- `src/tools/repo/meta/explain/__init__.py` disposition=`canonical` rank=`1` total_score=`67.14` risk=`HIGH`
- `src/tools/repo/meta/explain/explain_engine.py` disposition=`quarantine` rank=`2` total_score=`59.58` risk=`HIGH`

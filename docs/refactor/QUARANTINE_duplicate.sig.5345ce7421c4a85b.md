...
# Quarantine Packet `duplicate.sig.5345ce7421c4a85b`
...
- `src/worldgen/earth/wind/wind_field_engine.py` disposition=`quarantine` rank=`5` total_score=`54.94` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.bb153e03f0b0c034`

- Symbol: `surface_flag_map_from_mask`
- Cluster Kind: `exact`
...
- `src/worldgen/earth/material/material_proxy_engine.py` disposition=`quarantine` rank=`3` total_score=`53.61` risk=`HIGH`

## Usage Sites

- Build Targets: `none`
- Docs: `docs/audit/MODULE_DUPLICATION_REPORT.md, docs/audit/REPO_TREE_INDEX.md, docs/domains/worldgen/EARTH_WATER_VISUAL_MODEL.md`

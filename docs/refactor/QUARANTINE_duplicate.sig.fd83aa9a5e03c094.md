...
- `src/tools/governance/effects/__init__.py` disposition=`canonical` rank=`1` total_score=`67.14` risk=`HIGH`
- `src/control/__init__.py` disposition=`quarantine` rank=`2` total_score=`62.26` risk=`HIGH`
- `src/tools/governance/effects/effect_engine.py` disposition=`merge` rank=`3` total_score=`50.01` risk=`HIGH`

...
# Quarantine Packet `duplicate.cluster.4de651971fe8ea84`
...
- `tools/xstack/testx/tests/appshell3_testlib.py` disposition=`quarantine` rank=`8` total_score=`81.67` risk=`HIGH`
- `tools/xstack/testx/tests/appshell1_testlib.py` disposition=`drop` rank=`9` total_score=`77.02` risk=`HIGH`
- `tools/xstack/testx/tests/server_mvp1_testlib.py` disposition=`merge` rank=`10` total_score=`76.43` risk=`HIGH`
- `tools/xstack/testx/tests/pack_compat0_testlib.py` disposition=`merge` rank=`11` total_score=`76.19` risk=`HIGH`
- `tools/xstack/testx/tests/mod_policy0_testlib.py` disposition=`merge` rank=`12` total_score=`75.0` risk=`HIGH`
- `tools/xstack/testx/tests/ipc_unify_testlib.py` disposition=`drop` rank=`13` total_score=`68.89` risk=`HIGH`
- `tools/xstack/testx/tests/ui_reconcile_testlib.py` disposition=`merge` rank=`14` total_score=`68.45` risk=`HIGH`

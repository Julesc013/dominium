...
# Quarantine Packet `duplicate.sig.7b835ebdeb46569f`

- Symbol: `emitter_kind_registry_hash`
- Cluster Kind: `exact`
...
- `src/astro/illumination/__init__.py` disposition=`canonical` rank=`1` total_score=`58.04` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.2f01ae6cb62a1cea`

- Symbol: `REFUSAL_GEO_CCTV_INVALID`
- Cluster Kind: `exact`
...
- `src/geo/lens/__init__.py` disposition=`quarantine` rank=`2` total_score=`50.74` risk=`HIGH`

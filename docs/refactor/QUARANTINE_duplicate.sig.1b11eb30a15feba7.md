...
- `tools/validate/policy_validation.h` disposition=`quarantine` rank=`2` total_score=`80.12` risk=`HIGH`
- `tools/validate/tool_validation.h` disposition=`quarantine` rank=`3` total_score=`80.12` risk=`HIGH`
...
- `tools/validate/policy_validation.cpp` disposition=`quarantine` rank=`8` total_score=`74.4` risk=`HIGH`
- `tools/validate/tool_validation.cpp` disposition=`quarantine` rank=`9` total_score=`74.4` risk=`HIGH`
- `tools/coredata_compile/coredata_validate.h` disposition=`quarantine` rank=`10` total_score=`72.58` risk=`HIGH`
- `tools/validation/validator_common.cpp` disposition=`quarantine` rank=`11` total_score=`71.05` risk=`HIGH`
...
- `tools/universe_editor/ue_commands.h` disposition=`merge` rank=`26` total_score=`64.74` risk=`HIGH`
- `tools/replay_analyzer/ra_diff.h` disposition=`merge` rank=`27` total_score=`64.44` risk=`HIGH`
- `tools/replay_viewer/dom_replay_viewer_controller.h` disposition=`merge` rank=`28` total_score=`64.2` risk=`HIGH`
- `tools/net_inspector/dom_net_inspector_controller.h` disposition=`merge` rank=`29` total_score=`64.07` risk=`HIGH`
- `tools/replay_analyzer/ra_parser.h` disposition=`merge` rank=`30` total_score=`63.32` risk=`HIGH`
- `tools/validator/validator_checks.cpp` disposition=`merge` rank=`31` total_score=`61.83` risk=`HIGH`
- `tools/coredata_compile/coredata_emit_tlv.cpp` disposition=`merge` rank=`32` total_score=`61.81` risk=`HIGH`
- `tools/validation/validator_reports.cpp` disposition=`merge` rank=`33` total_score=`61.7` risk=`HIGH`
- `tools/replay_analyzer/ra_parser.cpp` disposition=`merge` rank=`34` total_score=`60.74` risk=`HIGH`
- `tools/universe_editor/ue_queries.h` disposition=`merge` rank=`35` total_score=`60.26` risk=`HIGH`
- `tools/validation/validators_registry.cpp` disposition=`merge` rank=`36` total_score=`60.26` risk=`HIGH`
- `tools/world_editor/dom_world_editor_controller.h` disposition=`merge` rank=`37` total_score=`60.26` risk=`HIGH`
- `tools/replay_analyzer/ra_diff.cpp` disposition=`merge` rank=`38` total_score=`59.91` risk=`HIGH`
- `tools/universe_editor/ue_queries.cpp` disposition=`merge` rank=`39` total_score=`59.3` risk=`HIGH`
- `tools/replay_viewer/dom_replay_viewer_controller.cpp` disposition=`merge` rank=`40` total_score=`58.83` risk=`HIGH`
- `tools/coredata_validate/coredata_validate_checks.cpp` disposition=`merge` rank=`41` total_score=`58.7` risk=`HIGH`
- `tools/universe_editor/ue_commands.cpp` disposition=`merge` rank=`42` total_score=`57.88` risk=`HIGH`
- `tools/net_inspector/dom_net_inspector_controller.cpp` disposition=`merge` rank=`43` total_score=`57.87` risk=`HIGH`
- `tools/world_editor/dom_world_editor_controller.cpp` disposition=`merge` rank=`44` total_score=`57.87` risk=`HIGH`
- `tools/save_inspector/dom_save_inspector_controller.cpp` disposition=`merge` rank=`45` total_score=`55.16` risk=`HIGH`

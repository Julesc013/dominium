...
# Quarantine Packet `duplicate.cluster.88dab2d679244b5d`
...
- `src/worldgen/earth/sky/sky_view_engine.py` disposition=`drop` rank=`4` total_score=`53.75` risk=`HIGH`
- `src/worldgen/earth/lighting/lighting_view_engine.py` disposition=`drop` rank=`5` total_score=`52.51` risk=`HIGH`
- `src/astro/views/orbit_view_engine.py` disposition=`drop` rank=`6` total_score=`52.21` risk=`HIGH`

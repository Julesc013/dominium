...
# Quarantine Packet `duplicate.sig.ab4e1657b2c50486`
...
- `src/geo/render/__init__.py` disposition=`quarantine` rank=`2` total_score=`54.69` risk=`HIGH`
- `src/geo/render/floating_origin_policy.py` disposition=`quarantine` rank=`3` total_score=`50.81` risk=`HIGH`

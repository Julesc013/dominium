...
# Quarantine Packet `duplicate.sig.ec29b7675de6a395`

- Symbol: `arbitrate_logic_protocol_frames`
- Cluster Kind: `exact`
...
- `src/logic/protocol/protocol_engine.py` disposition=`merge` rank=`3` total_score=`35.11` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.b8086df9a3b92ea6`
...
- `game/include/dominium/execution/system_iface.h` disposition=`merge` rank=`2` total_score=`68.57` risk=`HIGH`
- `game/include/dominium/rules/war/war_system.h` disposition=`quarantine` rank=`3` total_score=`67.35` risk=`HIGH`
- `game/include/dominium/rules/economy/economy_system.h` disposition=`drop` rank=`4` total_score=`67.04` risk=`HIGH`
- `game/include/dominium/rules/scale/interest_system.h` disposition=`drop` rank=`5` total_score=`65.98` risk=`HIGH`
- `game/include/dominium/rules/agents/agent_system.h` disposition=`drop` rank=`6` total_score=`65.85` risk=`HIGH`
- `game/include/dominium/rules/scale/world_streaming_system.h` disposition=`drop` rank=`7` total_score=`62.71` risk=`HIGH`
- `client/presentation/render_prep_system.h` disposition=`drop` rank=`8` total_score=`59.31` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.68a4882e58556a8e`

- Symbol: `dom_ticks_to_us`
- Cluster Kind: `exact`
...
- `engine/kernel/spacetime.c` disposition=`quarantine` rank=`2` total_score=`69.94` risk=`HIGH`

...
- `src/tools/validators/security/trust/trust_verifier.py` disposition=`drop` rank=`85` total_score=`65.42` risk=`HIGH`
- `tools/validators/shell/supervisor_hardening_common.py` disposition=`merge` rank=`86` total_score=`64.8` risk=`HIGH`
- `src/tools/repo/meta/compute/compute_budget_engine.py` disposition=`drop` rank=`87` total_score=`64.34` risk=`HIGH`
...
- `src/tools/release/release_manifest_engine.py` disposition=`drop` rank=`91` total_score=`62.56` risk=`HIGH`
...
- `src/tools/validators/compatibility/shims/validation_shims.py` disposition=`drop` rank=`95` total_score=`59.44` risk=`HIGH`
- `src/tools/validators/stability/stability_validator.py` disposition=`drop` rank=`96` total_score=`59.4` risk=`HIGH`
...
- `src/contracts/abi/store/reachability_engine.py` disposition=`drop` rank=`107` total_score=`54.29` risk=`HIGH`
- `src/tools/release/update_resolver.py` disposition=`drop` rank=`108` total_score=`54.29` risk=`HIGH`
- `src/logic/timing/compute_hooks.py` disposition=`drop` rank=`109` total_score=`53.8` risk=`HIGH`
- `src/tools/repo/meta/reference/logic_small_reference.py` disposition=`drop` rank=`110` total_score=`53.55` risk=`HIGH`
- `src/tools/validators/compatibility/shims/flag_shims.py` disposition=`drop` rank=`111` total_score=`53.11` risk=`HIGH`
...
- `src/tools/validators/suite/validation_engine.py` disposition=`drop` rank=`114` total_score=`50.89` risk=`HIGH`
- `src/tools/validators/security/trust/license_capability.py` disposition=`drop` rank=`115` total_score=`49.77` risk=`HIGH`

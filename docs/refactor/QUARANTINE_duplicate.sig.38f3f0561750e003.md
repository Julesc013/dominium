...
# Quarantine Packet `duplicate.sig.38f3f0561750e003`

- Symbol: `DOWNGRADE_BUDGET`
- Cluster Kind: `exact`
...
- `src/tools/governance/negotiation/__init__.py` disposition=`quarantine` rank=`3` total_score=`70.3` risk=`HIGH`
- `src/tools/governance/fidelity/fidelity_engine.py` disposition=`merge` rank=`4` total_score=`58.62` risk=`HIGH`
- `src/tools/governance/negotiation/negotiation_kernel.py` disposition=`merge` rank=`5` total_score=`51.87` risk=`HIGH`

## Usage Sites

- Build Targets: `none`
- Docs: `docs/architecture/BUDGET_POLICY.md, docs/architecture/fidelity_policy.md, docs/audit/CONTROL_NEGOTIATION_BASELINE.md, docs/audit/CONTROL_PLANE_CONSTITUTION_BASELINE.md, docs/audit/CTRL10_RETRO_AUDIT.md, docs/audit/CTRL3_RETRO_AUDIT.md, docs/audit/CTRL5_RETRO_AUDIT.md, docs/audit/FIDELITY_ARBITRATION_BASELINE.md`

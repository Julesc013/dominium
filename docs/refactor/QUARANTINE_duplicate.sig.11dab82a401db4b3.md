...
- Build Targets: `none`
- Docs: `docs/runtime/shell/CLI_REFERENCE.md, docs/audit/MODULE_DUPLICATION_REPORT.md, docs/audit/REPO_TREE_INDEX.md, docs/audit/STABILITY_CLASSIFICATION_BASELINE.md, docs/contracts/refusal_contract.md, docs/domains/geology/WORLDGEN_CONSTITUTION.md, docs/meta/PROFILE_OVERRIDE_ARCHITECTURE.md, docs/release/PROVISIONAL_FEATURE_LIST.md`

...
- Risk Level: `HIGH`
- Canonical Candidate: `runtime/network/d_net_apply.h`
- Quarantine Reasons: `planned_quarantine`
- Planned Action Kinds: `quarantine`

## Competing Files

- `runtime/network/d_net_apply.c`
- `runtime/network/d_net_apply.h`

## Scorecard

- `runtime/network/d_net_apply.h` disposition=`canonical` rank=`1` total_score=`86.67` risk=`HIGH`
- `runtime/network/d_net_apply.c` disposition=`quarantine` rank=`2` total_score=`81.43` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.ed9e0cbcd25ae4b2`

- Symbol: `material_proxy_friction_permille`
- Cluster Kind: `exact`
...
- `src/worldgen/earth/material/material_proxy_engine.py` disposition=`merge` rank=`3` total_score=`47.14` risk=`HIGH`

## Usage Sites

- Build Targets: `none`
- Docs: `docs/audit/EARTH_MATERIAL_PROXY_BASELINE.md, docs/audit/auditx/FINDINGS.md, docs/release/PROVISIONAL_FEATURE_LIST.md`

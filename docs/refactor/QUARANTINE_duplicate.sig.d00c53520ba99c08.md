...
# Quarantine Packet `duplicate.sig.d00c53520ba99c08`

- Symbol: `normalize_arbitration_state_rows`
- Cluster Kind: `exact`
...
- `src/logic/eval/__init__.py` disposition=`quarantine` rank=`3` total_score=`69.52` risk=`HIGH`
- `src/logic/protocol/rows.py` disposition=`quarantine` rank=`4` total_score=`68.69` risk=`HIGH`
- `src/logic/eval/runtime_state.py` disposition=`merge` rank=`5` total_score=`57.49` risk=`HIGH`

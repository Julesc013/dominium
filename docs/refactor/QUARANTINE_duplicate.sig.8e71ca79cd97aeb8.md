...
# Quarantine Packet `duplicate.sig.8e71ca79cd97aeb8`

- Symbol: `normalize_position_ref`
- Cluster Kind: `exact`
...
- `src/geo/frame/frame_engine.py` disposition=`quarantine` rank=`2` total_score=`68.45` risk=`HIGH`

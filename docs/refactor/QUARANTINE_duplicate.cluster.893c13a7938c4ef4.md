...
- `src/tools/libraries/provides/__init__.py` disposition=`canonical` rank=`1` total_score=`64.17` risk=`HIGH`
- `src/tools/libraries/provides/provider_resolution.py` disposition=`quarantine` rank=`2` total_score=`54.72` risk=`HIGH`

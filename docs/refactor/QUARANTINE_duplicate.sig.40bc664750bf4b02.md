...
# Quarantine Packet `duplicate.sig.40bc664750bf4b02`
...
- `tools/release/release_index_policy_common.py` disposition=`quarantine` rank=`2` total_score=`85.83` risk=`HIGH`
- `tools/release/install_profile_common.py` disposition=`quarantine` rank=`3` total_score=`85.36` risk=`HIGH`
- `tools/release/arch_matrix_common.py` disposition=`quarantine` rank=`4` total_score=`84.76` risk=`HIGH`
- `tools/compat/migration_lifecycle_common.py` disposition=`quarantine` rank=`5` total_score=`84.64` risk=`HIGH`
- `tools/release/archive_policy_common.py` disposition=`quarantine` rank=`6` total_score=`84.64` risk=`HIGH`
- `tools/release/update_model_common.py` disposition=`quarantine` rank=`7` total_score=`84.64` risk=`HIGH`
- `tools/meta/observability_common.py` disposition=`quarantine` rank=`8` total_score=`84.29` risk=`HIGH`
...
- `tools/perf/performance_envelope_common.py` disposition=`merge` rank=`11` total_score=`76.01` risk=`HIGH`
- `tools/engine/concurrency_contract_common.py` disposition=`merge` rank=`12` total_score=`74.32` risk=`HIGH`
- `tools/engine/numeric_discipline_common.py` disposition=`merge` rank=`13` total_score=`68.94` risk=`HIGH`

...
# Quarantine Packet `duplicate.sig.8328f2f4b67f8fc1`

- Symbol: `geo_refine_cell_key`
- Cluster Kind: `exact`
...
- `src/geo/index/__init__.py` disposition=`quarantine` rank=`2` total_score=`57.01` risk=`HIGH`

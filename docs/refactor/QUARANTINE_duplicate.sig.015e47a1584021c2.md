...
# Quarantine Packet `duplicate.sig.015e47a1584021c2`

- Symbol: `REFUSAL_CTRL_ENTITLEMENT_MISSING`
- Cluster Kind: `exact`
...
- `src/tools/governance/negotiation/negotiation_kernel.py` disposition=`quarantine` rank=`3` total_score=`54.76` risk=`HIGH`

...
- `tools/distribution/profile_inspect.py` disposition=`canonical` rank=`1` total_score=`70.44` risk=`HIGH`
- `tools/distribution/compat_dry_run.py` disposition=`quarantine` rank=`2` total_score=`65.62` risk=`HIGH`

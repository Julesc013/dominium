...
- `tools/validators/domain/geology/geo10_stress_runtime.py` disposition=`merge` rank=`6` total_score=`67.27` risk=`HIGH`

## Usage Sites

- Build Targets: `none`
- Docs: `docs/apps/PRODUCT_BOUNDARIES.md, docs/architecture/CANON_INDEX.md, docs/architecture/REPORT_GAME_ARCH_DECISIONS.md, docs/audit/ARCH_AUDIT0_RETRO_AUDIT.md, docs/audit/CANON_MAP.md, docs/audit/CONVERGENCE_FINAL.md, docs/audit/DIST_TREE_ASSEMBLY_FINAL.md, docs/audit/DOC_INDEX.md`

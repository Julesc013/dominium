...
# Quarantine Packet `duplicate.cluster.d377814b66f72f86`
...
- `tools/xstack/testx/tests/test_no_spec_packs_null_boot_ok.py` disposition=`drop` rank=`3` total_score=`65.5` risk=`HIGH`

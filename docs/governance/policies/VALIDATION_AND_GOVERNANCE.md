...
1) Add a new check in `tools/validators/suite/validators_registry.cpp`.
2) Use a GOV-* rule ID from `docs/testing/ci/CI_ENFORCEMENT_MATRIX.md`.
3) Add a fixture under `tools/validators/suite/fixtures/`.

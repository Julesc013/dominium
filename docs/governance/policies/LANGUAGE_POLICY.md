...
behavioral requirements are specified in `docs/reference/specs/SPEC_DETERMINISM.md` and guarded
by `docs/governance/policies/DETERMINISM_REGRESSION_RULES.md`.

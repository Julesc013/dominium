...
### Game rules
- Game rules are versioned by feature epochs (see `docs/governance/policies/FEATURE_EPOCH_POLICY.md`).
...
- `docs/governance/policies/FEATURE_EPOCH_POLICY.md` (if sim-affecting)
- `docs/governance/policies/RENDER_BACKEND_LIFECYCLE.md` (if backend lifecycle changes)

...
| `src/appshell/supervisor/supervisor_engine.py` | `apps` | `apps.appshell.supervisor` | `tools` | `tools.xstack.auditx` | `appshell/supervisor/supervisor_engine.py` |
...
| `src/client/render/renderers/hw_renderer_gl.py` | `apps` | `runtime.render.client.renderers` | `tools` | `tools.xstack.registry_compile` | `client/render/renderers/hw_renderer_gl.py` |
| `src/client/render/representation_resolver.py` | `apps` | `runtime.render.client` | `tools` | `tools.xstack.registry_compile` | `client/render/representation_resolver.py` |
| `src/client/render/snapshot_capture.py` | `apps` | `runtime.render.client` | `tools` | `tools.ci` | `client/render/snapshot_capture.py` |
| `src/compat/__init__.py` | `compat` | `compat.compat` | `tools` | `tools.xstack.sessionx` | `compat/__init__.py` |
| `src/compat/capability_negotiation.py` | `compat` | `compat.compat` | `tools` | `tools.xstack.compatx.core` | `compat/capability_negotiation.py` |

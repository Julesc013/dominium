...
- agent/controller participation in the intent→delta pipeline (`docs/reference/specs/SPEC_ACTIONS.md`)
...
- deterministic LOD representation state (`dg_rep_state`; `docs/reference/specs/SPEC_LOD.md`)
...
- field samples/events/messages delivered at deterministic phase boundaries
  (`docs/reference/specs/SPEC_FIELDS_EVENTS.md`, `docs/reference/specs/SPEC_SIM_SCHEDULER.md`)
...
- Tie-break rules for agent outputs are explicit and stable (see
  `docs/reference/specs/SPEC_ACTIONS.md` for ordering keys).

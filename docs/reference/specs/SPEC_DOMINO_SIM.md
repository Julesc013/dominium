...
does not define the refactor SIM scheduler (`docs/reference/specs/SPEC_SIM_SCHEDULER.md`) or the
packet/delta commit contract (`docs/reference/specs/SPEC_ACTIONS.md`).
...
- Determinism note: `ticks` is authoritative; `sim_time_s` and `dt_s` are
  ...
  point quantities (see `docs/reference/specs/SPEC_DETERMINISM.md` and `docs/reference/specs/SPEC_NUMERIC.md`).

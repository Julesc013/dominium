...
- Cosmos anchors and edges are sourced from core data packs; see
  `docs/reference/specs/SPEC_CORE_DATA.md` and `docs/reference/specs/SPEC_COSMO_CORE_DATA.md`.
...
Travel is an in-sim state (see `docs/reference/specs/SPEC_LOGICAL_TRAVEL.md`):
...
- See `docs/reference/specs/SPEC_SYSTEM_LOGISTICS.md` for authoritative logistics rules.
...
- See `docs/reference/specs/SPEC_COSMO_ECONOMY_EVENTS.md` for authoritative rules.
...
- See `docs/reference/specs/SPEC_FACTIONS.md` and `docs/reference/specs/SPEC_AI_DETERMINISM.md`.

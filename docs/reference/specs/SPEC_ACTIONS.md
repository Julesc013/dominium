...
1. **Intent**
   ...
   - Immutable and TLV-versioned (`docs/reference/specs/SPEC_PACKETS.md`).
...
4. **Delta**
   ...
   - Applied at defined commit points in the scheduler (`docs/reference/specs/SPEC_SIM_SCHEDULER.md`).

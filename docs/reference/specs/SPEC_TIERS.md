...
- Tiers are negotiated via `PERF_CAPS` (see `docs/reference/specs/SPEC_CAPABILITIES.md`).
- Tiers are not part of identity digests; they are advisory and adjustable.
- SIM_CAPS are separate and pinned; see `docs/reference/specs/SPEC_CAPABILITIES.md`.

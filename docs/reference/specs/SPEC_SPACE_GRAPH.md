...
- Pathfinding beyond direct-edge lookup is not implemented in this pass; any future algorithm must be deterministic and obey canonical ordering rules (`docs/reference/specs/SPEC_GRAPH_TOOLKIT.md`).

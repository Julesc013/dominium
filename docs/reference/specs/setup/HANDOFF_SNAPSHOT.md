...
- Job DAG parallelism deferred (docs/apps/setup/FUTURE_BACKLOG.md)
- Signed manifest verification deferred (docs/apps/setup/FUTURE_BACKLOG.md)
- Stronger cryptographic digests deferred (docs/apps/setup/FUTURE_BACKLOG.md)
- MSIX/Flatpak/AppImage wrappers deferred (docs/apps/setup/FUTURE_BACKLOG.md)
- Advanced Steam verify/repair mapping deferred (docs/apps/setup/FUTURE_BACKLOG.md)

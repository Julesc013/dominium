...
It complements `docs/reference/specs/SPEC_DETERMINISM.md`, which defines the deterministic core
...
- D0 backends must avoid platform-dependent floating point, unordered iteration,
  and dependence on wall-clock time or OS state (see `docs/reference/specs/SPEC_DETERMINISM.md`).

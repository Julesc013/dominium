...
This aligns with `docs/reference/specs/SPEC_EVENT_DRIVEN_STEPPING.md` and the macro due
...
Determinism tests are listed in `docs/testing/ci/DETERMINISM_TEST_MATRIX.md`.

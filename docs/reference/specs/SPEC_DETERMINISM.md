...
- See `docs/reference/specs/SPEC_CAPABILITIES.md` for field definitions and hashing rules.
...
- Producers buffer events/messages/field-updates; delivery/application happens
  ...
  `docs/reference/specs/SPEC_FIELDS_EVENTS.md` and `docs/reference/specs/SPEC_SIM_SCHEDULER.md`).
...
MUST obey `docs/reference/specs/SPEC_GRAPH_TOOLKIT.md`:
...
The engine-wide LOD framework (see `docs/reference/specs/SPEC_LOD.md`) is part of deterministic
...
- LOD representations R1–R3 (see `docs/reference/specs/SPEC_LOD.md`)
- knowledge/visibility/comms state (see `docs/reference/specs/SPEC_KNOWLEDGE_VIS_COMMS.md`)
- compiled/expanded graph adjacency caches (see `docs/reference/specs/SPEC_GRAPH_TOOLKIT.md`)

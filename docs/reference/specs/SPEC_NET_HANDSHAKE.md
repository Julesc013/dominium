...
- `docs/reference/specs/SPEC_CONTAINER_TLV.md` (canonical TLV encoding rules)
- `docs/reference/specs/SPEC_NETCODE.md` (session model overview)
- `docs/reference/specs/SPEC_PACKETS.md` (deterministic packet taxonomy)

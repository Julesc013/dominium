...
- anchor-based positioning for corridor surfaces (see `docs/reference/specs/SPEC_POSE_AND_ANCHORS.md`)
...
`docs/reference/specs/SPEC_SIM_SCHEDULER.md` and `docs/reference/specs/SPEC_DETERMINISM.md`).

## Consumes
- BUILD placement/edit intents expressed as `(dg_anchor, dg_pose)` plus TLV
  parameters (see `docs/reference/specs/SPEC_PACKETS.md` and `docs/reference/specs/SPEC_POSE_AND_ANCHORS.md`)

...
Every install root contains `installed_state.dsustate` (see `docs/apps/setup/INSTALLED_STATE_SCHEMA.md`) that records install metadata, components, and platform intents.

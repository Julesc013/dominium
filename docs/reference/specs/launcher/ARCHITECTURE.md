...
`docs/reference/specs/core/CORE_LIBRARIES.md` (TLV, err_t, logging, jobs, caps/solver, audit,
...
(`docs/reference/specs/core/INSTALLED_STATE_CONTRACT.md`). The launcher parses the Setup state
...
- Selection visibility has a single source of truth: `selection_summary.tlv` (see `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`).
...
See `docs/apps/launcher/DIAGNOSTICS_AND_SUPPORT.md` and `docs/reference/specs/SPEC_LAUNCHER_CORE.md`.
...
See:
- `docs/apps/launcher/INSTANCE_MODEL.md`
- `docs/reference/specs/SPEC_CONTAINER_TLV.md`
- `docs/reference/specs/DATA_FORMATS.md`

## Related Documents

- `docs/apps/launcher/INSTALLED_STATE_CONTRACT.md`
- `docs/apps/launcher/INSTANCE_MODEL.md`
- `docs/apps/launcher/ARTIFACT_STORE.md`
- `docs/apps/launcher/PACK_SYSTEM.md`
- `docs/apps/launcher/UI_SYSTEM.md`
- `docs/apps/launcher/RECOVERY_AND_SAFE_MODE.md`
- `docs/apps/launcher/DIAGNOSTICS_AND_SUPPORT.md`
- `docs/apps/launcher/SECURITY_AND_TRUST.md`
- `docs/apps/launcher/BUILD_AND_PACKAGING.md`
- `docs/apps/launcher/CLI.md`
- `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`
- `docs/apps/launcher/TESTING.md`

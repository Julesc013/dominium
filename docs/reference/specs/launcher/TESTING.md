...
For the schema details of these files, see `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`.
...
Refusal codes are enumerated in `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`.

...
See `docs/reference/specs/SPEC_LAUNCHER_CORE.md`.
...
See `docs/apps/launcher/BUILD_AND_PACKAGING.md` for packaging determinism principles and `docs/apps/launcher/SECURITY_AND_TRUST.md` for trust considerations.

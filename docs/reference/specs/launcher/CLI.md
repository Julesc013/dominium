...
- on success: selection summary is printed as:
  ...
  - `selection_summary.*=<key/value lines>` (see `docs/apps/launcher/ECOSYSTEM_INTEGRATION.md`)
...
Bundle layout is specified in `docs/reference/specs/launcher/ARCHITECTURE.md`.

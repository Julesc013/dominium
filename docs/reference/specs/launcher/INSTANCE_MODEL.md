...
- `archive/generated/artifacts/` contains the shared content-addressed artifact store (see `docs/apps/launcher/ARTIFACT_STORE.md`).
...
The exact on-disk layout is defined by the instance layout spec: `docs/reference/specs/SPEC_INSTANCE_LAYOUT.md`.
...
Safe mode applies an overlay during launch planning without persisting changes unless explicitly confirmed. See `docs/apps/launcher/RECOVERY_AND_SAFE_MODE.md`.
...
See `docs/reference/specs/SPEC_LAUNCHER_PACKS.md` and `docs/apps/launcher/RECOVERY_AND_SAFE_MODE.md`.

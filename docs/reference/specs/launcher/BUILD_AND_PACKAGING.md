...
See `docs/development/guides/BUILDING.md` and `docs/testing/ci/BUILD_MATRIX.md` for full matrices.
...
See `docs/reference/specs/launcher/ARCHITECTURE.md` and `docs/reference/specs/CONTRACTS.md`.

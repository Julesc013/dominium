...
- **SIM scheduler (`dg_sched_*`)**: the refactor scheduler specified by
  `docs/reference/specs/SPEC_SIM_SCHEDULER.md` (phase-ordered, delta-commit based).
...
- DSIM code and all tick callbacks must obey `docs/reference/specs/SPEC_DETERMINISM.md`.
...
are specified in `docs/reference/specs/SPEC_SIM_SCHEDULER.md` and implemented under
...
- Any subsystem/module that participates in the refactor scheduler MUST obey
  ...
  `docs/reference/specs/SPEC_SIM_SCHEDULER.md` and `docs/reference/specs/SPEC_ACTIONS.md`.

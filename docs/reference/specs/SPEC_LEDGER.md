...
Out of scope:
- Currency formatting and standards (see `docs/reference/specs/SPEC_MONEY_STANDARDS.md`).
- Market clearing (see `docs/reference/specs/SPEC_MARKETS.md`).
- Instrument templates (see `docs/reference/specs/SPEC_ASSETS_INSTRUMENTS.md`).
...
- Balances and statements are InfoRecords for UI (see `docs/reference/specs/SPEC_INFORMATION_MODEL.md`).

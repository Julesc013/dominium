...
`docs/reference/specs/SPEC_COSMO_LANE.md` and `docs/reference/specs/SPEC_LOGICAL_TRAVEL.md`.
...
QoS negotiation is optional and non-sim; see `docs/reference/specs/SPEC_QOS_ASSISTANCE.md`.

...
policy. Resolution order is defined in `docs/reference/specs/SPEC_STANDARD_RESOLUTION.md`.
...
- calendars and time standards (see `docs/reference/specs/SPEC_CALENDARS.md`)
- currencies and economy (see `docs/reference/specs/SPEC_ECONOMY.md`)
- unit systems (see `docs/reference/specs/SPEC_NUMERIC.md` for canonical storage constraints)
- legal and governance standards (future specs)
- comms and identity naming (see `docs/reference/specs/SPEC_KNOWLEDGE.md`)

...
- Event-driven stepping: `docs/reference/specs/SPEC_EVENT_DRIVEN_STEPPING.md`
- Interest sets: `docs/reference/specs/SPEC_INTEREST_SETS.md`
- Fidelity projection: `docs/reference/specs/SPEC_FIDELITY_PROJECTION.md`
- Provenance: `docs/reference/specs/SPEC_PROVENANCE.md`
- Communication model: `docs/reference/specs/SPEC_COMMUNICATION.md`
- Command intent: `docs/reference/specs/SPEC_COMMAND_MODEL.md`
- Time warp: `docs/reference/specs/SPEC_TIME_WARP.md`

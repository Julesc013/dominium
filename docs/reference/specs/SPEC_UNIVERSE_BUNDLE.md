...
Logistics chunk formats are defined in `docs/reference/specs/SPEC_SYSTEM_LOGISTICS.md`.

## 2.1 COSM chunk (cosmos graph container)
The `COSM` chunk payload is a DTLV container (see `docs/reference/specs/SPEC_CONTAINER_TLV.md`)
...
- Migration policy is defined in `docs/reference/specs/SPEC_MIGRATIONS.md`.
...
- `docs/reference/specs/SPEC_LAUNCH_HANDSHAKE_GAME.md`

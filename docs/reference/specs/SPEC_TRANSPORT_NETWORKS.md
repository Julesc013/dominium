...
transform/topology system (`docs/reference/specs/SPEC_TRANS.md`).
...
subsystems (`docs/reference/specs/SPEC_DETERMINISM.md`).
...
- Any future routing/pathfinding MUST obey canonical ordering rules from
  `docs/reference/specs/SPEC_GRAPH_TOOLKIT.md` (no unordered traversal; explicit tie-breaks).

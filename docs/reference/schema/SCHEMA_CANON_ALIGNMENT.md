...
This document is the canonical alignment summary for schema versioning and
migration mechanics as implemented in the repository. It mirrors the BR-0
alignment note under `docs/archive/audit/SCHEMA_CANON_ALIGNMENT.md`.

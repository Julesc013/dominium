...
| launcher_python_appshell | python tools/launcher/launch.py | python_cli | canonical | yes | Python, repo root, archive/generated/dist/manifests/release_manifest.json | Best launcher surface for repo-local audit and likely baseline assembly. |
| setup_python_appshell | python tools/setup/setup_cli.py | python_cli | canonical | yes | Python, repo root, archive/generated/dist/manifests/release_manifest.json | This is the strongest live setup surface in the repo today. |
...
| validation_python | python tools/validators/suite/tool_run_validation.py | python_cli | canonical | yes | Python, repo root | Exists and is wired, but audit did not finish a full FAST run. |
...
Canonical today for repo-local work: `cmake --preset verify`, verify binaries, `tools/launcher/launch.py`, `tools/setup/setup_cli.py`, `tools/xstack/session_create.py`, `tools/xstack/testx_all.py`, `tools/validators/suite/tool_run_validation.py`.

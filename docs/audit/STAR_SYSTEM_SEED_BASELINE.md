...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/specs/SPEC_MVP0_SCOPE_CONSTITUTION.md`, `docs/domains/worldgen/MILKY_WAY_CONSTITUTION.md`, `docs/domains/worldgen/STAR_SYSTEM_SEED_MODEL.md`, `schema/worldgen/star_system_seed.schema`, `schema/worldgen/star_system_artifact.schema`, and `src/geo/worldgen/worldgen_engine.py`.

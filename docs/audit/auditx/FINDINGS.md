...
- `E317_COMMIT_PHASE_BYPASS_SMELL:0001` VIOLATION `E317_COMMIT_PHASE_BYPASS_SMELL` `logic.commit_phase_bypass_smell` (src/logic/eval/compute_engine.py)
  - non-COMMIT logic phase contains state mutation token
  - serialize_state(

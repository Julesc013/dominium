...
- `E105_LEGACY_REFERENCE_SMELL:0001` RISK `E105_LEGACY_REFERENCE_SMELL` `architecture.legacy_reference_smell` (src/validation/validation_engine.py)
  - "- Total legacy/significant validation surfaces: `{}`".format(int(surface_inventory.get("surface_count", 0) or 0)),
  - legacy quarantine reference detected in production/runtime code

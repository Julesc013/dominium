...
- architecture.inline_phase_change_smell: 13
...
- architecture.silent_corruption_smell: 4
- architecture.silent_degrade_smell: 10
- architecture.silent_downgrade_smell: 3
- architecture.silent_therm_degrade_smell: 6
...
- architecture.undeclared_schema_smell: 2

...
- `tools/xstack/performx/performx.py` -> exists=`yes`
- `tools/setup/setup_cli.py` -> exists=`yes`
- `tools/release/dist/tool_assemble_dist_tree.py` -> exists=`yes`
- `tools/release/dist/tool_verify_distribution.py` -> exists=`yes`
- `tools/release/dist/tool_run_clean_room.py` -> exists=`yes`
- `tools/release/dist/tool_run_platform_matrix.py` -> exists=`yes`
- `tools/release/dist/tool_run_version_interop.py` -> exists=`yes`
...
- `archive/generated/artifacts/toolchain_runs/winnt-msvc-x86_64-vs2026/run.5ea8970d1739f5c2/run_manifest.json` -> exists=`yes`
- `archive/generated/artifacts/toolchain_runs/winnt-msvc-x86_64-vs2026/run.5ea8970d1739f5c2/hashes.json` -> exists=`yes`

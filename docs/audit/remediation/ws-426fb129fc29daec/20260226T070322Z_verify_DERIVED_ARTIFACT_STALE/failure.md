...
INV-CANON-INDEX: canonical doc not listed in CANON_INDEX: docs/domains/worldgen/REAL_DATA_IMPORT_PIPELINE.md
INV-CANON-INDEX: canonical doc not listed in CANON_INDEX: docs/domains/worldgen/WORLDGEN_CONSTRAINTS.md
...
INV-DOC-STATUS-HEADER: missing status header: docs/development/DEVELOPER_ACCELERATION_MODEL.md
INV-DOC-STATUS-HEADER: missing status header: docs/development/IMPACT_GRAPH.md
...
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/ANTI_CHEAT_ENFORCEMENT_ACTIONS.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/ANTI_CHEAT_MODULES.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/ANTI_CHEAT_POLICY_FRAMEWORK.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/DIEGETIC_CHANNELS_OVER_NETWORK.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/EPISTEMICS_OVER_NETWORK.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/EPISTEMIC_SCOPE_AND_FOG_OF_WAR.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/ESPORTS_PROOF_ARTIFACTS.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/HANDSHAKE_AND_COMPATIBILITY.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/MULTIPLAYER_MODEL_OVERVIEW.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/RANKED_SERVER_GOVERNANCE.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/REPLICATION_POLICIES.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/SERVER_AUTHORITATIVE_POLICY.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/SRZ_HYBRID_POLICY.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/network/TRANSPORT_ABSTRACTION.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/render/PROCEDURAL_RENDERING_DEFAULTS.md
INV-DOC-STATUS-HEADER: missing status header: docs/runtime/render/RENDERMODEL_CONTRACT.md
...
INV-TOOL-VERSION-MISMATCH: hash mismatch for tools/xstack/auditx/auditx.py (expected 4350ab3a056da7ae0b6b3d86166d5bb165d76ed8e40372e7447835f6a789407e, got 144b6dc8f67d81350e2cf88020af5341a623aa3cda17471dfa3afd2ef474930b)
INV-TOOL-VERSION-MISMATCH: hash mismatch for tools/xstack/compatx/compatx.py (expected 09c1dde3b93df65ba1df0fba2f184fbd80fe64e57e9bd9f7a68c980774659af1, got 7ce9387818e8070df8528015faacd1d36dadff9f52fbae0e99a687257a01c0d6)
INV-TOOL-VERSION-MISMATCH: hash mismatch for tools/xstack/controlx/controlx.py (expected 97e4890766339d131cfee5694b5429f368d9402a783c1c5621e6339d59a6aeb7, got 665d5d8f7359cd325e2dffe000945ba055af5816f6acc97c61d44341b67fe325)
INV-TOOL-VERSION-MISMATCH: hash mismatch for tools/xstack/securex/securex.py (expected 1c03332e38e70d462251be1db83e11f4ae7e4482f50484280347d5d075ee4da2, got e289f3f39a3f736785fad954153cbf70188ef4236684be3e4a046009e1fc93b7)
```

...
| `engine` | `engine` | `tools/validators/shell/product_stub_cli.py` | `yes` | `yes` | `no` | `no` |
| `game` | `game` | `tools/validators/shell/product_stub_cli.py` | `yes` | `yes` | `no` | `no` |
...
| `tool.attach_console_stub` | `tool_attach_console_stub` | `tools/validators/shell/product_stub_cli.py` | `yes` | `yes` | `yes` | `no` |

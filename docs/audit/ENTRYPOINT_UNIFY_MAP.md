...
| `engine` | `engine` | `tools/validators/shell/product_stub_cli.py` | `return appshell_main(` | `AppShell -> stub dispatch` | `AppShell stub mode only` | `none` | `src/appshell/bootstrap.py::AppShellIPCEndpointServer` | `mode_select -> descriptor_emit -> negotiation_preflight -> stub_dispatch` | `compliant` |
| `game` | `game` | `tools/validators/shell/product_stub_cli.py` | `return appshell_main(` | `AppShell -> stub dispatch` | `AppShell stub mode only` | `none` | `src/appshell/bootstrap.py::AppShellIPCEndpointServer` | `mode_select -> descriptor_emit -> negotiation_preflight -> stub_dispatch` | `compliant` |
...
| `tool.attach_console_stub` | `tool_attach_console_stub` | `tools/validators/shell/product_stub_cli.py` | `return appshell_main(` | `AppShell -> stub dispatch` | `AppShell stub mode only` | `none` | `src/appshell/bootstrap.py::AppShellIPCEndpointServer` | `mode_select -> descriptor_emit -> negotiation_preflight -> stub_dispatch` | `compliant` |

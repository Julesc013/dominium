...
| Unified validation | python tools/validators/suite/tool_run_validation.py | verified | likely | likely | Help works and validator sources exist. | FAST run attempt timed out, so audit cannot mark the lane green. |

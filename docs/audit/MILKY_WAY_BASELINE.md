...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/specs/SPEC_MVP0_SCOPE_CONSTITUTION.md`, `docs/domains/worldgen/MILKY_WAY_CONSTITUTION.md`, `schema/worldgen/galaxy_priors.schema`, and `src/geo/worldgen/worldgen_engine.py`.

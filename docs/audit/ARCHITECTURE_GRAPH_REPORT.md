...
- `ARTIFACT_KIND_PACK` -> tools/release/release_manifest_engine.py, security/trust/__init__.py
...
- `AnalysisGraph` -> tools/xstack/auditx/graph/__init__.py, tools/xstack/auditx/graph/analysis_graph.py

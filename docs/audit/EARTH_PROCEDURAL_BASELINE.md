...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/specs/SPEC_MVP0_SCOPE_CONSTITUTION.md`, `docs/domains/worldgen/PLANET_SURFACE_MACRO_MODEL.md`, `docs/domains/worldgen/EARTH_PROCEDURAL_CONSTITUTION.md`, `schema/worldgen/earth_surface_params.schema`, `data/registries/earth_surface_params_registry.json`, `src/worldgen/earth/earth_surface_generator.py`, `tools/worldgen/earth0_probe.py`, and `tools/worldgen/tool_verify_earth_surface.py`.

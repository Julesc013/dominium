...
- Documentation under docs/arch and docs/specs remains unarchived and contains
...
Status: FAIL
Evidence:
- Legacy architecture/spec files remain unarchived under `docs/arch` and
  `docs/specs`, and include path-based package guidance
  (`docs/specs/SPEC_PACKAGES.md`).
- Canonical architecture docs exist under `docs/architecture/`, but the
...
- Update coredata tooling to preserve unknown fields/tags and support forward
  compatibility.
- Archive or mark legacy docs under `docs/arch` and `docs/specs` per PROMPT 0.

...
Machine-readable surfaces such as `release/updates/changelog.json`, release manifests, release indices, yanks, and later operator transaction records carry structured change state for tools and automation.

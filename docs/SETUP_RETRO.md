...
## DOS (16/32-bit)
- Installer: `source/dominium/products/setup/os/dos/setup_dos_tui.c`
  (text UI).
...
## Win16
- Stub: `source/dominium/products/setup/os/win16/setup_win16_tui.c`.
...
## CP/M-80 / CP/M-86
- Stubs: `source/dominium/products/setup/os/cpm/setup_cpm80.c`,
  `setup_cpm86.c`.
...
## Carbon OS (Z80)
- Stub: `source/dominium/products/setup/os/carbon/setup_carbon.c`.

...
targets are routed into `archive/generated/dist/` via `dist_set_role`. Default build outputs
remain under the build directory; dist routing is opt-in.

Goals:
- one unified output root: `archive/generated/dist/`
...
`archive/generated/dist/` for targets that call `dist_set_role`. Targets that do not call
...
Symbols (MSVC PDB) go under `archive/generated/dist/sym/<os>/<arch>/...` mirroring the runtime
layout.
...
This produces:
```
archive/generated/dist/sys/<os>/<arch>/<variant>/
archive/generated/dist/sym/<os>/<arch>/<variant>/
```

Only enable a variant when you must keep toolchains in the same `archive/generated/dist/` root.

## Metadata Outputs

Generated by the `dist_meta` target:
- `archive/generated/dist/meta/dist.json` (schema + build info)
- `archive/generated/dist/meta/targets.json` (active build tuple)
- `archive/generated/dist/meta/files.json` (path + size + sha256)
- `archive/generated/dist/meta/hash.txt` (sha256 lines)
- `archive/generated/dist/meta/build.txt` (toolchain, generator, config)
- `archive/generated/dist/meta/ver.txt` (project version)
- `archive/generated/dist/meta/rules.txt` (layout/naming rules)
...
- max depth (<= 16 from `archive/generated/dist/`)
- required meta files

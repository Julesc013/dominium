...
## Where to start
- `docs/architecture/MENTAL_MODEL.md` (canonical framing)
- `docs/architecture/INVARIANTS.md` (non-negotiable rules)
- `docs/architecture/TERMINOLOGY.md` (canonical terms and aliases)
- `docs/architecture/COMPATIBILITY_PHILOSOPHY.md` (saves/mods/packs)
- `docs/architecture/NON_GOALS.md` (explicit non-goals)
- `docs/arch/WHAT_THIS_IS.md` and `docs/arch/WHAT_THIS_IS_NOT.md` (binding canon)

## Structure
- `docs/arch/` binding architecture canon and laws
...
## Archival notes
Historical and audit documents are moved to `docs/archive/` with headers that

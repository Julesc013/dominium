...
- HVAC hooks: `dzone_add_gas(zone, substance, mass_delta_kg, energy_delta_J)` and `dzone_add_heat(zone, energy_delta_J)` let life support/machines inject or remove mass/heat. Behavior is deterministic, integer-only; full thermodynamics are TODO.

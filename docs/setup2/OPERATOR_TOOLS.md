# Setup2 Operator Tools

## Commands
- `dominium-setup2 doctor --state <file> --plan <file> --journal <file> --txn-journal <file> --audit <file> [--json]`
- `dominium-setup2 explain-refusal --audit <file> [--json]`
- `dominium-setup2 audit dump --in <file> --out <file> --format json`

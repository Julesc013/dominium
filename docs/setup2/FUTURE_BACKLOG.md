# Setup2 Deferred / Non-Binding Backlog

This backlog is Deferred / Non-Binding. It documents ideas only and makes no
promises. Setup2 is complete without these items.
...
- Description: add an MSIX package wrapper that launches Setup2 for installation.
...
- Description: provide Linux distribution wrappers that call Setup2 for planning
...
- Description: map Setup2 verify/repair to Steam depots and validation routines.

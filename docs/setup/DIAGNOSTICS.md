...
## Setup2 CLI logging
`dominium-setup2` supports optional structured log output for kernel runs:
- `dominium-setup2 run ... --out-log <file>` writes `core_log` TLV events for each kernel stage.

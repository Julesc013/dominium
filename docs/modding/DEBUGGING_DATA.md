...
```bash
python tools/domain/fabrication/fab_validate.py --input content/packs/core/org.dominium.core.parts.basic/data/fab_pack.json --format json
```
...
```bash
python tools/package/pack/capability_inspect.py --pack-id org.dominium.core.ecology.basic --pack-id org.dominium.core.population.basic --format json
```

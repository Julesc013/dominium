...
- `docs/app/COMMAND_GRAPH_CAMERA_AND_BLUEPRINT.md` - canonical camera and blueprint commands.
...
- `docs/ui/FREECAM_MODES.md` - camera mode rules and refusal codes.
- `docs/ui/RENDERING_EPISTEMICS.md` - observation/memory render contract.

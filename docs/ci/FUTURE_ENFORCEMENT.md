...
## Invariants
- Invariants cannot change without review and canon updates.
- Unknown data never triggers silent fallback.
- Mod policy is enforced at load/admission time.
...
- Mod conflicts can be ignored by fallback.
- Invariant changes can be merged without review.

...
Binding Sources: `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `AGENTS.md`, `docs/reference/specs/reality/SPEC_CROSS_DOMAIN_BRIDGES.md`, `docs/reference/specs/reality/SPEC_DOMAIN_CONTRACT_TEMPLATE.md`, `contracts/abi/reality/SPEC_CAPABILITY_SURFACES.md`, `docs/reference/specs/reality/SPEC_FORMALIZATION_CHAIN.md`, `docs/planning/SEMANTIC_OWNERSHIP_REVIEW.md`, `docs/planning/UNIVERSAL_DOMAIN_CONSTITUTION_TEMPLATE.md`

...
- `docs/archive/blueprint/FOUNDATION_READINESS_MATRIX.md` still marks `Distributed shard relocation` as `unrealistic_currently`, which remains correct for `Ζ` live operations even if `Φ-B5` is now ready to define foundations

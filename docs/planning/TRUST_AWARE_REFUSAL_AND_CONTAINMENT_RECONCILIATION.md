...
- `contracts/registry/trust_root_registry.json` still has an empty trust-root set
- `contracts/registry/trust_policy_registry.json` still marks trust posture as provisional

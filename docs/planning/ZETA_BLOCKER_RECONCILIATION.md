...
- Evidence surfaces: `contracts/registry/net_replication_policy_registry.json`, `server/net/dom_server_runtime.h`, `server/net/dom_server_runtime.cpp`
...
- Evidence surfaces: `server/net/dom_server_runtime.cpp` transfer checkpoints, lifecycle and checkpoint policy surfaces, `docs/archive/blueprint/STOP_CONDITIONS_AND_ESCALATION.md`
...
- Evidence surfaces: `contracts/registry/trust_policy_registry.json`, `contracts/registry/trust_root_registry.json`, `tools/validators/security/trust/trust_verifier.py`
...
- Evidence surfaces: `contracts/registry/trust_root_registry.json` is empty, `contracts/registry/trust_policy_registry.json` remains provisional, `tools/release/update_resolver.py`, `tools/validators/security/trust/trust_verifier.py`
...
- Evidence surfaces: `contracts/registry/provenance_classification_registry.json`, `tools/release/update_resolver.py`

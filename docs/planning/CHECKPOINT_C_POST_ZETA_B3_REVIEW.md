...
- `contracts/registry/trust_root_registry.json` still exposes an empty trust-root posture
- `contracts/registry/trust_policy_registry.json` and `contracts/registry/net_replication_policy_registry.json` still remain provisional rather than closed realization proof

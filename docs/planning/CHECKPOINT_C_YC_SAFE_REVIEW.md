...
- `tools/validators/security/trust/trust_verifier.py` and `release/update_resolver.py` prove local trust-bearing control-plane handling exists, but not distributed trust convergence or distributed revocation choreography

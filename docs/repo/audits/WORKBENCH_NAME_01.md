...
- `docs/archive/audit/**`, `docs/testing/ci/HYGIENE_QUEUE.md`, and old refactor/change history retain stale historical paths and were not rewritten by this task.
...
- Generated side effects from validators/build/test runs were restored and not committed: `tools/migration/root_inventory.json`, `tools/migration/root_move_map.json`, and generated `docs/archive/audit/**` proof outputs.

## Remaining Follow-Up Work

- Historical `.aide/**` and docs/archive/audit snapshots should be regenerated by their owning tools when those generated-current maps are next refreshed.

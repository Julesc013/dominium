...
- `docs/archive/restructure/FUTURE_LAYOUT_PROPOSAL.md` is marked canonical but is planning-only and proposes a future `/src` structure rather than describing current layout.

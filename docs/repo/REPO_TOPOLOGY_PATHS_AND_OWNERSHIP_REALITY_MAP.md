...
- Derived or generated output roots:
  `build/`, `archive/generated/dist/`, `out/`, `.xstack_cache/`, `archive/generated/artifacts/`, `run_meta/`, `tmp/`, `saves/`
...
- `docs/planning/`, `docs/archive/audit/`, `docs/repo/`, `docs/development/xstack/`, `specs/reality/`, `data/planning/`, `data/audit/`, and `data/xstack/` are the doctrine and evidence cluster that later design prompts must consume instead of rediscovering.
...
- `run_meta/`
- large parts of `archive/generated/dist/` once assembled
- `data/audit/`
- many generated report leaves under `docs/archive/audit/`
...
- Evidence notes:
  `docs/archive/audit/ULTRA_REPO_AUDIT_SYSTEM_INVENTORY.md`, `CMakePresets.json`
...
- Major dependencies or path couplings:
  `contracts/registry/command_registry.json`, `contracts/registry/tui_panel_registry.json`, `contracts/registry/virtual_root_registry.json`, `archive/generated/dist/`, `packs/`, `profiles/`, `locks/`, `saves/`, `runtime/`
- Evidence notes:
  `appshell/command_registry.py`, `appshell/paths/virtual_paths.py`, `contracts/registry/virtual_root_registry.json`
...
- Evidence notes:
  `client/CMakeLists.txt`, `client/local_server/local_server_controller.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_WIRING_MAP.md`
...
- Evidence notes:
  `client/local_server/local_server_controller.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_PRODUCT_ASSEMBLY_PLAN.md`
...
- Evidence notes:
  `launcher/CMakeLists.txt`, `docs/archive/audit/ULTRA_REPO_AUDIT_ENTRYPOINTS_AND_RUNPATHS.md`, `docs/archive/audit/ULTRA_REPO_AUDIT_REUSE_AND_CONSOLIDATION_PLAN.md`
...
- Evidence notes:
  `setup/CMakeLists.txt`, `docs/archive/audit/ULTRA_REPO_AUDIT_ENTRYPOINTS_AND_RUNPATHS.md`
...
- Major dependencies or path couplings:
  `manifests/release_manifest.json`, `manifests/release_index.json`, `contracts/registry/component_graph_registry.json`, `contracts/registry/install_profile_registry.json`, `store/profiles/`, `store/locks/`, `archive/generated/dist/`
- Evidence notes:
  `tools/release/release_manifest_engine.py`, `tools/release/component_graph_resolver.py`, `tools/release/update_resolver.py`
...
- Major dependencies or path couplings:
  `contracts/registry/trust_policy_registry.json`, `contracts/registry/trust_root_registry.json`, `manifests/trust_root_registry.local.json`
- Evidence notes:
...
- Evidence notes:
  `runtime/process_spawn.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_WIRING_MAP.md`
...
- Evidence notes:
  `tools/validators/network/policies/policy_server_authoritative.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_WIRING_MAP.md`
...
- What it appears not to own:
  the CLI wrapper, which lives in `tools/validators/suite/`, or repo doctrine
- Product-critical now:
  yes
- Baseline-critical now:
  yes
...
- Major dependencies or path couplings:
  `contracts/registry/validation_suite_registry.json`, `docs/archive/audit/VALIDATION_INVENTORY.md`, `docs/archive/audit/VALIDATION_REPORT_<PROFILE>.md`, `data/audit/validation_report_<PROFILE>.json`, `docs/archive/audit/VALIDATION_UNIFY_FINAL.md`
- Evidence notes:
  `tools/validators/suite/validation_engine.py`, `tools/validators/suite/tool_run_validation.py`
...
- Evidence notes:
  `tools/CMakeLists.txt`, `docs/archive/audit/ULTRA_REPO_AUDIT_SYSTEM_INVENTORY.md`
...
- Major dependencies or path couplings:
  virtual-root pack discovery, pack compatibility validation, session materialization inputs, archive/generated/dist/store pack resolution
- Evidence notes:
  `content/packs/README.md`, `appshell/paths/virtual_paths.py`, `AGENTS.md`
...
- Major dependencies or path couplings:
  `appshell/command_registry.py`, `appshell/paths/virtual_paths.py`, `tools/release/component_graph_resolver.py`, `tools/validators/security/trust/trust_verifier.py`, `tools/validators/suite/validation_engine.py`
- Evidence notes:
  `contracts/registry/virtual_root_registry.json`, `contracts/registry/bundle_profiles.json`, `contracts/registry/session_defaults.json`
...
- Evidence notes:
  `schemas/README.md`, `AGENTS.md`, `tools/validators/suite/validation_engine.py`
...
- Major dependencies or path couplings:
  `docs/planning/`, `docs/archive/audit/`, `docs/repo/`, `docs/development/xstack/`, `specs/reality/`
- Evidence notes:
  `docs/planning/AUTHORITY_ORDER.md`, `docs/repo/REPO_NON_NEGOTIABLES_AND_CURRENT_REALITY.md`, `docs/development/xstack/CODEX_REPO_OPERATING_CONTRACT.md`
...
- Major dependencies or path couplings:
  `contracts/repo/release_policy.toml`, `contracts/repo/canon_state.json`, `CMakePresets.json`
- Evidence notes:
  `contracts/repo/release_policy.toml`, `CMakePresets.json`, `AGENTS.md`
...
- Root/path:
  `build/`, `out/`, `.xstack_cache/`, `archive/generated/artifacts/`, `run_meta/`, `tmp/`
- Actual purpose:
...
- `PATH-009 - authored_mvp_asset_locations`
  The authored baseline asset trio is physically located at `content/profiles/bundles/bundle.mvp_default.json`, `contracts/package/locks/pack_lock.mvp_default.json`, and `content/templates/session/session.mvp_default.json`.
  Baseline-critical: yes.

- `PATH-010 - registry_vs_authored_bundle_seam`
  The authored baseline asset trio coexists with registry-driven defaults in `contracts/registry/bundle_profiles.json` and a SessionX default bundle id of `bundle.base.lab` from `tools/xstack/registry_compile/constants.py`.
...
- `PATH-012 - virtual_root_registry_defaults`
  `appshell/paths/virtual_paths.py` and `contracts/registry/virtual_root_registry.json` encode default search locations for `packs`, `profiles`, `locks`, `saves`, `runtime`, and store/install-style fallbacks.
  Baseline-critical: yes.

### Manifest, Store, And Dist Assumptions

- `PATH-013 - dist_release_manifest_contract`
  The repo-local launcher/setup shells and release logic expect release manifests at `manifests/release_manifest.json`, with the repo-local install/discovery path commonly resolving via `archive/generated/dist/manifests/release_manifest.json`.
  Baseline-critical: yes.

- `PATH-014 - store_projection_contract`
  Release/update logic also expects installed or projected payloads such as `store/content/profiles/bundles/bundle.mvp_default.json` and `store/contracts/package/locks/pack_lock.mvp_default.json`.
...
- Baseline-critical now:
  yes
- Evidence notes:
  `CMakePresets.json`, `docs/archive/audit/ULTRA_REPO_AUDIT_BUILD_RUN_TEST_MATRIX.md`
...
- Depends on:
  `tools/validators/suite/`, `validation/`, `contracts/registry/validation_suite_registry.json`, `docs/archive/audit/`, `data/audit/`
- Critical path contracts:
  `PATH-001`, `PATH-012`
- Baseline-critical now:
  yes
- Evidence notes:
  `tools/validators/suite/tool_run_validation.py`, `tools/validators/suite/validation_engine.py`
...
- Baseline-critical now:
  yes
- Evidence notes:
  `tools/xstack/testx_all.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_BUILD_RUN_TEST_MATRIX.md`
...
- Baseline-critical now:
  transitional only
- Evidence notes:
  `tools/release/mvp/runtime_entry.py`, `tools/release/mvp/runtime_bundle.py`, `docs/archive/audit/ULTRA_REPO_AUDIT_PLAYTEST_READINESS.md`
...
| `docs/archive/audit/` | human-readable audit evidence | mixed evidence root | high-value evidence, but not implementation truth when code differs |
| `data/audit/` | machine-readable audit evidence | derived report-only root | mirrors reports and evidence payloads |
| `docs/development/xstack/` | xstack closure and retained/deferred contracts | canonical bounded-domain packet for this series | XStack/AIDE closure is frozen and constraining |
| `data/xstack/` | xstack mirrors | derived mirror with intact provenance | machine-readable consumption only |
| `archive/generated/dist/` | assembled distribution tree | generated but operationally important | launcher/setup/appshell discover it, but it is not authored canon |
...
- `archive/generated/dist/` is generated, but it is still on the operational path for launcher/setup discovery. Later prompts must not treat generated roots as irrelevant just because they are non-canonical.
...
- `archive/generated/dist/` is derived but operationally consumed
...
- ignoring generated intermediates like `build/registries/`, `build/lockfile.json`, or `archive/generated/dist/` because they are non-canonical, even though live flows still depend on them

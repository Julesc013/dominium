...
| `RR-006` | stale `src/...` mirrors plus `tools/migration/import_bridge.py` still coexist | Drift is real and is exactly why the first slice exists, but bridge retirement remains later work. | This is the main risk addressed by `RMS-001`. |

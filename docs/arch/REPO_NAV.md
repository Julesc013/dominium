...
- Where do I add docs? Add them under `docs/` (usually `docs/arch/`).
...
| policies, constitutions, and architectural contracts | `docs/arch/` |
...
## See also
- `docs/arch/CODE_DATA_BOUNDARY.md`
- `docs/arch/EXTEND_VS_CREATE.md`

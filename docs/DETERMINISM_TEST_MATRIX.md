...
- CIV2 Governance scenario (jurisdictions/legitimacy/policies)
...
- CIV5 War Security Forces scenario (mobilization/readiness/morale)
  - Data packs: core/time, core/civ (population/logistics), core/governance (legitimacy/enforcement)
- CIV5 War Engagements scenario (engagement resolution/casualties)
  - Data packs: core/time, core/life (death/remains), core/civ (logistics), core/governance (legitimacy)
- CIV5 War Occupation scenario (occupation/resistance/disruptions)

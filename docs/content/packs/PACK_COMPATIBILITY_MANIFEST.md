...
Supersedes: none
Superseded By: none
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/reference/contracts/SEMANTIC_CONTRACT_MODEL.md`, `docs/governance/meta/UNIVERSE_CONTRACT_BUNDLE.md`, `docs/modding/MOD_TRUST_AND_CAPABILITIES.md`, and `docs/domains/geology/OVERLAY_CONFLICT_POLICIES.md`

...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/content/packs/PACK_COMPATIBILITY_MANIFEST.md`, `docs/reference/contracts/SEMANTIC_CONTRACT_MODEL.md`, and `docs/modding/MOD_TRUST_AND_CAPABILITIES.md`.

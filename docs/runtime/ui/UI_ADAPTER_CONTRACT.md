...
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/runtime/shell/UI_MODE_RESOLUTION.md`, `docs/runtime/shell/COMMANDS_AND_REFUSALS.md`, and `docs/release/FROZEN_INVARIANTS_v0_0_0.md`.

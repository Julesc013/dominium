...
| `dom compat generate-descriptor-manifest` | Generate deterministic offline descriptor manifest from archive/generated/dist/bin wrappers | `refusal.io.invalid_args` |
...
- `dom compat generate-descriptor-manifest`: Generate deterministic offline descriptor manifest from archive/generated/dist/bin wrappers

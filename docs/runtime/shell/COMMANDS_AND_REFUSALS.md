...
Superseded By: none
Version: 1.0.0
Compatibility: Bound to `docs/canon/constitution_v1.md`, `docs/canon/glossary_v1.md`, `docs/runtime/shell/APPSHELL_CONSTITUTION.md`, `docs/contracts/CAPABILITY_NEGOTIATION_CONSTITUTION.md`, and `docs/packs/PACK_VERIFICATION_PIPELINE.md`.

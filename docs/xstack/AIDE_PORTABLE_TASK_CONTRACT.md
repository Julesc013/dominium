...
- `tools/validators/validation/validation_engine.py` maps live and legacy validation surfaces, replacement targets, evidence outputs, and status classes. That is the repo-grounded reason to require evidence obligations, compatibility notes, and review-aware failure reporting.

...
`docs/architecture/DIRECTORY_CONTEXT.md` is the authoritative directory/layout contract.

## Mandatory constraints
- Architecture constitution: `docs/architecture/ARCH0_CONSTITUTION.md`,
  `docs/architecture/CHANGE_PROTOCOL.md`, `docs/architecture/GLOSSARY.md`
- Canonical system map and invariants: `docs/architecture/CANONICAL_SYSTEM_MAP.md`,

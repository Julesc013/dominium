...
KERNEL_ROOTS = (
    REPO_ROOT / "apps" / "launcher" / "include" / "launcher",
    REPO_ROOT / "apps" / "launcher" / "include" / "launcher" / "_internal" / "launcher_internal",
    REPO_ROOT / "apps" / "launcher" / "core",
    REPO_ROOT / "apps" / "setup" / "core",
)

...
python scripts\ci\test_support_bundle_determinism.py --out-dir "%BUILD_DIR%\\ci_archive\generated\archive\generated\archive\generated\artifacts\\support_bundle"
if errorlevel 1 goto :fail

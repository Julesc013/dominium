/*
FILE: source/domino/env/d_env_volume.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / env/d_env_volume
RESPONSIBILITY: Defines internal contract for `d_env_volume`; shared within its subsystem; does NOT define a public API (see `include/**`).

/*
FILE: source/domino/gui/gui.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / gui/gui
RESPONSIBILITY: Implements `gui`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

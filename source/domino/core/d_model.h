/*
FILE: source/domino/core/d_model.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / core/d_model
RESPONSIBILITY: Defines internal contract for `d_model`; shared within its subsystem; does NOT define a public API (see `include/**`).

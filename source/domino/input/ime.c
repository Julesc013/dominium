/*
FILE: source/domino/input/ime.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / input/ime
RESPONSIBILITY: Implements `ime`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

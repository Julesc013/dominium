/*
FILE: source/domino/net/d_net_proto.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / net/d_net_proto
RESPONSIBILITY: Implements `d_net_proto`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/net/d_net_session.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / net/d_net_session
RESPONSIBILITY: Defines internal contract for `d_net_session`; shared within its subsystem; does NOT define a public API (see `include/**`).

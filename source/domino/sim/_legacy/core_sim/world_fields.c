/*
FILE: source/domino/sim/_legacy/core_sim/world_fields.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/_legacy/core_sim/world_fields
RESPONSIBILITY: Implements `world_fields`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

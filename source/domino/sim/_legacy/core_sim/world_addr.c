/*
FILE: source/domino/sim/_legacy/core_sim/world_addr.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/_legacy/core_sim/world_addr
RESPONSIBILITY: Implements `world_addr`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

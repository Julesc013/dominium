/*
FILE: source/domino/sim/_legacy/core_sim/dom_sim_world.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/_legacy/core_sim/dom_sim_world
RESPONSIBILITY: Implements `dom_sim_world`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

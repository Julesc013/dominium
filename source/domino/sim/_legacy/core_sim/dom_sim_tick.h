/*
FILE: source/domino/sim/_legacy/core_sim/dom_sim_tick.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/_legacy/core_sim/dom_sim_tick
RESPONSIBILITY: Defines internal contract for `dom_sim_tick`; shared within its subsystem; does NOT define a public API (see `include/**`).

/*
FILE: source/domino/sim/bus/dg_field_layer.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/bus/dg_field_layer
RESPONSIBILITY: Implements `dg_field_layer`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/sim/sense/dg_observation_buffer.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/sense/dg_observation_buffer
RESPONSIBILITY: Defines internal contract for `dg_observation_buffer`; shared within its subsystem; does NOT define a public API (see `include/**`).

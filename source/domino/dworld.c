/*
FILE: source/domino/dworld.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / dworld
RESPONSIBILITY: Implements `dworld`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

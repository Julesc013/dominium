/*
FILE: source/domino/djob.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / djob
RESPONSIBILITY: Implements `djob`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/render/dx11/dx11_gfx.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/dx11/dx11_gfx
RESPONSIBILITY: Defines internal contract for `dx11_gfx`; shared within its subsystem; does NOT define a public API (see `include/**`).

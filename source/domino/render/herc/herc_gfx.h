/*
FILE: source/domino/render/herc/herc_gfx.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/herc/herc_gfx
RESPONSIBILITY: Implements `herc_gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

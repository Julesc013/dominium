/*
FILE: source/domino/render/api/core/dom_target.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/api/core/dom_target
RESPONSIBILITY: Implements `dom_target`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

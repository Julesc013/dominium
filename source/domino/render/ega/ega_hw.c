/*
FILE: source/domino/render/ega/ega_hw.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/ega/ega_hw
RESPONSIBILITY: Implements `ega_hw`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

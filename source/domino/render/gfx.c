/*
FILE: source/domino/render/gfx.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/gfx
RESPONSIBILITY: Implements `gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

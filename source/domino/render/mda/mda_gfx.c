/*
FILE: source/domino/render/mda/mda_gfx.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / render/mda/mda_gfx
RESPONSIBILITY: Implements `mda_gfx`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

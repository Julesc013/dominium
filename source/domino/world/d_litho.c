/*
FILE: source/domino/world/d_litho.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / world/d_litho
RESPONSIBILITY: Implements `d_litho`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/system/plat/unix/posix/posix_headless/dom_platform_posix_headless.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/unix/posix/posix_headless/dom_platform_posix_headless
RESPONSIBILITY: Defines internal contract for `dom_platform_posix_headless`; shared within its subsystem; does NOT define a public API (see `include/**`).

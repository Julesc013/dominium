/*
FILE: source/domino/system/plat/dos16/dos16_sys.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/plat/dos16/dos16_sys
RESPONSIBILITY: Implements `dos16_sys`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/system/core/base/shared/os_paths.cpp
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/core/base/shared/os_paths
RESPONSIBILITY: Implements `os_paths`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

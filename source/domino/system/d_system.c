/*
FILE: source/domino/system/d_system.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / system/d_system
RESPONSIBILITY: Implements `d_system`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/decor/compile/dg_decor_compile.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / decor/compile/dg_decor_compile
RESPONSIBILITY: Implements `dg_decor_compile`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/deconomy.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / deconomy
RESPONSIBILITY: Implements `deconomy`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

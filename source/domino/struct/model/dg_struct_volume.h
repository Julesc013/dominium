/*
FILE: source/domino/struct/model/dg_struct_volume.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/model/dg_struct_volume
RESPONSIBILITY: Implements `dg_struct_volume`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

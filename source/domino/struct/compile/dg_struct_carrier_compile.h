/*
FILE: source/domino/struct/compile/dg_struct_carrier_compile.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/compile/dg_struct_carrier_compile
RESPONSIBILITY: Implements `dg_struct_carrier_compile`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

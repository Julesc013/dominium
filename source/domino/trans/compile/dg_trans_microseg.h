/*
FILE: source/domino/trans/compile/dg_trans_microseg.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/compile/dg_trans_microseg
RESPONSIBILITY: Implements `dg_trans_microseg`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

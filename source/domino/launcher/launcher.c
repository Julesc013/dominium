/*
FILE: source/domino/launcher/launcher.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / launcher/launcher
RESPONSIBILITY: Implements `launcher`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

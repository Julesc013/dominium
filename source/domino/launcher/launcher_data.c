/*
FILE: source/domino/launcher/launcher_data.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / launcher/launcher_data
RESPONSIBILITY: Implements `launcher_data`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/domino/build/d_build.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / build/d_build
RESPONSIBILITY: Implements `d_build`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

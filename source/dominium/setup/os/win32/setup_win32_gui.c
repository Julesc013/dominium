/*
FILE: source/dominium/setup/os/win32/setup_win32_gui.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / setup/os/win32/setup_win32_gui
RESPONSIBILITY: Implements `setup_win32_gui`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

...
static void dsk_print_usage(void) {
    std::printf("dominium-setup2-steam <request-make|run> --manifest <file> [options]\n");
...
int main(int argc, char **argv) {
    ...
    std::string cli = dsk_get_arg_value(argc, argv, "--setup2-cli")
        ? dsk_get_arg_value(argc, argv, "--setup2-cli")
        : "dominium-setup2";
    ...
    std::string frontend_id = dsk_get_arg_value(argc, argv, "--frontend-id") ? dsk_get_arg_value(argc, argv, "--frontend-id") : "dominium-setup2-steam";

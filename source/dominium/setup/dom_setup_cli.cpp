/*
FILE: source/dominium/setup/dom_setup_cli.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / setup/dom_setup_cli
RESPONSIBILITY: Implements `dom_setup_cli`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

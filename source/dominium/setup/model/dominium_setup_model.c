/*
FILE: source/dominium/setup/model/dominium_setup_model.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / setup/model/dominium_setup_model
RESPONSIBILITY: Implements `dominium_setup_model`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

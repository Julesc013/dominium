/*
FILE: source/dominium/setup/core/setup_run_install.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / setup/core/setup_run_install
RESPONSIBILITY: Implements `setup_run_install`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/setup/core/setup_core.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / setup/core/setup_core
RESPONSIBILITY: Implements `setup_core`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

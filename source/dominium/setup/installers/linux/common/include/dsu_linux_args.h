#ifndef DSU_LINUX_ARGS_H_INCLUDED
#define DSU_LINUX_ARGS_H_INCLUDED

#ifdef __cplusplus
extern "C" {
#endif

typedef struct dsu_linux_cli_args_t {
    int want_help;
    int want_version;
    int want_json;
    int deterministic;
...
#endif /* DSU_LINUX_ARGS_H_INCLUDED */

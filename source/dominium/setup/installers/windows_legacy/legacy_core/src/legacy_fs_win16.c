/*
FILE: source/dominium/setup/installers/windows_legacy/legacy_core/src/legacy_fs_win16.c
MODULE: Dominium Setup (Legacy Core)
PURPOSE: Win16 filesystem helpers and DSUA extraction (archive-only payloads).
*/

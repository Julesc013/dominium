/*
FILE: source/dominium/setup/adapters/macos/dominium_setup_adapter_macos.c
MODULE: Dominium Setup
PURPOSE: macOS setup adapter entrypoint (Plan S-6).
*/
#if !defined(__APPLE__)
#error "dominium_setup_adapter_macos.c is macOS-only"
#endif
...
static dsu_status_t dsu__mac_noop_register(void *user, dsu_ctx_t *ctx, const dsu_platform_registrations_state_t *state, const dsu_platform_intent_t *intent) {
    (void)user;
    (void)ctx;
    (void)state;
    (void)intent;
...
static dsu_status_t dsu__mac_noop_remove(void *user, dsu_ctx_t *ctx, const dsu_platform_registrations_state_t *state) {
    (void)user;
    (void)ctx;
    (void)state;
    return DSU_STATUS_SUCCESS;
...
int main(int argc, char **argv) {
    ...
    iface.plat_request_elevation = dsu__mac_plat_request_elevation;
    iface.plat_register_app_entry = dsu__mac_noop_register;
    iface.plat_register_file_assoc = dsu__mac_noop_register;
    iface.plat_register_url_handler = dsu__mac_noop_register;
    iface.plat_register_uninstall_entry = dsu__mac_noop_register;
    iface.plat_declare_capability = dsu__mac_noop_register;
    iface.plat_remove_registrations = dsu__mac_noop_remove;
    iface.plat_atomic_dir_swap = dsu__mac_plat_atomic_dir_swap;
    iface.plat_flush_fs = dsu__mac_plat_flush_fs;

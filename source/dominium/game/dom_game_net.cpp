/*
FILE: source/dominium/game/dom_game_net.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/dom_game_net
RESPONSIBILITY: Implements `dom_game_net`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

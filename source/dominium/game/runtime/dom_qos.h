...
enum {
    ...
    DOM_QOS_TLV_CAPS_PERF_CLASS = 10u,
    DOM_QOS_TLV_CAPS_MAX_UPDATE_HZ = 11u,
    DOM_QOS_TLV_CAPS_MAX_DELTA_DETAIL = 12u,
    DOM_QOS_TLV_CAPS_MAX_INTEREST_RADIUS_M = 13u,

    DOM_QOS_TLV_POLICY_UPDATE_HZ = 20u,
    DOM_QOS_TLV_POLICY_DELTA_DETAIL = 21u,
    DOM_QOS_TLV_POLICY_INTEREST_RADIUS_M = 22u,
    DOM_QOS_TLV_POLICY_RECOMMENDED_PROFILE = 23u,

    DOM_QOS_TLV_STATUS_FPS_BUDGET = 30u,
    DOM_QOS_TLV_STATUS_BACKLOG_MS = 31u,
    DOM_QOS_TLV_STATUS_DESIRED_REDUCTION = 32u,
    DOM_QOS_TLV_STATUS_FLAGS = 33u
};

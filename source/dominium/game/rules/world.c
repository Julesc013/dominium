/*
FILE: source/dominium/game/rules/world.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/rules/world
RESPONSIBILITY: Implements `world`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

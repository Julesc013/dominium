/*
FILE: source/dominium/game/cli/dom_cli_main.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/cli/dom_cli_main
RESPONSIBILITY: Implements `dom_cli_main`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

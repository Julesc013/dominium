/*
FILE: source/dominium/game/frontends/gui/dom_game_frontend_gui.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / game/frontends/gui
RESPONSIBILITY: Implements a thin GUI frontend loop over the runtime kernel.
...
extern "C" int dom_game_frontend_gui_run(dom_game_runtime *rt, u32 max_ticks) {
    if (!rt) {
        return 1;
    }

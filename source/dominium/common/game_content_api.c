/*
FILE: source/dominium/common/game_content_api.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/game_content_api
RESPONSIBILITY: Implements `game_content_api`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

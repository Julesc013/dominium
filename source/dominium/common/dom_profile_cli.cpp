/*
FILE: source/dominium/common/dom_profile_cli.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dom_profile_cli
RESPONSIBILITY: Implements `dom_profile_cli`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

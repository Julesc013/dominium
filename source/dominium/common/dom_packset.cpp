/*
FILE: source/dominium/common/dom_packset.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dom_packset
RESPONSIBILITY: Implements `dom_packset`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/common/dom_instance.cpp
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dom_instance
RESPONSIBILITY: Implements `dom_instance`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

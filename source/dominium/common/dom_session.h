/*
FILE: source/dominium/common/dom_session.h
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / common/dom_session
RESPONSIBILITY: Defines internal contract for `dom_session`; shared within its subsystem; does NOT define a public API (see `include/**`).

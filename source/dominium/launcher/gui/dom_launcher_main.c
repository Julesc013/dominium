/*
FILE: source/dominium/launcher/gui/dom_launcher_main.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / launcher/gui/dom_launcher_main
RESPONSIBILITY: Implements `dom_launcher_main`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

/*
FILE: source/dominium/launcher/core/launch_core.c
MODULE: Dominium
LAYER / SUBSYSTEM: Dominium impl / launcher/core/launch_core
RESPONSIBILITY: Implements `launch_core`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

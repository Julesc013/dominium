/*
FILE: source/domino/world/d_serialize.c
MODULE: Domino
...
DETERMINISM: Determinism-sensitive (serialized bytes may be replayed/hashed); see `docs/reference/specs/SPEC_DETERMINISM.md`.
VERSIONING / ABI / DATA FORMAT NOTES: Legacy subsystem TLV stream; see `docs/reference/specs/DATA_FORMATS.md` (Subsystem TLV containers).
...
static u32 d_tag_for_subsystem(d_subsystem_id id) {
    switch (id) {
        ...
        case D_SUBSYS_ORG:    return TAG_SUBSYS_DORG;
        case D_SUBSYS_RESEARCH: return TAG_SUBSYS_DRESEARCH;
...
static d_subsystem_id d_subsystem_for_tag(u32 tag) {
    switch (tag) {
        ...
        case TAG_SUBSYS_DORG:    return D_SUBSYS_ORG;
        case TAG_SUBSYS_DRESEARCH: return D_SUBSYS_RESEARCH;

/*
FILE: source/domino/world/frame/dg_anchor.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / world/frame/dg_anchor
RESPONSIBILITY: Implements `dg_anchor`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

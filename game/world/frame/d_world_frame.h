/*
FILE: source/domino/world/frame/d_world_frame.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / world/frame/d_world_frame
RESPONSIBILITY: Defines internal contract for `d_world_frame`; shared within its subsystem; does NOT define a public API (see `include/**`).
 ...
 *
 * See docs/reference/specs/SPEC_DOMAINS_FRAMES_PROP.md and docs/reference/specs/SPEC_POSE_AND_ANCHORS.md
 */

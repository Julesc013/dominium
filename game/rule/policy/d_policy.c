/*
FILE: source/domino/policy/d_policy.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / policy/d_policy
RESPONSIBILITY: Implements `d_policy`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

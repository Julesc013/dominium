/*
FILE: source/domino/struct/d_struct_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / struct/d_struct_validate
RESPONSIBILITY: Implements `d_struct_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

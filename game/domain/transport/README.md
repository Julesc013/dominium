...
## Spec
See `docs/reference/specs/SPEC_TRANS.md`, `docs/reference/specs/SPEC_TRANS_STRUCT_DECOR.md`,
`docs/reference/specs/SPEC_POSE_AND_ANCHORS.md`, and `docs/reference/specs/SPEC_DETERMINISM.md`.

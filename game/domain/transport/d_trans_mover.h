/*
FILE: source/domino/trans/d_trans_mover.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / trans/d_trans_mover
RESPONSIBILITY: Defines internal contract for `d_trans_mover`; shared within its subsystem; does NOT define a public API (see `include/**`).

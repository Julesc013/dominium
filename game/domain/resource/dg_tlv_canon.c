/*
FILE: source/domino/res/dg_tlv_canon.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / res/dg_tlv_canon
RESPONSIBILITY: Implements `dg_tlv_canon`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

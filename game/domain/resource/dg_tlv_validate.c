/*
FILE: source/domino/res/dg_tlv_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / res/dg_tlv_validate
RESPONSIBILITY: Implements `dg_tlv_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

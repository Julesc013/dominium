/*
FILE: source/domino/ai/d_agent.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / ai/d_agent
RESPONSIBILITY: Defines internal contract for `d_agent`; shared within its subsystem; does NOT define a public API (see `include/**`).

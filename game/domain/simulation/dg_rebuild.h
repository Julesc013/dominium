/*
FILE: source/domino/sim/dg_rebuild.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/dg_rebuild
RESPONSIBILITY: Defines internal contract for `dg_rebuild`; shared within its subsystem; does NOT define a public API (see `include/**`).
...
#include "dg_dirtyset.h"
#include "dg_rebuild_work.h"

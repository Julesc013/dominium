/*
FILE: source/domino/sim/act/dg_delta_registry.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/act/dg_delta_registry
RESPONSIBILITY: Defines internal contract for `dg_delta_registry`; shared within its subsystem; does NOT define a public API (see `include/**`).

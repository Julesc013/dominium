...
RESPONSIBILITY: Defines internal contract for `dg_action`; shared within its subsystem; does NOT define a public API (see `include/**`).
...
#include "dg_agent_ids.h"
#include "dg_pkt_delta.h"
#include "dg_pkt_intent.h"

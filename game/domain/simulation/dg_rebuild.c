/*
FILE: source/domino/sim/dg_rebuild.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/dg_rebuild
RESPONSIBILITY: Implements `dg_rebuild`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

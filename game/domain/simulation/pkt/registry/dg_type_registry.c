/*
FILE: source/domino/sim/pkt/registry/dg_type_registry.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/pkt/registry/dg_type_registry
RESPONSIBILITY: Implements `dg_type_registry`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

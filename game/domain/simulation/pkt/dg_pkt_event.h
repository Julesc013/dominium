/*
FILE: source/domino/sim/pkt/dg_pkt_event.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/pkt/dg_pkt_event
RESPONSIBILITY: Defines internal contract for `dg_pkt_event`; shared within its subsystem; does NOT define a public API (see `include/**`).

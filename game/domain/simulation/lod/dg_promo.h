/*
FILE: source/domino/sim/lod/dg_promo.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/lod/dg_promo
RESPONSIBILITY: Defines internal contract for `dg_promo`; shared within its subsystem; does NOT define a public API (see `include/**`).
 ...
 *
 * Algorithm (authoritative; see docs/reference/specs/SPEC_LOD.md):
...
#include "dg_pkt_common.h"
#include "dg_budget.h"

#include "dg_rep.h"
#include "dg_lod_index.h"
#include "dg_interest.h"
#include "dg_representable.h"

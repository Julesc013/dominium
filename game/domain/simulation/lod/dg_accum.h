/*
FILE: source/domino/sim/lod/dg_accum.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / sim/lod/dg_accum
RESPONSIBILITY: Defines internal contract for `dg_accum`; shared within its subsystem; does NOT define a public API (see `include/**`).

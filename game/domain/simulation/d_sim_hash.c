...
DETERMINISM: Determinism-critical; hashes stable, canonical byte encodings (see `docs/reference/specs/SPEC_DETERMINISM.md`).
VERSIONING / ABI / DATA FORMAT NOTES: Hash is sensitive to serialized byte encodings; see `docs/reference/specs/SPEC_DETERMINISM.md` and `docs/reference/specs/DATA_FORMATS.md`.
EXTENSION POINTS: Extend via public headers and relevant `docs/reference/specs/SPEC_*.md` without cross-layer coupling.
*/
#include <stdlib.h>
#include <string.h>

#include "d_sim_hash.h"
#include "dg_tlv_canon.h"

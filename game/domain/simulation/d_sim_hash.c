...
DETERMINISM: Determinism-critical; hashes stable, canonical byte encodings (see `docs/specs/SPEC_DETERMINISM.md`).
VERSIONING / ABI / DATA FORMAT NOTES: Hash is sensitive to serialized byte encodings; see `docs/specs/SPEC_DETERMINISM.md` and `docs/specs/DATA_FORMATS.md`.

/*
FILE: source/domino/agent/dg_agent_comp.h
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / agent/dg_agent_comp
RESPONSIBILITY: Defines internal contract for `dg_agent_comp`; shared within its subsystem; does NOT define a public API (see `include/**`).

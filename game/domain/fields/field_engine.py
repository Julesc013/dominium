...
def geo_cell_key_from_position(*args, **kwargs):
    from game.domain.geology.index.geo_index_engine import geo_cell_key_from_position as impl

    return impl(*args, **kwargs)


def geo_partition_cell_key(*args, **kwargs):
    from game.domain.geology.kernel.geo_kernel import geo_partition_cell_key as impl

    return impl(*args, **kwargs)


def field_sampling_position(*args, **kwargs):
    from game.domain.geology.frame.frame_engine import field_sampling_position as impl

    return impl(*args, **kwargs)


def field_sampling_cell_key(*args, **kwargs):
    from game.domain.geology.frame.frame_engine import field_sampling_cell_key as impl

    return impl(*args, **kwargs)


def geo_distance(*args, **kwargs):
    from game.domain.geology.metric.metric_engine import geo_distance as impl

    return impl(*args, **kwargs)


def geo_neighbors(*args, **kwargs):
    from game.domain.geology.metric.neighborhood_engine import geo_neighbors as impl

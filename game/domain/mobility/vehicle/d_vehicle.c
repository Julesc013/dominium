/*
FILE: source/domino/vehicle/d_vehicle.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / vehicle/d_vehicle
RESPONSIBILITY: Implements `d_vehicle`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

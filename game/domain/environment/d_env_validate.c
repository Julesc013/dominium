/*
FILE: source/domino/env/d_env_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / env/d_env_validate
RESPONSIBILITY: Implements `d_env_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).
...
#include "d_model.h"
#include "d_env.h"
#include "d_env_field.h"
#include "d_env_volume.h"

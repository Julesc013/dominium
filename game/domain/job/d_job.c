/*
FILE: source/domino/job/d_job.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / job/d_job
RESPONSIBILITY: Implements `d_job`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

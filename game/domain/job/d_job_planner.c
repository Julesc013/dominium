/*
FILE: source/domino/job/d_job_planner.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / job/d_job_planner
RESPONSIBILITY: Implements `d_job_planner`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

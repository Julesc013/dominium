...
from game.domain.worldgen.mw.mw_surface_refiner_l3 import (
    generate_mw_surface_l3_payload,
    normalize_surface_tile_artifact_rows,
)
from game.domain.worldgen.galaxy import generate_galaxy_object_stub_payload, normalize_galaxy_object_stub_rows

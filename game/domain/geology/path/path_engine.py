...
from game.domain.geology.metric.neighborhood_engine import geo_neighbors
from game.domain.geology.path.shard_route_planner import build_shard_route_plan
...
def _field_cost_modifier(
    *,
    ...
    def _field_value(field_id: str, cell_key: Mapping[str, object]) -> int:
        ...
        try:
            from game.domain.fields.field_engine import field_get_value
        except Exception:
            return 0

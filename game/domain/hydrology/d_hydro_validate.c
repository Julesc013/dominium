/*
FILE: source/domino/hydro/d_hydro_validate.c
MODULE: Domino
LAYER / SUBSYSTEM: Domino impl / hydro/d_hydro_validate
RESPONSIBILITY: Implements `d_hydro_validate`; owns translation-unit-local helpers/state; does NOT define the public contract (see `include/**`).

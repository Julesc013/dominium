...
def _coerce_cell_key(value: object) -> dict:
    from game.domain.geology.index.geo_index_engine import _coerce_cell_key as _geo_coerce_cell_key
...
def _build_position_ref(
    *,
    ...
    from game.domain.geology.frame.frame_engine import build_position_ref
...
def generate_galaxy_object_stub_payload(
    *,
    ...
    from game.domain.worldgen.mw import mw_cell_position_pc, mw_density_permille, mw_metallicity_permille

...
from models.model_engine import evaluate_field_modifier_curve
from tools.xstack.compatx.canonical_json import canonical_sha256


def geo_cell_key_from_position(*args, **kwargs):
    from game.domains.geology.index.geo_index_engine import geo_cell_key_from_position as impl

    return impl(*args, **kwargs)


def geo_partition_cell_key(*args, **kwargs):
    from game.domains.geology.kernel.geo_kernel import geo_partition_cell_key as impl

    return impl(*args, **kwargs)


def field_sampling_position(*args, **kwargs):
    from game.domains.geology.frame.frame_engine import field_sampling_position as impl

    return impl(*args, **kwargs)


def field_sampling_cell_key(*args, **kwargs):
    from game.domains.geology.frame.frame_engine import field_sampling_cell_key as impl

    return impl(*args, **kwargs)


def geo_distance(*args, **kwargs):
    from game.domains.geology.metric.metric_engine import geo_distance as impl

    return impl(*args, **kwargs)


def geo_neighbors(*args, **kwargs):
    from game.domains.geology.metric.neighborhood_engine import geo_neighbors as impl

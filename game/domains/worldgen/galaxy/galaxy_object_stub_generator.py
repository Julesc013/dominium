...
def _coerce_cell_key(value: object) -> dict:
    from game.domains.geology.index.geo_index_engine import _coerce_cell_key as _geo_coerce_cell_key
...
def generate_galaxy_object_stub_payload(
    *,
    ...
    from game.domains.worldgen.mw import mw_cell_position_pc, mw_density_permille, mw_metallicity_permille

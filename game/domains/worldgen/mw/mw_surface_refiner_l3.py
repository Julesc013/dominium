...
from game.domains.geology.edit import build_geometry_cell_state
from game.domains.geology.index.geo_index_engine import _coerce_cell_key, _semantic_cell_key
from game.domains.geology.index.object_id_engine import geo_object_id
...
def _earth_bindings() -> dict:
    from game.domains.worldgen.earth.climate_field_engine import (
        DEFAULT_EARTH_CLIMATE_PARAMS_ID,
        earth_climate_params_rows,
        evaluate_earth_tile_climate,
    )
    from game.domains.worldgen.earth.hydrology_engine import (
    ...
    from game.domains.worldgen.earth.tide_field_engine import (

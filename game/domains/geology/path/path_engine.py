...
from game.domains.geology.frame.domain_adapters import field_sampling_cell_key
from game.domains.geology.index.geo_index_engine import _coerce_cell_key, _semantic_cell_key, geo_cell_key_from_position, geo_refine_cell_key
from game.domains.geology.kernel.geo_kernel import (
...
from game.domains.geology.metric.metric_engine import geo_distance
from game.domains.geology.metric.neighborhood_engine import geo_neighbors
from game.domains.geology.path.shard_route_planner import build_shard_route_plan
...
def _field_cost_modifier(
    *,
    ...
    def _field_value(field_id: str, cell_key: Mapping[str, object]) -> int:
        ...
        try:
            from game.domains.fields.field_engine import field_get_value
        except Exception:
            return 0

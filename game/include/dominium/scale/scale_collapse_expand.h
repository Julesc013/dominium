/*
FILE: include/dominium/scale/scale_collapse_expand.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_COLLAPSE_EXPAND_H
#define DOMINIUM_SCALE_COLLAPSE_EXPAND_H
...
#endif /* DOMINIUM_SCALE_COLLAPSE_EXPAND_H */

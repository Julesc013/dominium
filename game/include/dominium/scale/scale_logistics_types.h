/*
FILE: include/dominium/scale/scale_logistics_types.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_LOGISTICS_TYPES_H
#define DOMINIUM_SCALE_LOGISTICS_TYPES_H
...
#endif /* DOMINIUM_SCALE_LOGISTICS_TYPES_H */

/*
FILE: include/dominium/scale/domain_transitions.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_DOMAIN_TRANSITIONS_H
#define DOMINIUM_SCALE_DOMAIN_TRANSITIONS_H
...
#endif /* DOMINIUM_SCALE_DOMAIN_TRANSITIONS_H */

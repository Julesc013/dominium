/*
FILE: include/dominium/scale/relevance_transitions.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_RELEVANCE_TRANSITIONS_H
#define DOMINIUM_SCALE_RELEVANCE_TRANSITIONS_H
...
#endif /* DOMINIUM_SCALE_RELEVANCE_TRANSITIONS_H */

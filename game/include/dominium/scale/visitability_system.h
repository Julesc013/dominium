/*
FILE: include/dominium/scale/visitability_system.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_VISITABILITY_SYSTEM_H
#define DOMINIUM_SCALE_VISITABILITY_SYSTEM_H
...
#endif /* DOMINIUM_SCALE_VISITABILITY_SYSTEM_H */

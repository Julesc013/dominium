/*
FILE: include/dominium/scale/interstellar_logistics.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_INTERSTELLAR_LOGISTICS_H
#define DOMINIUM_SCALE_INTERSTELLAR_LOGISTICS_H
...
#endif /* DOMINIUM_SCALE_INTERSTELLAR_LOGISTICS_H */

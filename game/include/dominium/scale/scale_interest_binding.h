/*
FILE: include/dominium/scale/scale_interest_binding.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SCALE_INTEREST_BINDING_H
#define DOMINIUM_SCALE_INTEREST_BINDING_H
...
#endif /* DOMINIUM_SCALE_INTEREST_BINDING_H */

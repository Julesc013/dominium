/*
FILE: include/dominium/city/city_services_stub.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_CITY_SERVICES_STUB_H
#define DOMINIUM_CITY_SERVICES_STUB_H
...
#endif /* DOMINIUM_CITY_SERVICES_STUB_H */

/*
FILE: include/dominium/city/city_refusal_codes.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_CITY_REFUSAL_CODES_H
#define DOMINIUM_CITY_REFUSAL_CODES_H
...
#endif /* DOMINIUM_CITY_REFUSAL_CODES_H */

/*
FILE: include/dominium/infrastructure/production_chain.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_INFRA_PRODUCTION_CHAIN_H
#define DOMINIUM_INFRA_PRODUCTION_CHAIN_H
...
#endif /* DOMINIUM_INFRA_PRODUCTION_CHAIN_H */

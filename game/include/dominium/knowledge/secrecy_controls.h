/*
FILE: include/dominium/knowledge/secrecy_controls.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_KNOWLEDGE_SECRECY_CONTROLS_H
#define DOMINIUM_KNOWLEDGE_SECRECY_CONTROLS_H
...
#endif /* DOMINIUM_KNOWLEDGE_SECRECY_CONTROLS_H */

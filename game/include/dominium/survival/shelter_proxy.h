/*
FILE: include/dominium/survival/shelter_proxy.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_SURVIVAL_SHELTER_PROXY_H
#define DOMINIUM_SURVIVAL_SHELTER_PROXY_H
...
#endif /* DOMINIUM_SURVIVAL_SHELTER_PROXY_H */

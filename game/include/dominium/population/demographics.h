/*
FILE: include/dominium/population/demographics.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_POPULATION_DEMOGRAPHICS_H
#define DOMINIUM_POPULATION_DEMOGRAPHICS_H
...
#endif /* DOMINIUM_POPULATION_DEMOGRAPHICS_H */

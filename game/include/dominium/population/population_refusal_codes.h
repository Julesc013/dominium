/*
FILE: include/dominium/population/population_refusal_codes.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_POPULATION_REFUSAL_CODES_H
#define DOMINIUM_POPULATION_REFUSAL_CODES_H
...
#endif /* DOMINIUM_POPULATION_REFUSAL_CODES_H */

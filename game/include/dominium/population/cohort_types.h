/*
FILE: include/dominium/population/cohort_types.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_POPULATION_COHORT_TYPES_H
#define DOMINIUM_POPULATION_COHORT_TYPES_H
...
#endif /* DOMINIUM_POPULATION_COHORT_TYPES_H */

/*
FILE: include/dominium/logistics/transport_capacity.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_LOGISTICS_TRANSPORT_CAPACITY_H
#define DOMINIUM_LOGISTICS_TRANSPORT_CAPACITY_H
...
#endif /* DOMINIUM_LOGISTICS_TRANSPORT_CAPACITY_H */

/*
FILE: include/dominium/governance/legitimacy_tasks.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_GOVERNANCE_LEGITIMACY_TASKS_H
#define DOMINIUM_GOVERNANCE_LEGITIMACY_TASKS_H
...
#endif /* DOMINIUM_GOVERNANCE_LEGITIMACY_TASKS_H */

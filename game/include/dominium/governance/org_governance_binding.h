/*
FILE: include/dominium/governance/org_governance_binding.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_GOVERNANCE_ORG_BINDING_H
#define DOMINIUM_GOVERNANCE_ORG_BINDING_H
...
#endif /* DOMINIUM_GOVERNANCE_ORG_BINDING_H */

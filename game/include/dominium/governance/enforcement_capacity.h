/*
FILE: include/dominium/governance/enforcement_capacity.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_GOVERNANCE_ENFORCEMENT_CAPACITY_H
#define DOMINIUM_GOVERNANCE_ENFORCEMENT_CAPACITY_H
...
#endif /* DOMINIUM_GOVERNANCE_ENFORCEMENT_CAPACITY_H */

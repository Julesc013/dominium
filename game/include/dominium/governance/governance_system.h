/*
FILE: include/dominium/governance/governance_system.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_GOVERNANCE_GOVERNANCE_SYSTEM_H
#define DOMINIUM_GOVERNANCE_GOVERNANCE_SYSTEM_H
...
#endif /* DOMINIUM_GOVERNANCE_GOVERNANCE_SYSTEM_H */

/*
FILE: include/dominium/agents/agent_doctrine_tasks.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_AGENTS_AGENT_DOCTRINE_TASKS_H
#define DOMINIUM_AGENTS_AGENT_DOCTRINE_TASKS_H
...
#endif /* DOMINIUM_AGENTS_AGENT_DOCTRINE_TASKS_H */

/*
FILE: include/dominium/war/occupation_state.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_OCCUPATION_STATE_H
#define DOMINIUM_WAR_OCCUPATION_STATE_H
...
#endif /* DOMINIUM_WAR_OCCUPATION_STATE_H */

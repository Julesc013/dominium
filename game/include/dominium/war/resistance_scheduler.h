/*
FILE: include/dominium/war/resistance_scheduler.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_RESISTANCE_SCHEDULER_H
#define DOMINIUM_WAR_RESISTANCE_SCHEDULER_H
...
#endif /* DOMINIUM_WAR_RESISTANCE_SCHEDULER_H */

/*
FILE: include/dominium/war/loss_accounting.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_LOSS_ACCOUNTING_H
#define DOMINIUM_WAR_LOSS_ACCOUNTING_H
...
#endif /* DOMINIUM_WAR_LOSS_ACCOUNTING_H */

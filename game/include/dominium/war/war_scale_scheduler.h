/*
FILE: include/dominium/war/war_scale_scheduler.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_WAR_SCALE_SCHEDULER_H
#define DOMINIUM_WAR_WAR_SCALE_SCHEDULER_H
...
#endif /* DOMINIUM_WAR_WAR_SCALE_SCHEDULER_H */

/*
FILE: include/dominium/war/resistance_state.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_RESISTANCE_STATE_H
#define DOMINIUM_WAR_RESISTANCE_STATE_H
...
#endif /* DOMINIUM_WAR_RESISTANCE_STATE_H */

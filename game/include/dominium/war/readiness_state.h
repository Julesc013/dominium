/*
FILE: include/dominium/war/readiness_state.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_READINESS_STATE_H
#define DOMINIUM_WAR_READINESS_STATE_H
...
#endif /* DOMINIUM_WAR_READINESS_STATE_H */

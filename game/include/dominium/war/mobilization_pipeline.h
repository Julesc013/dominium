/*
FILE: include/dominium/war/mobilization_pipeline.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_MOBILIZATION_PIPELINE_H
#define DOMINIUM_WAR_MOBILIZATION_PIPELINE_H
...
#endif /* DOMINIUM_WAR_MOBILIZATION_PIPELINE_H */

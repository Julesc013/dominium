/*
FILE: include/dominium/war/casualty_generator.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_CASUALTY_GENERATOR_H
#define DOMINIUM_WAR_CASUALTY_GENERATOR_H
...
#endif /* DOMINIUM_WAR_CASUALTY_GENERATOR_H */

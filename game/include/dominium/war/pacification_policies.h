/*
FILE: include/dominium/war/pacification_policies.h
MODULE: Dominium
...
*/
#ifndef DOMINIUM_WAR_PACIFICATION_POLICIES_H
#define DOMINIUM_WAR_PACIFICATION_POLICIES_H
...
#endif /* DOMINIUM_WAR_PACIFICATION_POLICIES_H */

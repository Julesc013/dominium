...
static const dom_app_command_desc k_commands[] = {
    { DOM_APP_CMD_LAUNCHER_VERSION, "version", "launcher", DOM_APP_ARG_SCHEMA_NONE,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_0_NONBIO_WORLD, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    ...
    { DOM_APP_CMD_CLIENT_AGENTS, "agents", "client", DOM_APP_ARG_SCHEMA_NONE,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_1_NONINTELLIGENT_LIFE, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    { DOM_APP_CMD_CLIENT_AGENT_ADD, "agent-add", "client", DOM_APP_ARG_SCHEMA_ARGS,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_2_INTELLIGENT_PRE_TOOL, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    ...
    { DOM_APP_CMD_CLIENT_INSTITUTION_CREATE, "institution-create", "client", DOM_APP_ARG_SCHEMA_ARGS,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_4_PRE_INDUSTRY, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    ...
    { DOM_APP_CMD_CLIENT_NETWORK_CREATE, "network-create", "client", DOM_APP_ARG_SCHEMA_ARGS,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_5_PRE_PRESENT, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    ...
    { DOM_APP_CMD_TOOLS_INSPECT, "inspect", "tools", DOM_APP_ARG_SCHEMA_ARGS,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_0_NONBIO_WORLD, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_FULL },
    ...
    { DOM_APP_CMD_TOOLS_AI, "ai", "tools", DOM_APP_ARG_SCHEMA_ARGS,
      k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_6_FUTURE, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
    ...
    { DOM_APP_CMD_LAUNCHER_UI_INSTANCES_PLAY_SELECTED, "launcher.instances.play_selected", "launcher",
      DOM_APP_ARG_SCHEMA_NONE, k_failure_common, 4u, k_exit_common, 4u, DOM_STAGE_0_NONBIO_WORLD, k_required_caps_none, 0u, DOM_EPISTEMIC_SCOPE_PARTIAL },
...
int appcore_stage_rank(const char* stage_id)
{
    ...
    if (strcmp(stage_id, DOM_STAGE_0_NONBIO_WORLD) == 0) return 0;
    if (strcmp(stage_id, DOM_STAGE_1_NONINTELLIGENT_LIFE) == 0) return 1;
    if (strcmp(stage_id, DOM_STAGE_2_INTELLIGENT_PRE_TOOL) == 0) return 2;
    if (strcmp(stage_id, DOM_STAGE_3_PRE_TOOL_WORLD) == 0) return 3;
    if (strcmp(stage_id, DOM_STAGE_4_PRE_INDUSTRY) == 0) return 4;
    if (strcmp(stage_id, DOM_STAGE_5_PRE_PRESENT) == 0) return 5;
    if (strcmp(stage_id, DOM_STAGE_6_FUTURE) == 0) return 6;
    return -1;
}
...
int appcore_command_stage_allowed(const dom_app_command_desc* cmd, const char* world_stage)
{
    int cmd_rank;
    int world_rank;
    if (!cmd || !cmd->required_stage || !world_stage) {
        return 0;
    }
    cmd_rank = appcore_stage_rank(cmd->required_stage);
    world_rank = appcore_stage_rank(world_stage);
    if (cmd_rank < 0 || world_rank < 0) {
        return 0;
    }
    return world_rank >= cmd_rank ? 1 : 0;
}
